...
import android.widget.LinearLayout;/*[bug-107499][BIRD_WEIMI_MUSIC]wangyueyue 20150618 add*/
...
public class AudioPreview extends Activity
    ...
    private void showPostPrepareUI() {
        ...
        /*[bug-107499][BIRD_WEIMI_MUSIC]wangyueyue 20150618 begin*/
        LinearLayout ln = (LinearLayout) findViewById(R.id.spinner_parent);
        ln.setVisibility(View.VISIBLE);
        /*[bug-107499][BIRD_WEIMI_MUSIC]wangyueyue 20150618 end*/
    ...
    @Override
    public boolean onKeyUp(int keyCode, KeyEvent event) {//[bug-12516][songwei][20170704]onKeyDown --> onKeyUp
        switch (keyCode) {
