...
implements MusicUtils.Defs, ServiceConnection
{
    ...
    public void onCreate(Bundle icicle) {
        ...
        mToken = MusicUtils.bindToService(this, this);
         /*[BIRD_WEIMI_MUSIC]wangyueyue 20150314 end*/
         Drawable myDrawable2 = getResources().getDrawable(R.drawable.bird_main_bg_activity);
    ...
    public void onServiceConnected(ComponentName name, IBinder service) {
        ...
        if (mAdapter == null) {
            ...
            if (TextUtils.isEmpty(mFilterString)) {
                ...
                //mTrackList.birdDisablePopwindow(); /*[BIRD_WEIMI_MUSIC]wangyueyue 20150316 add*/
    ...
    static class QueryListAdapter extends SimpleCursorAdapter {
        ...
        public void bindView(View view, Context context, Cursor cursor) {
            ...
            if (mimetype.equals("artist")) {
                ...
                iv.setImageResource(R.drawable.ic_mp_album_list);//albumart_mp_unknown_list/*[BIRD_WEIMI_MUSIC]wangyueyue 20150314 modify*/
                String name = cursor.getString(cursor.getColumnIndexOrThrow(
                        MediaStore.Audio.Albums.ALBUM));
                String displayname = name;
                if (name == null || name.equals(MediaStore.UNKNOWN_STRING)) {
