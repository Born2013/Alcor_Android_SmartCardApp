    ...
    public void onCreate(Bundle icicle)
    {
        ...
        if (intent != null) {
            ...
            if (mWithtabs) {
                ...
                Drawable myDrawable2 = r.getDrawable(R.drawable.bird_main_bg_activity);
                this.getWindow().setBackgroundDrawable(myDrawable2);
                /*[BIRD_WEIMI_MUSIC]wangyueyue 20150314 end*/
            /// @}
            }
        }
        ...
        if (!mWithtabs && !mEditMode) {
            ...
            //setAlbumArtBackground();/*[BIRD_WEIMI_MUSIC]wangyueyue 20150314 add*/
        }
...
/*
    ...
    public void onPause() {
        ...
        /*[bug-106689]xujing 20150415 begin*/
        /*[BIRD][BIRD_WEIMI_SYSTEMUI]wangyueyue 20150320 begin
        if (FeatureOption.BIRD_WEIMI_SYSTEMUI) {
            Intent intent = new Intent("com.weimi.bird.music");
            intent.putExtra("ONMUSIC", false);
            sendBroadcast(intent);
        }
        /*[BIRD][BIRD_WEIMI_SYSTEMUI]wangyueyue 20150320 end*/
        /*[bug-106689]xujing 20150415 end*/
        if (mSubMenu != null) {
            mSubMenu.close();
        }
        ...
        switch (item.getItemId()) {
            case PLAY_SELECTION: {
                ...
                if (checkDrmRightsForPlay(mTrackCursor, position, false, true)) {
                    //MusicLogUtils.d("wyy_0518", "checkDrmRightsForPlay    995 "); /*[bug-107324][BIRD_WEIMI_MUSIC] wangyueyue 20150518 add */ 
    ...
    protected void onListItemClick(ListView l, View v, int position, long id)
    {
        ...
        if (mTrackCursor instanceof NowPlayingCursor) {
            if (MusicUtils.sService != null) {
                try {
                    /// M: check drm rights firstly when the song to be played.
                     MusicLogUtils.d("wyy_0518", "checkDrmRightsForPlay    1250 "); /*[bug-107324][BIRD_WEIMI_MUSIC] wangyueyue 20150518 add */  
        ...
        /// M: check drm rights firstly when the song to be played.
        if (checkDrmRightsForPlay(mTrackCursor, position, false, true)) {
            //MusicLogUtils.d("wyy_0518", "checkDrmRightsForPlay  1261" ); /*[bug-107324][BIRD_WEIMI_MUSIC] wangyueyue 20150518 add */  
            MusicUtils.playAll(this, mTrackCursor, position);
        }
    }
    ...
    static class TrackListAdapter extends SimpleCursorAdapter implements SectionIndexer {
        ...
        public void bindView(View view, Context context, Cursor cursor) {
            ...
            if (mActivity.mEditMode) {
                ...
                //ivEdit.setVisibility(View.VISIBLE); /*[BIRD_WEIMI_MUSIC]wangyueyue 20150314 add*/
            }
            /// @}
