        ...
        implements View.OnCreateContextMenuListener, MusicUtils.Defs
{
    ...
    public void onCreate(Bundle icicle) {
        ...
        /*[bug-106559][BIRD_WEIMI_MUSIC]wangyueyue 20150408 begin*/
        lv.setGroupIndicator(this.getResources().getDrawable(R.drawable.expander_group_material));
        /*[bug-106559][BIRD_WEIMI_MUSIC]wangyueyue 20150408 end*/
...
*/
    ...
    public void init(Cursor c) {
        ...
        if (mLastListPosCourse >= 0) {
            ...
            /*[bug-106559][BIRD_WEIMI_MUSIC]wangyueyue 20150408 begin*/
            elv.setGroupIndicator(this.getResources().getDrawable(R.drawable.expander_group_material));
            /*[bug-106559][BIRD_WEIMI_MUSIC]wangyueyue 20150408 end*/
    ...
    static class ArtistAlbumListAdapter extends SimpleCursorTreeAdapter implements SectionIndexer {
        ...
        private int getGroupPositon(int position) {
            ...
            /*[bug-106559][BIRD_WEIMI_MUSIC]wangyueyue 20150408 begin*/
            listview.setGroupIndicator(mContext.getResources().getDrawable(R.drawable.expander_group_material));
            /*[bug-106559][BIRD_WEIMI_MUSIC]wangyueyue 20150408 end*/
