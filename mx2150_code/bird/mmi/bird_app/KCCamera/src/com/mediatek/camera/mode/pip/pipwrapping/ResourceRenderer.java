...
public class ResourceRenderer extends Renderer {
    ...
    private void dumpVertex(RectF mRectF) {
        Log.d(TAG, "[dumpVertex] + (" + mRectF.left + " , " + mRectF.top + ")" + " , " + "("
                + (mRectF.left + mRectF.width()) + " , " + mRectF.top + ")" + "(centerX , centerY) = "
                + "(" + mRectF.centerX() + " , "+ mRectF.centerY() + ")");
        Log.d(TAG, "[dumpVertex] -(" + mRectF.left + " , " + (mRectF.top + mRectF.height()) + ")" + " , "
