...
public class SettingConstants {
    ...
    public static final int SETTING_COUNT = 60 + 1 + 1 + 2;//[BIRD][GANGYUN_BOKEH_SUPPORT][双摄][yangheng][20170215] 
	// +1 拍照提示音控制菜单
    ...
    public static final String KEY_VOLUME_KEY_FEATURE = "pref_volume_key_feature_key";
    ...
    //[BIRD][BIRD_ADD_CAMERA_SHUTTERSOUND][拍照提示音控制菜单][qianliliang][20151210]END
    //[BIRD][BIRD_VOLUME_KEY_FEATURE_IN_CAMERA][相机设置中增加音量键功能选项][qianliliang][20150921]BEGIN
    public static final int ROW_SETTING_CAMERA_VOLUME_KEY_FEATURE = 61;
    //[BIRD][BIRD_VOLUME_KEY_FEATURE_IN_CAMERA][相机设置中增加音量键功能选项][qianliliang][20150921]END
	//gangyun tech add begin
    public static final int ROW_SETTING_GANGYUN_BEAUTY            = 62;
    public static final int ROW_SETTING_GANGYUN_BOKEH              = 63;
	//gangyun tech add end
    ...
    static {
	    ...
	    //[BIRD][BIRD_VOLUME_KEY_FEATURE_IN_CAMERA][相机设置中增加音量键功能选项][qianliliang][20150921]BEGIN
        SETTING_TYPE[ROW_SETTING_CAMERA_VOLUME_KEY_FEATURE]    = BOTH_IN_PARAMETER_AND_PREFERENCE;
        //[BIRD][BIRD_VOLUME_KEY_FEATURE_IN_CAMERA][相机设置中增加音量键功能选项][qianliliang][20150921]END
		//gangyun tech add begin
    ...
    static {
        ...
        //[BIRD][BIRD_VOLUME_KEY_FEATURE_IN_CAMERA][相机设置中增加音量键功能选项][qianliliang][20150921]BEGIN
        KEYS_FOR_SETTING[ROW_SETTING_CAMERA_VOLUME_KEY_FEATURE]       = KEY_VOLUME_KEY_FEATURE;
        //[BIRD][BIRD_VOLUME_KEY_FEATURE_IN_CAMERA][相机设置中增加音量键功能选项][qianliliang][20150921]END
		//[BIRD][BIRD_ADD_CAMERA_SHUTTERSOUND][拍照提示音控制菜单][qianliliang][20151210]BEGIN
    ...
    public static final int[] SETTING_GROUP_CAMERA_FOR_TAB = new int[]{
        ...
        //[BIRD][BIRD_VOLUME_KEY_FEATURE_IN_CAMERA][相机设置中增加音量键功能选项][qianliliang][20150921]BEGIN
        ROW_SETTING_CAMERA_VOLUME_KEY_FEATURE,
        //[BIRD][BIRD_VOLUME_KEY_FEATURE_IN_CAMERA][相机设置中增加音量键功能选项][qianliliang][20150921]END
		//[BIRD][BIRD_ADD_CAMERA_SHUTTERSOUND][拍照提示音控制菜单][qianliliang][20151210] BEGIN
		ROW_SETTING_CAMERA_SHUTTER_SOUND,
		//[BIRD][BIRD_ADD_CAMERA_SHUTTERSOUND][拍照提示音控制菜单][qianliliang][20151210] END
    };
    ...
    public static final int[] UN_SUPPORT_BY_FRONT_CAMERA_EXCEPT_CONTINUOUS_SHOT = new int[] {
        ROW_SETTING_SLOW_MOTION,
        ROW_SETTING_SLOW_MOTION_VIDEO_QUALITY,
        ROW_SETTING_STEREO_MODE,
    };
