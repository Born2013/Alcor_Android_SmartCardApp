...
public class SettingDataBase {
    ...
    static {
        ...
        //        video  videopip photostereo videostereo gangyun_beauty gangyun_blur
 ...
 MATRIX_RESTRICTION_STATE[SettingConstants.ROW_SETTING_SLOW_MOTION_VIDEO_QUALITY]    = new int[]{
        ...
        MATRIX_RESTRICTION_STATE[SettingConstants.ROW_SETTING_FACEBEAUTY_SMOOTH]     = new int[]{
                ...
                STATE_D0, STATE_D0, STATE_D0, STATE_D0, STATE_R0, STATE_R0};
        ...
        MATRIX_RESTRICTION_STATE[SettingConstants.ROW_SETTING_MULTI_FACE_MODE]       = new int[]{
                ...
                STATE_E0, STATE_D0, STATE_D0, STATE_D0, STATE_E0, STATE_E0};
        ...
        MATRIX_RESTRICTION_STATE[SettingConstants.ROW_SETTING_CAMERA_VOLUME_KEY_FEATURE]
		                   = new int[]{STATE_E0, STATE_E0, STATE_E0, STATE_E0, STATE_E0, STATE_E0, STATE_E0,  STATE_D0, STATE_E0, STATE_E0, STATE_D0, STATE_E0, STATE_E0, STATE_E0, STATE_E0, STATE_E0, STATE_E0};
        ...
        MATRIX_RESTRICTION_STATE[SettingConstants.ROW_SETTING_CAMERA_SHUTTER_SOUND]  = new int[]{
				STATE_E0, STATE_E0, STATE_E0, STATE_E0, STATE_E0, STATE_E0,
				STATE_E0, STATE_E0, STATE_E0, STATE_E0, STATE_E0, STATE_E0, 
				STATE_E0, STATE_E0, STATE_E0, STATE_E0, STATE_E0}; //56 shutter sound
    ...
    private static final int[] RESTRCTION_SETTING_INDEX = new int[] {
        ...
        //SettingConstants.ROW_SETTING_GANGYUN_AGE, 
    ...
    static {
        ...
        RESET_STATE_VALUE[SettingConstants.ROW_SETTING_DNG]
                = new String[]{"off", "on"};
		//[BIRD][BIRD_VOLUME_KEY_FEATURE_IN_CAMERA][相机设置中增加音量键功能选项][qianliliang][20150921]BEGIN
        RESET_STATE_VALUE[SettingConstants.ROW_SETTING_CAMERA_VOLUME_KEY_FEATURE]    = new String[]{"shoot"};
        //[BIRD][BIRD_VOLUME_KEY_FEATURE_IN_CAMERA][相机设置中增加音量键功能选项][qianliliang][20150921]END
		//[BIRD][BIRD_ADD_CAMERA_SHUTTERSOUND][拍照提示音控制菜单][qianliliang][20151210]BEGIN
		RESET_STATE_VALUE[SettingConstants.ROW_SETTING_CAMERA_SHUTTER_SOUND]    = new String[]{"off", "on"};
		//[BIRD][BIRD_ADD_CAMERA_SHUTTERSOUND][拍照提示音控制菜单][qianliliang][20151210]END
		//gangyun tech add begin
    ...
    static {
        ...
        //[BIRD][BIRD_VOLUME_KEY_FEATURE_IN_CAMERA][相机设置中增加音量键功能选项][qianliliang][20150921]BEGIN
        DEFAULT_VALUE_FOR_SETTING_ID[SettingConstants.ROW_SETTING_CAMERA_VOLUME_KEY_FEATURE]    = R.string.bird_pref_volume_key_feature_default;
        //[BIRD][BIRD_VOLUME_KEY_FEATURE_IN_CAMERA][相机设置中增加音量键功能选项][qianliliang][20150921]END
		//[BIRD][BIRD_ADD_CAMERA_SHUTTERSOUND][拍照提示音控制菜单][qianliliang][20151210]BEGIN
