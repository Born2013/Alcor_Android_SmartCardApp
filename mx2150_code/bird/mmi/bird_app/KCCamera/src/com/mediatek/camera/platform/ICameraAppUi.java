...
import com.android.camera.manager.ZoomManager;//[BIRD][BIRD_VOLUME_KEY_FEATURE_IN_CAMERA][相机设置中增加音量键功能选项][qianliliang][20151209]
...
public interface ICameraAppUi {
   ...
   */
	...
	public ZoomManager getZoomManager();//[BIRD][BIRD_VOLUME_KEY_FEATURE_IN_CAMERA][相机设置中增加音量键功能选项][qianliliang][20151209]
