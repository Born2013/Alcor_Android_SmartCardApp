...
public class CameraAnimation {
    ...
    public void doCaptureAnimation(final View view, Activity activity,
        ...
        ObjectAnimator scaleX = ObjectAnimator.ofFloat(view, "scaleX", 0, 1f).setDuration(CameraAnimation.SLIDE_DURATION);    
        ObjectAnimator scaleY = ObjectAnimator.ofFloat(view, "scaleY", 0, 1f).setDuration(CameraAnimation.SLIDE_DURATION);    

        mCaptureAnimator = new AnimatorSet();
        mCaptureAnimator.playTogether(scaleX, scaleY);
        ...
        mCaptureAnimator.addListener(new Animator.AnimatorListener() {
            ...
            public void onAnimationEnd(Animator animator) {
                ...
                view.setClickable(true);//[BIRD][BIRD_KUSAI_CAMERA][chengshujiang]20170623
            }
