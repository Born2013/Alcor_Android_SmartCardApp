...
public class AdditionManager {
    ...
    public AdditionManager(ICameraContext cameraContext) {
        ...
        mGangyunBeautyAddition.add(mIContinuousShotAddition); //gangyun tech add 
        mGangyunBokehAddition.add(mIContinuousShotAddition);//gangyun tech add
    ...
    public void setCurrentMode(CameraModeType type) {
		...
		case EXT_MODE_GY_BOKEH:
	            mModeAddition = mGangyunBokehAddition;
	            break;
