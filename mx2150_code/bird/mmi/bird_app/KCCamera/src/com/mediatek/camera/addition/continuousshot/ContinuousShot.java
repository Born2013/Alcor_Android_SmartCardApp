...
//[BIRD][BIRD_ADD_CAMERA_SHUTTERSOUND][拍照提示音控制菜单][修改连拍声音控制][dingjiayuan][20161102]begin
import com.android.camera.FeatureSwitcher;
//[BIRD][BIRD_ADD_CAMERA_SHUTTERSOUND][拍照提示音控制菜单][修改连拍声音控制][dingjiayuan][20161102]end
...
public class ContinuousShot extends CameraAddition implements ContinuousShotListener {
    ...
    public boolean IsShutterSoundEnable() {
        boolean mShutterSound = "on".equals(mISettingCtrl.getSettingValue(SettingConstants.KEY_CAMERA_SHUTTER_SOUND));
        Log.i("dingjiayuan","IsShutterSoundEnable() = "+ mShutterSound);
        return mShutterSound;
    }
	//[BIRD][BIRD_ADD_CAMERA_SHUTTERSOUND][拍照提示音控制菜单][修改连拍声音控制][dingjiayuan][20161102]end
    // Running in main thread
