...
public class ModeChecker {
    ...
    static {
        ...
        MATRIX_NORMAL_ENABLE[ModePicker.MODE_FACEART]     = new boolean[]{true, true};
		if(GYConfig.BOKEH_SUPPORT_FRONT)
	        MATRIX_NORMAL_ENABLE[ModePicker.MODE_BOKEH]     = new boolean[]{true, true};
		else
		    MATRIX_NORMAL_ENABLE[ModePicker.MODE_BOKEH]     = new boolean[]{true, false}; 
    ...
    public static void updateModeMatrix(CameraActivity camera, int cameraId) {
        ...
        if (FeatureSwitcher.BIRD_REMOVE_PIP_MODE) {
	...
	if(FeatureSwitcher.isGyBokehSupported())//FeatureOption.GANGYUN_CAMERA_BEAUTY
	{
	    MATRIX_NORMAL_ENABLE[ModePicker.MODE_BOKEH][cameraId] = true;
	    if( cameraId == 1 &&  !GYConfig.BOKEH_SUPPORT_FRONT)			
			 MATRIX_NORMAL_ENABLE[ModePicker.MODE_BOKEH][cameraId] = false;
