...
public class CameraActivity extends ActivityBase implements
    ...
    /*[BIRD][BIRD_FINGER_PRINT][指纹功能拓展][yangbo][20160826]BEGIN */
    private static final int MSG_RESTART_FINGERPRINT = 19;
    private static final int MSG_CHECK_FINGERPRINT_SHOULD_START = 20;
    /*[BIRD][BIRD_FINGER_PRINT][指纹功能拓展][yangbo][20160826]END */
    ...
    private boolean mIsFingerprintTakePhotoTurnOn = false;
    /*[BIRD][BIRD_FINGER_PRINT][指纹功能拓展][yangbo][20160826]END */

    //[BIRD][BIRD_BACK_CAMERA_FOCUS_FAKE][后摄对焦作假][qianliliang][20160506] BEGIN
    FocusManager mFocusManager;
    //[BIRD][BIRD_BACK_CAMERA_FOCUS_FAKE][后摄对焦作假][qianliliang][20160506] END
    ...
    public void onCreate(Bundle icicle) {
        ...
        CameraPerformanceTracker.onEvent(TAG,
                ...
                CameraPerformanceTracker.ISEND);
        /*[BIRD][BIRD_DIRECT_WITH_PROXIMITY][智能体感][yangbo][20150605]BEGIN */
        if (FeatureSwitcher.BIRD_DIRECT_WITH_PROXIMITY) {
            if (getProximitySwitchEnable()) {
                mShutterPhotoProxSensor = new ShutterPhotoProxSensor();
            }
        }
        /*[BIRD][BIRD_DIRECT_WITH_PROXIMITY][智能体感][yangbo][20150605]END */
        //[BIRD_ONBACKPRESS_TAKE_PHOTO][在锁屏亮屏界面长按back打开相机并拍照][hongzhihao][20170613]begin
        ...
        if (bundle != null) {
            sh = bundle.getBoolean("sh");
            if (mCameraActor instanceof PhotoActor) {
                PhotoActor a = (PhotoActor) mCameraActor;
                a.setShut(sh);
            }
        }   
        //[BIRD_ONBACKPRESS_TAKE_PHOTO][在锁屏亮屏界面长按back打开相机并拍照][hongzhihao][20170613]end
    ...
    protected void onResume() {
        ...
        /*[BIRD][BIRD_FLASHLIGHT][手电筒接口][luye][20160527]begin*/
		if(FeatureSwitcher.BIRD_IUI_FLASHLIGHT_SUPPORT) {
		    Intent intent = new Intent("com.bird.flashlight.ACTION_SOS_OFF");
		    Intent intent1 = new Intent("com.bird.flashlight.ACTION_HIDE");
		    sendBroadcast(intent);
		    sendBroadcast(intent1);
		    FlashLightJni.turn_off_flashlight();
		}
        /*[BIRD][BIRD_FLASHLIGHT][手电筒接口][luye][20160527]end*/
		/*[BIRD][BIRD_DIRECT_WITH_PROXIMITY][智能体感][yangbo][20150605]BEGIN */
        if(FeatureSwitcher.BIRD_DIRECT_WITH_PROXIMITY == true){
            if(getProximitySwitchEnable()) {
                if (mShutterPhotoProxSensor == null) {
                    mShutterPhotoProxSensor = new ShutterPhotoProxSensor();
                }
                mShutterPhotoProxSensor.start();
            } else {
                if (mShutterPhotoProxSensor != null) {
                    mShutterPhotoProxSensor.stop();
                    mShutterPhotoProxSensor = null;
                }
            }
        }
        /*[BIRD][BIRD_DIRECT_WITH_PROXIMITY][智能体感][yangbo][20150605]END */
        ...
        /*[BIRD][BIRD_FINGER_PRINT][指纹功能拓展][yangbo][20160826]BEGIN */
        if (FeatureSwitcher.BIRD_FINGER_PRINT) {
            mMainHandler.removeMessages(MSG_CHECK_FINGERPRINT_SHOULD_START);
            mMainHandler.sendEmptyMessageDelayed(MSG_CHECK_FINGERPRINT_SHOULD_START, 500);
        }
        /*[BIRD][BIRD_FINGER_PRINT][指纹功能拓展][yangbo][20160826]END */
        
        //[BIRD][BIRD_BACK_CAMERA_FOCUS_FAKE][后摄对焦作假][qianliliang][20160506] BEGIN
        if (FeatureSwitcher.BIRD_BACK_CAMERA_FOCUS_FAKE) {
            mFocusManager = mCameraDeviceCtrl.getFocusManager();
            mMainHandler.sendEmptyMessageDelayed(2017, 1000);
            new Thread() {
                public void run() {
                    try {
                        while (true) {
                            sleep(8500);
                            mMainHandler.sendEmptyMessage(2017);
                        }
    ...
    protected void onPause() {
        ...
        CameraPerformanceTracker.onEvent(TAG,
                CameraPerformanceTracker.NAME_CAMERA_ON_PAUSE,
                CameraPerformanceTracker.ISEND);
        //[BIRD][BIRD_FLASHLIGHT][手电筒接口][luye][20160527] BEGIND
		if(FeatureSwitcher.BIRD_IUI_FLASHLIGHT_SUPPORT) {
		    Intent intent = new Intent("com.bird.flashlight.ACTION_SHOW");
		    sendBroadcast(intent);
		}
        //[BIRD][BIRD_FLASHLIGHT][手电筒接口][luye][20160527] END
		/*[BIRD][BIRD_DIRECT_WITH_PROXIMITY][智能体感][yangbo][20150605]BEGIN */
        ...
        /*[BIRD][BIRD_FINGER_PRINT][指纹功能拓展][yangbo][20160826]BEGIN */
        if (FeatureSwitcher.BIRD_FINGER_PRINT) {
            mIsFingerprintTakePhotoTurnOn = false;
            stopFingerprint();
        }
        /*[BIRD][BIRD_FINGER_PRINT][指纹功能拓展][yangbo][20160826]END */
    }
    ...
    public void onSingleTapUp(View view, int x, int y) {
        ...
        //[BIRD][BIRD_BACK_CAMERA_FOCUS_FAKE][后摄对焦作假][qianliliang][20160506] BEGIN
        if (FeatureSwitcher.BIRD_BACK_CAMERA_FOCUS_FAKE && mFocusManager != null && getCameraId() == 0) {
            Log.i(TAG, "BIRD_BACK_CAMERA_FOCUS_FAKE onSingleTapUp start");
            mFocusManager.onSingleTapUp(x, y);
            //if (getParameters() != null && getCameraDevice() != null) {
            //    getCameraDevice().setParametersAsync(getParameters(), 1);
            //}
            Log.i(TAG, "BIRD_BACK_CAMERA_FOCUS_FAKE onSingleTapUp end");
        }
        //[BIRD][BIRD_BACK_CAMERA_FOCUS_FAKE][后摄对焦作假][qianliliang][20160506] END
    ...
    private Handler mMainHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            case MSG_UPDATE_SWITCH_ACTOR_STATE:
                ...
                break;
            /*[BIRD][BIRD_FINGER_PRINT][指纹功能拓展][yangbo][20160826]BEGIN */
            case MSG_RESTART_FINGERPRINT:
                stopFingerprint();
                startFingerprint();
                break;
            case MSG_CHECK_FINGERPRINT_SHOULD_START:
                mIsFingerprintTakePhotoTurnOn = false;
                ...
                for (int i = 0; i < fingerprintCount; i++) {
                    ...
                    if (fingerprintManager.isTakePhotoEnable(item.getFingerId(), item.getGroupId())) {
                        mIsFingerprintTakePhotoTurnOn = true;
                        break;
                    }
                }
                if (mIsFingerprintTakePhotoTurnOn && hasWindowFocus()) {
                    startFingerprint();
                }
                break;
            /*[BIRD][BIRD_FINGER_PRINT][指纹功能拓展][yangbo][20160826]END */
            //[BIRD][BIRD_BACK_CAMERA_FOCUS_FAKE][后摄对焦作假][qianliliang][20160506] BEGIN
            case 2017:
                if (mFocusManager != null && getCameraId() == 0) {
                    mFocusManager.onSingleTapUp(2017, 2017);
                }
                break;
            //[BIRD][BIRD_BACK_CAMERA_FOCUS_FAKE][后摄对焦作假][qianliliang][20160506] END
            default:
    ...
    private PickerManager.PickerListener mPickerListener = new PickerManager.PickerListener() {
        ...
        public boolean onFlashPicked(String flashMode) {
            /*[BIRD][BIRD_FLASH_LIGHT_TORCH][前摄闪光灯补光模式时常亮][zhangaman][20170214]begin*/
            if (FeatureSwitcher.BIRD_FLASH_LIGHT_TORCH) {
                int currentCameraId = mCameraDeviceCtrl.getCameraId();
                if (currentCameraId == 1 && flashMode.equals(Parameters.FLASH_MODE_ON)) {
                    flashMode = Parameters.FLASH_MODE_TORCH;
                }
            }
            /*[BIRD][BIRD_FLASH_LIGHT_TORCH][前摄闪光灯补光模式时常亮][zhangaman][20170214]end*/
    ...
    private boolean isPIPMode(int mode) {
        return mode == ModePicker.MODE_VIDEO_PIP
                ...
                || mode == ModePicker.MODE_BOKEH;//[BIRD][GANGYUN_BOKEH_SUPPORT][双摄][yangheng][20170215] 
    }
    ...
    public void onWindowFocusChanged(boolean hasFocus) {
        ...
        if(FeatureSwitcher.BIRD_DIRECT_WITH_PROXIMITY){
        	if(hasFocus && getProximitySwitchEnable()) {
        		if (mShutterPhotoProxSensor == null) {
        			mShutterPhotoProxSensor = new ShutterPhotoProxSensor();
        		}
        	    mShutterPhotoProxSensor.start();
    ...
    private long secTimestamp = 0;

    ShutterPhotoProxSensor mShutterPhotoProxSensor;

    class ShutterPhotoProxSensor implements SensorEventListener {
            ...
            try {
                if (event.values!=null && event.values.length>0) {
                    ...
                    if(event.values[0] < this.mMaxRange) {
                        isCover = true;
                    } else if ((secTimestamp - firstTimestamp) >= 30000000l
						&& (secTimestamp - firstTimestamp)<=1000000000 && !IsClamClosed()) {
                        if(isCover){
    ...
    private void takePhotoOrRecordVideo(){
        if (mCameraAppUi != null) {
            mCameraAppUi.takePhotoOrRecordVideo(!isVideoMode());
        }
    }

    private boolean getProximitySwitchEnable(){
        if (FeatureSwitcher.BIRD_DIRECT_WITH_PROXIMITY == true) {
            if ((Settings.System.getInt(getContentResolver(),Settings.System.BIRD_DIRECT_CAMERA, 0) == 1)
    ...
    private boolean IsClamClosed() {
        return false;
    }
    /*[BIRD][BIRD_DIRECT_WITH_PROXIMITY][智能体感][yangbo][20150605]END */
//gangyun tech add begin 
	public boolean isgyFullScreen() {
		String artio = getPreferences().getString(SettingConstants.KEY_PICTURE_RATIO,
                null);
        if(artio != null && artio.equals("1.7778")){
			Log.d(TAG, " isgyFullScreen a :"+artio);
		    return true;
    	}else{
			Log.d(TAG, " isgyFullScreen b :"+artio);
			return false;
		}	
    }
//gangyun tech add end 
    ...
    private void startFingerprint() {
        mMainHandler.removeMessages(MSG_RESTART_FINGERPRINT);
        if (mIsFingerprintTakePhotoTurnOn) {
    ...
    private class FingerprintHelper extends FingerprintManager.AuthenticationCallback {
        ...
        public void startListening() {
            ...
            if (mCancellationSignal != null) { //已经开启过了
                return;
            }
		...
		public void onAuthenticationSucceeded(FingerprintManager.AuthenticationResult result) {
		    if (mFingerprintManager.isTakePhotoEnable(result.getFingerprint().getFingerId(), result.getFingerprint().getGroupId())) {
		        if (!isVideoMode()) {
			        takePhotoOrRecordVideo();
		        }
	        }
			mMainHandler.sendEmptyMessageDelayed(MSG_RESTART_FINGERPRINT, 1000);
		}
		...
		public void onAuthenticationError(int errorCode, CharSequence errString) {
		    if (errorCode == FingerprintManager.FINGERPRINT_ERROR_LOCKOUT) {
		        ...
		        mMainHandler.sendEmptyMessageDelayed(MSG_RESTART_FINGERPRINT, 700);
		    }
		}
