...
public class FeatureSwitcher {
    ...
    //[BIRD][BIRD_VOLUME_KEY_FEATURE_IN_CAMERA][相机设置中增加音量键功能选项][qianliliang][20151209] BEGIN
    public static final boolean BIRD_VOLUME_KEY_FEATURE_IN_CAMERA = getValue("ro.bd_volume_key_in_camera");
    //[BIRD][BIRD_VOLUME_KEY_FEATURE_IN_CAMERA][相机设置中增加音量键功能选项][qianliliang][20151209] END
	//[BIRD][BIRD_ADD_CAMERA_SHUTTERSOUND][拍照提示音控制菜单][qianliliang][20151210] BEGIN
	public static final boolean BIRD_ADD_CAMERA_SHUTTERSOUND = SystemProperties.get("ro.bird_add_camera_shuttersound").equals("1");
	//[BIRD][BIRD_ADD_CAMERA_SHUTTERSOUND][拍照提示音控制菜单][qianliliang][20151210] END
	//[BIRD][BIRD_CAMERA_PICTURESIZE_STANDARD][相机设置中预览大小默认设置为标准(4:3)][20150823]BEGIN
	public static final boolean BIRD_CAMERA_PICTURESIZE_STANDARD = SystemProperties.get("ro.bird_camera_picsize_4_3").equals("1");
	//[BIRD][BIRD_CAMERA_PICTURESIZE_STANDARD][相机设置中预览大小默认设置为标准(4:3)][20150823]END

	/*[BIRD][BIRD_FLASHLIGHT][IUI手电筒][luye][20160527]begin*/
    public static final boolean BIRD_IUI_FLASHLIGHT_SUPPORT = getValue("ro.bd_iui_flashlight");
	/*[BIRD][BIRD_FLASHLIGHT][IUI手电筒][luye][20160527]end*/
    /*[BIRD][BIRD_FLASH_LIGHT_TORCH][前摄闪光灯补光模式时常亮][zhangaman][20170214]begin*/
    public static final boolean BIRD_FLASH_LIGHT_TORCH = getValue("ro.bird_flash_torch");
    /*[BIRD][BIRD_FLASH_LIGHT_TORCH][前摄闪光灯补光模式时常亮][zhangaman][20170214]end*/
    //[BIRD][BIRD_REMOVE_PIP_MODE][删除画中画模式][yangheng][20170228] BEGIN
    public static final boolean BIRD_REMOVE_PIP_MODE = getValue("ro.bd_rm_pip_mode");
    //[BIRD][BIRD_REMOVE_PIP_MODE][删除画中画模式][yangheng][20170228] END
    /*[BIRD][BIRD_FINGER_PRINT][指纹功能拓展][yangbo][20160826]BEGIN */
    public static final boolean BIRD_FINGER_PRINT = getValue("ro.bd_fingerprint_ex");
    /*[BIRD][BIRD_FINGER_PRINT][指纹功能拓展][yangbo][20160826]END */
    //[BIRD][BIRD_VIDEW_QUALITY_KEY_FINE][录像画质改为精细][yangheng][20170314] BEGIN
    public static final boolean BIRD_VIDEW_QUALITY_KEY_FINE = getValue("ro.bd_quality_fine");
    //[BIRD][BIRD_VIDEW_QUALITY_KEY_FINE][录像画质改为精细][yangheng][20170314] END
    //[BIRD][BIRD_GANGYUN_NO_REAL][假双摄][yangheng][20170314] BEGIN
    public static final boolean BIRD_GANGYUN_NO_REAL = getValue("ro.bd_gangyun_no_real");
    //[BIRD][BIRD_GANGYUN_NO_REAL][假双摄][yangheng][20170314] END
    //[BIRD][BIRD_BACK_CAMERA_FOCUS_FAKE][后摄对焦作假][qianliliang][20160506] BEGIN
    public static final boolean BIRD_BACK_CAMERA_FOCUS_FAKE = SystemProperties.get("ro.bd_back_camera_focus_fake").equals("1");
	...
	public static final boolean BIRD_CAMERA_PIXEL_FRAUD = getValue("ro.bd_camera_piexl");
