...
public class Storage {
    ...
    public static final String DIRECTORY = DCIM + "/" + SystemProperties.get("ro.bd_camera_filename", "Camera");

    public static final String FOLDER_PATH = "/" + Environment.DIRECTORY_DCIM + "/" + SystemProperties.get("ro.bd_camera_filename", "Camera");
