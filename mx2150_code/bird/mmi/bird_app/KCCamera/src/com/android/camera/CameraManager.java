...
public class CameraManager {
    ...
    private static final int DISNABLE_SHUTTER_SOUND = 30;
        ...
        public void handleMessage(final Message msg) {
            ...
            try {
                ...
                case ENABLE_SHUTTER_SOUND:
					...
					Log.i(TAG, "BIRD, mCamera.enableShutterSound() = Enable");
                    break;
                case DISNABLE_SHUTTER_SOUND:
                    mCamera.disnableShutterSound();
					Log.i(TAG, "BIRD, mCamera.enableShutterSound() = Disable");
                    break;
				//[BIRD][BIRD_ADD_CAMERA_SHUTTERSOUND][拍照提示音控制菜单][qianliliang][20151210]END
                ...
                case START_PREVIEW_ASYNC:
                    CameraPerformanceTracker.onEvent(TAG,
                            ...
                            CameraPerformanceTracker.ISBEGIN);
                    //[BIRD][TASK-4072][真双摄反复按home键 停止运行][yangheng][20170318] BEGIN
                    try {
                        mCamera.startPreview();
                    } catch (Exception e) {
                        Log.i("daulcamera", "e = " + e.getMessage());
                    }
                    //[BIRD][TASK-4072][真双摄反复按home键 停止运行][yangheng][20170318] END
