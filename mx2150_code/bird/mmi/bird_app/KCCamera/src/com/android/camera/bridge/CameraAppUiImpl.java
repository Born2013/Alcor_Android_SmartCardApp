...
//gangyun tech add end 
    ...
    private OnShutterButtonListener mVideoShutterListener = new OnShutterButtonListener() {
        ...
        @Override
        public boolean onShutterButtonClick(final ShutterButton button) {
            Log.i(TAG,
    ...
    public void takePhotoOrRecordVideo(boolean isPhoto){
        if (mShutterManager != null) {
            if (isPhoto) {
                mShutterManager.performPhotoShutter();
            } else {
                mShutterManager.getVideoShutter().performClick();
            }
        }
    }
