...
import com.gangyun.camera.GYConfig;//gangyun tech add 
...
public class FocusManager implements CameraActivity.OnOrientationListener,
    ...
    private static final int MSG_SHOW_FOCUS_END = 2000;
    ...
    private class MainHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            case MSG_SHOW_FOCUS_END:
                ...
                //    mContext.getCameraDevice().setParametersAsync(mContext.getParameters(), 0);
                //}
                break;
            //[BIRD][BIRD_BACK_CAMERA_FOCUS_FAKE][后摄对焦作假][qianliliang][20160506] BEGIN
            default:
        ...
        if (mState == STATE_FOCUSING_SNAP_ON_FINISH) {
            ...
            if (focused) {
                ...
                if (!Parameters.FOCUS_MODE_CONTINUOUS_PICTURE.equals(mFocusMode)) {
					 //gangyun tech add begin 
                    if( mContext.getCurrentMode() ==ModePicker.MODE_BOKEH && GYConfig.BOKEH_NO_PLAY_FOCUS_SOUND){
						//mListener.playSound(MediaActionSound.FOCUS_COMPLETE);
					}
					else
					//gangyun tech add end
    ...
    public void onSingleTapUp(int x, int y) {
        ...
        if (!mFocusAreaSupported && !FeatureSwitcher.BIRD_BACK_CAMERA_FOCUS_FAKE) {//[BIRD][BIRD_BACK_CAMERA_FOCUS_FAKE][后摄对焦作假][qianliliang][20160506]
        ...
        //[BIRD][BIRD_BACK_CAMERA_FOCUS_FAKE][后摄对焦作假][qianliliang][20160506] BEGIN
        mNeedPlaySound = true;
        if (FeatureSwitcher.BIRD_BACK_CAMERA_FOCUS_FAKE && x == 2017 && y == 2017) {
            x = (int)(previewWidth / 2);
            y = (int)(previewHeight / 2);
        ...
        mListener.setFocusParameters();
        ////[BIRD][BIRD_BACK_CAMERA_FOCUS_FAKE][后摄对焦作假][yangheng][20170613] BEGIN
        if (mFocusAreaSupported) {
            ...
            mHandler.sendEmptyMessageDelayed(RESET_TOUCH_FOCUS, 3000);
            ...
            if (FeatureSwitcher.BIRD_BACK_CAMERA_FOCUS_FAKE) {
                ...
                Log.i("qianliliang","2016 001");
            }
            //[BIRD][BIRD_BACK_CAMERA_FOCUS_FAKE][后摄对焦作假][qianliliang][20160506] END
        }
        ////[BIRD][BIRD_BACK_CAMERA_FOCUS_FAKE][后摄对焦作假][yangheng][20170613] BEGINyangheng
    }
