#[BIRD][BIRD_KUSAI_CAMERA][chengshujiang]20170623 begin
ifeq ($(strip $(BIRD_KUSAI_CAMERA)), yes)
...
#[BIRD][BIRD_KUSAI_CAMERA][chengshujiang]20170623
LOCAL_SRC_FILES += ../KCCamera/src/com/mediatek/camera/addition/remotecamera/service/ICameraClientCallback.aidl
LOCAL_SRC_FILES += ../KCCamera/src/com/mediatek/camera/addition/remotecamera/service/IMtkCameraService.aidl
#[BIRD][BIRD_KUSAI_CAMERA][chengshujiang]20170623
LOCAL_AIDL_INCLUDES += $(LOCAL_PATH)/src

#[BIRD][BIRD_NAVIGATIONBAR_SUPPORT][task-6098]songwei 20171013 begin
ifeq ($(BIRD_NAVIGATIONBAR_SUPPORT),yes) 
LOCAL_RESOURCE_DIR := $(LOCAL_PATH)/navbar
endif
#[BIRD][BIRD_NAVIGATIONBAR_SUPPORT][task-6098]songwei 20171013 end
...
ifeq ($(GANGYUN_BOKEH_SUPPORT), yes)
    LOCAL_JNI_SHARED_LIBRARIES += libBlurModoule   #gangyun tech add libBlurModoule
endif
...
#[BIRD][BIRD_KUSAI_CAMERA][chengshujiang]20170623 end
