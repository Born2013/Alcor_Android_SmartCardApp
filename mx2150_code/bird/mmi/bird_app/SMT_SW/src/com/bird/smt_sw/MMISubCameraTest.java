...
public class MMISubCameraTest extends MMINewActivity {
	...
	private View.OnClickListener mCorrectButtonHandler = new View.OnClickListener() {
		...
		public void onClick(View v) {
			...
			mEditor.putInt(MMISubCameraTest.this.getString(R.string.sub_camera), Test_launcherActivity.PASS);
			mEditor.commit();
			finish();
		}
	};
	...
	private View.OnClickListener mErrorButtonHandler = new View.OnClickListener() {
		...
		public void onClick(View v) {
			...
			mEditor.putInt(MMISubCameraTest.this.getString(R.string.sub_camera), Test_launcherActivity.FAIL);
			mEditor.commit();
			finish();
		}
	};	
	...
	private View.OnClickListener mRestdButtonHandler = new View.OnClickListener() {
		...
		public void onClick(View v) {
			//Intent intent = null;	
			//intent = new Intent(DeviceTestSubCamera.this,DeviceTestSubCamera.class);
		    //startActivityForResult(intent, 0);
			Intent intent = new Intent();
			ComponentName comp = new ComponentName(MMISubCameraTest.this, MMISubCameraTest.class);
