...
public class MMIRecordMainBoardMic extends MMINewActivity {
...
//	};
	...
	private void playRecord()
	{
		...
		//setReceiverMode();//xuzhenguo receiver mode
	...
	protected void onDestroy()	{
		...
		Log.d(TAG, "onDestroy");
		super.onDestroy();
		//recoverMode();//xuzhenguo receiver mode
	...
	private View.OnClickListener mCorrectButtonHandler = new View.OnClickListener(){
		...
		public void onClick(View v){
			mEditor.putInt(MMIRecordMainBoardMic.this.getString(R.string.board_record), Test_launcherActivity.PASS);
			mEditor.commit();
			finish();
		}
	};
	...
	private View.OnClickListener mErrorButtonHandler = new View.OnClickListener(){
		...
		public void onClick(View v){
			mEditor.putInt(MMIRecordMainBoardMic.this.getString(R.string.board_record), Test_launcherActivity.FAIL);
			mEditor.commit();
			finish();
		}
	};
	...
	private View.OnClickListener mRestdButtonHandler = new View.OnClickListener(){
		...
		public void onClick(View v){
			...
			ComponentName comp = new ComponentName(MMIRecordMainBoardMic.this, MMIRecordMainBoardMic.class);
