...
public class MMIMainCameraTest extends MMINewActivity {
	...
	private View.OnClickListener mCorrectButtonHandler = new View.OnClickListener() {
		...
		public void onClick(View v) {
			mEditor.putInt(MMIMainCameraTest.this.getString(R.string.main_camera), Test_launcherActivity.PASS);
			mEditor.commit();
			finish();
		}
	};
	...
	private View.OnClickListener mErrorButtonHandler = new View.OnClickListener() {
		...
		public void onClick(View v) {
			mEditor.putInt(MMIMainCameraTest.this.getString(R.string.main_camera), Test_launcherActivity.FAIL);
			mEditor.commit();
			finish();
		}
	};
	...
	private View.OnClickListener mRestdButtonHandler = new View.OnClickListener() {
		...
		public void onClick(View v) {
			...
			ComponentName comp = new ComponentName(MMIMainCameraTest.this, MMIMainCameraTest.class);
