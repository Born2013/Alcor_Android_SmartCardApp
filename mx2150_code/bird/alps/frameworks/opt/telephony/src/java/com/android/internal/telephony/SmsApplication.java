...
/*[BIRD][BIRD_ZX_SHOUFUBAO_APPS][中兴守护宝][yangbo][20170729]BEGIN */
import java.util.Arrays;
import android.text.TextUtils;
/*[BIRD][BIRD_ZX_SHOUFUBAO_APPS][中兴守护宝][yangbo][20170729]END */
...
public final class SmsApplication {
    ...
    /*[BIRD][BIRD_ZX_SHOUFUBAO_APPS][中兴守护宝][yangbo][20170729]BEGIN */
    private static final List<String> ZX_APPS = Arrays.asList("com.njzx.launcher", "com.njzx.lock", "com.njzx.shbmoniservice", "com.njzx.shbremotedesktop", "com.njzx.traffic", "com.njzx.weather", "com.cutecomm.cloudcc.service", "com.njzx.shbsetting");
    /*[BIRD][BIRD_ZX_SHOUFUBAO_APPS][中兴守护宝][yangbo][20170729]END */
    ...
    public static boolean shouldWriteMessageForPackage(String packageName, Context context) {
        ...
        if(FeatureOption.BIRD_EWC_VETTEL && (packageName != null) && packageName.equals("com.nbbird.ewc")) {
            return false;
        }
        ...
        if (FeatureOption.BIRD_ZX_SHOUFUBAO_APPS) {
            if (!TextUtils.isEmpty(packageName) && ZX_APPS.contains(packageName)) {
                return false;
            }
        }
        /*[BIRD][BIRD_ZX_SHOUFUBAO_APPS][中兴守护宝][yangbo][20170729]END */
