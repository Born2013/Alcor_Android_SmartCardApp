...
*/
    ...
    isSupportedOverImsPhone() {
        if (isShortCode()) return true;
            ...
            if (mPhone.isVolteEnabled()
                ...
                // UT not support over wifi calling
                return false;
            }
    ...
    processCode () throws CallStateException {
        mPhone.setCSCurrentPhoneId(mPhone.getPhoneId());
        try {
        ...
        if (ar.exception != null) {
            ...
            if (mIsCallFwdReg) {
                ...
                if (SystemProperties.get("ro.bd_spanish_call_tran").equals("1") && language != null && language.endsWith("es") && esChange == 1) {
                    ...
                    sb.append("\n");
                    Log.i("chenguangxiang","serviceRegistered3:"+esScvalues);
                    if (esScvalues == 21) {
                        esScvalues = 0;
            ...
            if (SystemProperties.get("ro.bd_spanish_call_tran").equals("1") && language != null && language.endsWith("es") && esChange == 1) {
                ...
                sb = new StringBuilder("");
                sb.append("\n");
                Log.i("chenguangxiang","serviceDisabled4:"+esScvalues);
                if (esScvalues == 21) {
                    esScvalues = 0;
            ...
            if (SystemProperties.get("ro.bd_spanish_call_tran").equals("1") && language != null && language.endsWith("es") && esChange == 1) {
                ...
                sb = new StringBuilder("");
                sb.append("\n");
                Log.i("chenguangxiang","serviceRegistered4:"+esScvalues);
                if (esScvalues == 21) {
                    esScvalues = 0;
                    sb.append("El desvio de llamadas incondicional se ha activado correctamente.");
                } else if (esScvalues == 67) {
        ...
        if (ar.exception != null) {
            ...
            if (infos.length == 0) {
                ...
                if (SystemProperties.get("ro.bd_spanish_call_tran").equals("1") && language != null && language.endsWith("es") && esChange == 1) {
                    ...
                    sb = new StringBuilder("");
                    sb.append("\n");
                    Log.i("chenguangxiang","serviceDisabled5:"+esScvalues);
                    if (esScvalues == 21) {
                        esScvalues = 0;
                        sb.append("El desvio de llamadas incondicional se ha desactivado correctamente.");
                    } else if (esScvalues == 67) {
            ...
            if (ar.result instanceof Bundle) {
                ...
                if (ssInfo != null) {
                    ...
                    if (ssInfo.mStatus == ImsSsInfo.DISABLED) {
                        ...
                        if (SystemProperties.get("ro.bd_spanish_call_tran").equals("1") && language != null && language.endsWith("es") && esChange == 1) {
                            ...
                            sb = new StringBuilder("");
                            sb.append("\n");
                            Log.i("chenguangxiang","serviceDisabled6:"+esScvalues);
                            if (esScvalues == 21) {
                                esScvalues = 0;
                                sb.append("El desvio de llamadas incondicional se ha desactivado correctamente.");
                            } else if (esScvalues == 67) {
                ...
                if (cbInfos[0] == 1) {
                    ...
                    if (SystemProperties.get("ro.bd_spanish_call_tran").equals("1") && language != null && language.endsWith("es") && esChange == 1) {
                        ...
                        sb = new StringBuilder("");
                        sb.append("\n");
                        Log.i("chenguangxiang","serviceDisabled7:"+esScvalues);
                        if (esScvalues == 21) {
                            esScvalues = 0;
                            sb.append("El desvio de llamadas incondicional se ha desactivado correctamente.");
                        } else if (esScvalues == 67) {
        ...
        if (ar.exception != null) {
            ...
            if (infos.length == 0) {
                ...
                if (SystemProperties.get("ro.bd_spanish_call_tran").equals("1") && language != null && language.endsWith("es") && esChange == 1) {
                    ...
                    sb = new StringBuilder("");
                    sb.append("\n");
                    Log.i("chenguangxiang","serviceDisabled8:"+esScvalues);
                    if (esScvalues == 21) {
                        esScvalues = 0;
                        sb.append("El desvio de llamadas incondicional se ha desactivado correctamente.");
                    } else if (esScvalues == 67) {
                ...
                for (int i = 0, s = infos.length; i < s ; i++) {
                    if (infos[i].mIcbNum !=null) {
                        ...
                        if (SystemProperties.get("ro.bd_spanish_call_tran").equals("1") && language != null && language.endsWith("es") && esChange == 1) {
                            ...
                            sb = new StringBuilder("");
                            sb.append("\n");
                            Log.i("chenguangxiang","serviceDisabled9:"+esScvalues);
                            if (esScvalues == 21) {
                                esScvalues = 0;
                                sb.append("El desvio de llamadas incondicional se ha desactivado correctamente.");
                            } else if (esScvalues == 67) {
                                ...
                                sb.append(mContext.getText(com.android.internal
                                        .R.string.zzzzz_bird_serviceDisabled));
                            }
                        } else {
                            sb.append(mContext.getText(com.android.internal
            ...
            if (ints.length != 0) {
                if (ints[0] == 0) {
                    ...
                    if (SystemProperties.get("ro.bd_spanish_call_tran").equals("1") && language != null && language.endsWith("es") && esChange == 1) {
                        ...
                        sb = new StringBuilder("");
                        sb.append("\n");
                        Log.i("chenguangxiang","serviceDisabled10:"+esScvalues);
                        if (esScvalues == 21) {
                            esScvalues = 0;
                            sb.append("El desvio de llamadas incondicional se ha desactivado correctamente.");
                        } else if (esScvalues == 67) {
