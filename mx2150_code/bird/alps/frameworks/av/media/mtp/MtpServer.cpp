...
MtpResponseCode MtpServer::doGetDeviceInfo() {
    ...
    //[BIRD][BIRD_PRODUCT_DEVICE_NAME][可配置手机连接电脑时PTP显示的名字][FAQ04857][20160517] BEGIN
    property_get("ro.product.bird.device.name", prop_value, "MTP Device");
    //[BIRD][BIRD_PRODUCT_DEVICE_NAME][可配置手机连接电脑时PTP显示的名字][FAQ04857][20160517] END
    string.set(prop_value);
