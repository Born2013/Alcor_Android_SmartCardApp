...
//[BIRD][BIRD_OLD_PHONE] chengci 20170803 begin
import android.provider.Settings; 
import android.os.SystemProperties;
import android.util.TypedValue;
//[BIRD][BIRD_OLD_PHONE] chengci 20170803 end
...
public class Notification implements Parcelable
{
    ...
    public static class Builder {
        ...
        private void bindProfileBadge(RemoteViews contentView) {
            ...
            if (profileBadge != null) {
                ...
                //[BIRD][BIRD_OLD_PHONE] chengci added 20170803 begin
                if (!getBirdOldPhoneMode()) {
                    contentView.setViewVisibility(R.id.profile_badge, View.VISIBLE);
                }
                //[BIRD][BIRD_OLD_PHONE] chengci added 20170803 end
            }
        }
        ...
        private RemoteViews applyStandardTemplate(int resId, boolean hasProgress,
            ...
            if (title != null) {
                ...
                //[BIRD][BIRD_OLD_PHONE][bug14294] chengci added 20170829 begin
                if (getBirdOldPhoneMode()) {
                    Log.d("chengci0829", "enter applyStandardTemplate title");
                    contentView.setTextViewTextSize(R.id.title, TypedValue.COMPLEX_UNIT_DIP, 24);
                }
                //[BIRD][BIRD_OLD_PHONE] chengci added 20170829 end
        ...
        public Notification build() {
            ...
            //[BIRD][BIRD_OLD_PHONE][bug14337] chengci added 20170828 begin
            if (getBirdOldPhoneMode()) {
                Log.d("chengci0829", "enter mN.flags111 ==" + mN.flags);
                Log.d("chengci0829", "enter mN.category == " + mN.category);
				//[BIRD][BIRD_OLD_PHONE][bug14337] chengci added 20170901 
                if (mN.category == CATEGORY_CALL) {
                    //[BIRD][BIRD_OLD_PHONE][bug14552] chengci added 20170902 
                    Log.d("chengci0829", "enter CATEGORY_CALL mN.category == ");
                } else {
                    mN.flags &= ~FLAG_NO_CLEAR;
                    mN.flags &= ~FLAG_ONGOING_EVENT;
                }
                Log.d("chengci0829", "enter mN.flags222 ==" + mN.flags);
            }
			//[BIRD][BIRD_OLD_PHONE] chengci added 20170828 end
            return mN;
        }
        ...
        private int getBaseLayoutResource() {
            ...
            if (getBirdOldPhoneMode()) {
                return R.layout.notification_template_material_base_birdoldphone;
            } else {
                return R.layout.notification_template_material_base;
            }
            //[BIRD][BIRD_OLD_PHONE] chengci 20170803 end
        ...
        private int getBigBaseLayoutResource() {
            ...
            if (getBirdOldPhoneMode()) {
                return R.layout.notification_template_material_big_base_birdoldphone;
            } else {
                return R.layout.notification_template_material_big_base;
            }
            //[BIRD][BIRD_OLD_PHONE] chengci 20170803 end
        ...
        private int getBigPictureLayoutResource() {
            ...
            if (getBirdOldPhoneMode()) {
                return R.layout.notification_template_material_big_picture_birdoldphone;
            } else {
                return R.layout.notification_template_material_big_picture;
            }
            //[BIRD][BIRD_OLD_PHONE] chengci 20170803 end
        ...
        private int getBigTextLayoutResource() {
            ...
            if (getBirdOldPhoneMode()) {
                return R.layout.notification_template_material_big_text_birdoldphone;
            } else {
                return R.layout.notification_template_material_big_text;
            }
            //[BIRD][BIRD_OLD_PHONE] chengci 20170803 end     
        ...
        private int getInboxLayoutResource() {
            ...
            if (getBirdOldPhoneMode()) {
                return R.layout.notification_template_material_inbox_birdoldphone;
            } else {
                return R.layout.notification_template_material_inbox;
            }
            //[BIRD][BIRD_OLD_PHONE] chengci 20170803 end      
        ...
        private int getMessagingLayoutResource() {
            ...
            if (getBirdOldPhoneMode()) {
                return R.layout.notification_template_material_messaging_birdoldphone;
            } else {
                return R.layout.notification_template_material_messaging;
            }
            //[BIRD][BIRD_OLD_PHONE] chengci 20170803 end
    ...
    public static class MessagingStyle extends Style {
        ...
        public RemoteViews makeBigContentView() {
            ...
            RemoteViews contentView = mBuilder.applyStandardTemplateWithActions(
                    ...
                    title,
                    null /* text */);
            //[BIRD][BIRD_OLD_PHONE][bug14294]chengci 20170829 begin
            int[] rowIds;
            if (getBirdOldPhoneMode()) {
                rowIds = new int[]{R.id.inbox_text0};
            } else {
                rowIds = new int[]{R.id.inbox_text0, R.id.inbox_text1, R.id.inbox_text2, R.id.inbox_text3,
                    R.id.inbox_text4, R.id.inbox_text5, R.id.inbox_text6};
            }
            //[BIRD][BIRD_OLD_PHONE][bug14294]chengci 20170829 end
    ...
    //[BIRD][BIRD_OLD_PHONE] chengci added 20170803 begin
    private static boolean getBirdOldPhoneMode() {
        return SystemProperties.get("ro.bird_old_phone").equals("1") && 
            (Settings.System.getInt(ActivityThread.currentApplication().getApplicationContext().getContentResolver(), 
            "is_oldphoneluancher_mode", 0) ==1);
    }
    //[BIRD][BIRD_OLD_PHONE] chengci 20170803 end
}
