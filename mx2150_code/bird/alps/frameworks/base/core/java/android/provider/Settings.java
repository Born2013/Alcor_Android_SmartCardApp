...
public final class Settings {
    ...
    public static final class System extends NameValueTable {
        ...
        /*[BIRD] [BIRD_TRAFFIC_MANAGE] caoyuangui begin 20170919*/
        /**
        * @hide
        */
        public static final String BIRD_DEFAULT_THE_INSTANT_SPEED = "speed_mode_enabled";
        /*[BIRD] [BIRD_TRAFFIC_MANAGE] caoyuangui  end 20170919*/
       ...
       /**
        ...
        /*[BIRD][BIRD_SMART_WAKE_UP_SCREEN][dengyang][20160321] begin*/

        /**
        * @hide
        */
        public static final String BIRD_SMART_WAKE_CTP_O = "bird_smart_wake_ctp_o";

        /**
        * @hide
        */
        public static final String BIRD_SMART_WAKE_CTP_C = "bird_smart_wake_ctp_c";

        /**
        * @hide
        */
        public static final String BIRD_SMART_WAKE_CTP_M = "bird_smart_wake_ctp_m";

        /**
        * @hide
        */
        public static final String BIRD_SMART_WAKE_CTP_Z = "bird_smart_wake_ctp_z";

        /**
        * @hide
        */
        public static final String BIRD_SMART_WAKE_CTP_E = "bird_smart_wake_ctp_e";

        /**
        * @hide
        */
        public static final String BIRD_SMART_WAKE_CTP_S = "bird_smart_wake_ctp_s";

        /**
        * @hide
        */
        public static final String BIRD_SMART_WAKE_CTP_W = "bird_smart_wake_ctp_w";

        /**
        * @hide
        */
        public static final String BIRD_SMART_WAKE_CTP_DOUBLE = "bird_smart_wake_ctp_double";

        /**
        * @hide
        */
        public static final String BIRD_SMART_WAKE_CTP_UP = "bird_smart_wake_ctp_up";

        /**
        * @hide
        */
        public static final String BIRD_SMART_WAKE_CTP_DOWN = "bird_smart_wake_ctp_down";

        /**
        * @hide
        */
        public static final String BIRD_SMART_WAKE_CTP_RIGHT = "bird_smart_wake_ctp_right";

        /**
        * @hide
        */
        public static final String BIRD_SMART_WAKE_CTP_LEFT = "bird_smart_wake_ctp_left";

        /**
        * @hide
        */
        public static final String BIRD_SMART_WAKE_CTP = "bird_smart_wake_ctp";

        /**
        * @hide
        */
        public static final String BIRD_SMART_WAKE_CTP_GLOVE = "bird_smart_wake_ctp_glove";

        //[BIRD][BIRD_SMART_WAKE_MISOPERATION_PREVENT][智能唤醒防误触功能][dengyang][20160321]BEGIN
        /**
         * @hide
         */
        public static final String BIRD_SMART_WAKE_CTP_MP = "bird_smart_wake_ctp_mp";
        //[BIRD][BIRD_SMART_WAKE_MISOPERATION_PREVENT][智能唤醒防误触功能][dengyang][20160321]END

        /**
         * @hide
         */
        public static final String BIRD_NO_APP_INFOR = "0";//[BUG #6552][手机无提示未安装此应用][dengyang][20160329]

        /*[BIRD][BIRD_SMART_WAKE_UP_SCREEN][冷屏解锁][dengyang][20160321] end*/
        /*[BIRD][BIRD_CALL_RECORDING_FORMAT_CUSTOM][通话录音格式更改][zhangaman][20170315]begin*/
        /**
         * @hide
         */
        public static final String BIRD_PHONE_NUMBER = "bird_phone_number";
        /*[BIRD][BIRD_CALL_RECORDING_FORMAT_CUSTOM][通话录音格式更改][zhangaman][20170315]end*/
        /*[BIRD][BIRD_SMALL_VIEW_WINDOW_STYLE][皮套风格1][zhangaman][20170524]begin*/
        /**
         * @hide
         */
        public static final String BIRD_SMALL_WINDOW_BG_STYLE1 = "bird_small_window_bg1";
         ...
         * @hide
         */
        public static final String BIRD_SETTINGS_NEEDBLUR_APP_PACKAGENAMES = "bird_blur_packages";
        /**
         * @hide
         */
        public static final String BIRD_SYSTEM_SETTINGS_RECENST_APP_BLUR = "bird_blur_status";
        /*[BIRD][BIRD_RECENTS_APP_BLUR][模糊显示最近任务列表的应用][zhangaman][20170620]end*/
		
        //[BIRD_GREEN_PROTECT] caoyuangui  20170707
        /**
         * @hide
         */
        public static final String BIRD_BUILD_VERSION = "ro.bird.device.model";
        /**
         * @hide
         */
        public static final String FOTA_RECOVERY_TAG = "fota_recovery";
        //[BIRD_GREEN_PROTECT] caoyuangui  20170707
         ...
         * @hide
         */
        public static final String BIRD_AUTO_CALL_RECORDING = "auto_call_recording";       
        /*[BIRD][BIRD_CALL_AUTO_RECORD_DEF][通话自动录音按钮默认关闭][luye][20160413] END*/

        /*[BIRD][TASK-5416][第一次开机桌面壁纸\锁屏壁纸没有默认标示][zhangaman][20170719]begin */
        /**
         * @hide
         */
        public static final String BIRD_SET_HOME_WALLPAPER = "bird_set_home_wallpaper";       
        /*[BIRD][TASK-5416][第一次开机桌面壁纸\锁屏壁纸没有默认标示][zhangaman][20170719]end */
        /*[BIRD][BIRD_WALKY_TALKY_SUPPORT][对讲机功能][zhangaman][20170825]begin*/
	/**
         * @hide
         */
        public static final String BIRD_SYSTEM_SETTINGS_WALKY_TALKY_SWITCH = "bird_walky_talky_status";
        /*[BIRD][BIRD_WALKY_TALKY_SUPPORT][对讲机功能][zhangaman][20170825]end*/

        /*[BIRD][BIRD_OLD_PHONE] chengci 20170823 begin */
        /**
         * @hide
         */
        public static final String BIRD_VOLUME_ENABLE = "bird_volume_enable";       
         ...
         * @hide
         */
        public static final String BIRD_ONESTEP_VOLUME_MUTE = "bird_onestep_volume_mute";       
         ...
         * @hide
         */
        public static final String BIRD_CTA_DATA_MMS_USE = "bird_cta_data_mms_use";
        /**
         * @hide
         */
        public static final String BIRD_CTA_DATA_EMAIL_USE = "bird_cta_data_email_use";
        /**
         * @hide
         */
        public static final String BIRD_CTA_DATA_TIME_USE = "bird_cta_data_time_use";       
        /**
         * @hide
         */
        public static final String BIRD_CTA_DATA_CALENDAR_USE = "bird_cta_data_calendar_use";
        //[BIRD][MTK_CTA_SUPPORT][CTA][chengci][20171101] END
        
        /*[BIRD][BIRD_KEYGUARD_NOTIFICATION] [船员项目锁屏通知控制功能] yeyunfeng 20171226 begin*/
        /**
         * @hide
         */
        public static final String BIRD_KEYGUARD_NOTIFICATION_ENABLE = "bird_keyguard_noti_enable";       
        /*[BIRD][BIRD_KEYGUARD_NOTIFICATION] [船员项目锁屏通知控制功能] yeyunfeng 20171226 end*/     
         ...
         * @hide
         */
        public static final String BIRD_DIRECT_TURN_ON = "bird_direct_with_proximity_turn_on";
        /**
         * @hide
         */
        public static final String BIRD_DIRECT_LAUNCHER_PAGE_TURNING = "bird_direct_launcher_page_turning";
        /**
         * @hide
         */
        public static final String BIRD_SMS_DIRECT_SEND_CALL = "bird_sms_direct_send_call";
        /**
         * {@hide}
         */
        public static final String BIRD_CONTACT_DIRECT_SEND_CALL = "bird_contact_direct_send_call";
        /**
         * @hide
         */
        public static final String BIRD_DIRECT_ANSWER_CALL = "bird_direct_answer_call";
        /**
         * @hide
         */
        public static final String BIRD_DIRECT_ANSWER_CALL_WITH_SPEAKER_ON = "bird_direct_answer_call_with_speaker_on";
        /**
         * @hide
         */
        public static final String BIRD_DIRECT_PHONE_SILENT = "bird_direct_phone_silent";
        /**
         * @hide
         */
        public static final String BIRD_DIRECT_PHOTO_SWITCH = "bird_direct_photo_switch";
        /**
         * @hide
         */
        public static final String BIRD_DIRECT_UNLOCK = "bird_direct_unlock";
        /**
         * @hide
         */
        public static final String BIRD_DIRECT_MUSIC_NEXT_SONG = "bird_direct_music_next_song";
        /**
         * @hide
         */
        public static final String BIRD_DIRECT_CAMERA = "bird_direct_camera";

        //[BIRD][BIRD_TURN_SILENCE][来电翻转静音][20150922]BEGIN
        /**
         * @hide
         */
        public static final String BIRD_TURN_SILENCE = "turn_silence_key";
        //[BIRD][BIRD_TURN_SILENCE][来电翻转静音][20150922]END


        //[BIRD][BIRD_SHAKER_ANSWERCALL][来电晃动接听][20150922]BEGIN
        /**
         * @hide
         */
        public static final String BIRD_SHAKER_ANSWERCALL= "shaker_answercall";
        //[BIRD][BIRD_SHAKER_ANSWERCALL][来电晃动接听][20150922]END


        //[BIRD][BIRD_CONTACT_DIRECT_DIAL][联系人详细界面智能拨号][20150924]BEGIN
        /**
         * @hide
         */
        public static final String BIRD_CONTACT_DIRECT_DIAL = "contact_direct_dial";
        //[BIRD][BIRD_CONTACT_DIRECT_DIAL][联系人详细界面智能拨号][20150924]END
         ...
         * @hide
         * 用于记录当前是否开启超级省电
         * int 1:had came in super saving already, 0:not come in(默认)
         */
        public static final String BIRD_SUPER_SAVING_STATUS = "bird_super_saving_status";

        /**
         * @hide
         * 用于记录当前是否是普通省电模式：
         * int 1: general saving, 0:off(默认)
         */
        public static final String BIRD_GENERAL_SAVING_STATUS = "bird_general_saving_status";

        /**
         * @hide
         * 用于记录超级省电是否自动进入
         * int 1:open 0:close(默认)
         */
        public static final String BIRD_SUPER_SAVING_AUTO_ENTER = "bird_super_saving_auto_enter";

        /**
         * @hide
         * 用于记录超级省电自动进入值
         * int 5% 10% 15%(默认) 20% 25%
         */
        public static final String BIRD_SUPER_SAVING_AUTO_ENTER_DEFAULT_VALUE = "bird_super_saving_auto_enter_default_value";
        //[BIRD][BIRD_POWER_MANAGER_V2][省电管理V2.0][qianliliang][20160527] END

        /*[BIRD][BIRD_FINGER_PRINT][指纹功能拓展][yangbo][20160826]BEGIN */
        /**
         * @hide
         */
        public static final String BIRD_SYSTEM_SETTINGS_FP_APPLOCK = "bird_system_settins_fp_applock";

        /**
         * @hide
         */
        public static final String BIRD_SYSTEM_SETTINGS_FP_SCREENLOCK = "bird_system_settings_fp_screenlock";

        /**
         * @hide
         */
        public static final String BIRD_SYSTEM_SETTINGS_FP_RECEIVER = "bird_system_settings_fp_receiver";

        /**
         * @hide
         */
        public static final String BIRD_SYSTEM_SETTINGS_FP_PHOTO = "bird_system_settings_fp_photo";

        /**
         * @hide
         */
        public static final String BIRD_SYSTEM_SETTINGS_FP_GALLERY = "bird_system_settings_fp_gallery";

        /**
         * @hide
         */
        public static final String BIRD_SYSTEM_SETTINGS_FP_QUICK = "bird_system_settings_fp_quick";

        /**
         * @hide
         */
        public static final String BIRD_SYSTEM_SETTINGS_FP_QUICK_INFO = "bird_system_settings_fp_quick_info";

        /**
         * @hide
         */
        public static final String BIRD_LAST_APP_LOCK_PACKAGE_NAME = "bird_last_app_lock_package_name";

        /**
         * @hide
         */
        public static final String BIRD_SETTINGS_NEEDLOCK_APP_PACKAGENAMES = "bird_settings_needlock_app_packagenames";

        /**
         * @hide
         */
        public static final String BIRD_ALREADY_UNLOCKED_PACKAGESNAME = "com_bird_already_unlocked_packagesname";
        /*[BIRD][BIRD_FINGER_PRINT][指纹功能拓展][yangbo][20160826]END */

        /*[BIRD][BIRD_UNREAD_SUPPORT_SHOTCUTS][在桌面图标上添加未读信息][zhangaman][20161130]begin*/
        /**
        * @hide
        */
        public static String BIRD_CALENDAR_MTK_UNREAD_KEY = "com_android_calendar_mtk_unread";

        /**
        * @hide
        */
        public static String BIRD_CONTACTS_UNREAD_KEY = "com_android_contacts_mtk_unread";

        /**
        * @hide
        */
        public static String BIRD_EMAIL_UNREAD_KEY = "com_android_email_mtk_unread";


        /*[BIRD][BIRD_UNREAD_SUPPORT_SHOTCUTS][在桌面图标上添加未读信息][zhangaman][20161130]end*/
        ...
        static {
            ...
            /*[BIRD][BIRD_UNREAD_SUPPORT_SHOTCUTS][在桌面图标上添加未读信息][zhangaman][20161130]BEGIN */
            PUBLIC_SETTINGS.add(BIRD_CALENDAR_MTK_UNREAD_KEY);
            PUBLIC_SETTINGS.add(BIRD_CONTACTS_UNREAD_KEY);
            PUBLIC_SETTINGS.add(BIRD_EMAIL_UNREAD_KEY);
            /*[BIRD][BIRD_UNREAD_SUPPORT_SHOTCUTS][在桌面图标上添加未读信息][zhangaman][20161130]END */


            //[BIRD_GREEN_PROTECT] caoyuangui   begin 20170707
            PUBLIC_SETTINGS.add(FOTA_RECOVERY_TAG);
            PUBLIC_SETTINGS.add(BIRD_BUILD_VERSION);
            //[BIRD_GREEN_PROTECT] caoyuangui  end 20170707

            /*[BIRD] [BIRD_TRAFFIC_MANAGE] caoyuangui  end 20170919*/
            PUBLIC_SETTINGS.add(BIRD_DEFAULT_THE_INSTANT_SPEED);
            /*[BIRD] [BIRD_TRAFFIC_MANAGE] caoyuangui  end 20170919*/


            /*[BIRD][BIRD_OLD_PHONE] chengci 20170823 begin */
            PUBLIC_SETTINGS.add(BIRD_VOLUME_ENABLE);
            /*[BIRD][BIRD_OLD_PHONE] chengci 20170823 begin */

            /*[BIRD][一键静音][Task6105] chengci 20171015 begin */
            PUBLIC_SETTINGS.add(BIRD_ONESTEP_VOLUME_MUTE);
            /*[BIRD][一键静音][Task6105] chengci 20171015 end */

            //[BIRD][MTK_CTA_SUPPORT][CTA][chengci][20171101] BEGIN
            PUBLIC_SETTINGS.add(BIRD_CTA_DATA_MMS_USE);
            PUBLIC_SETTINGS.add(BIRD_CTA_DATA_EMAIL_USE);
            PUBLIC_SETTINGS.add(BIRD_CTA_DATA_TIME_USE);
            PUBLIC_SETTINGS.add(BIRD_CTA_DATA_CALENDAR_USE);
            //[BIRD][MTK_CTA_SUPPORT][CTA][chengci][20171101] END
            
            /*[BIRD][BIRD_KEYGUARD_NOTIFICATION] [船员项目锁屏通知控制功能] yeyunfeng 20171226 begin*/
            PUBLIC_SETTINGS.add(BIRD_KEYGUARD_NOTIFICATION_ENABLE);
            /*[BIRD][BIRD_KEYGUARD_NOTIFICATION] [船员项目锁屏通知控制功能] yeyunfeng 20171226 end*/            
        }
       ...
       /**
		...
		//[BIRD][BIRD_OUT_CALL_ANSWER_NOTICE][去电接通震动][pangmeizhou][20160517]BEGIN
          ...
          * @hide
          */
        public static final String BIRD_OUT_CALL_ANSWER_NOTICE = "out_call_answer_notice";
        ...
        * @hide
        */
        public static final String BIRD_SHOW_BATTERY_PERCENT = "bird_show_battery_percent";
		//[BIRD][BIRD_SHOW_BATTERY_PERCENT][状态栏上显示电池电量百分比][dingjiayuan][20160519]end
		//[BIRD][BIRD_TOUCH_CAPTURE][BIRD_LONG_TOUCH_CAMERA_DEFAULT][待机长按触摸拍照键进入相机功能][qianliliang][20150818]BEGIN
		/**
		* @hide
		*/
		public static final String BIRD_LONG_PRESS_ENTER_CAMERA = "key_long_press_enter_camera";
		//[BIRD][BIRD_TOUCH_CAPTURE][BIRD_LONG_TOUCH_CAMERA_DEFAULT][待机长按触摸拍照键进入相机功能][qianliliang][20150818]END

        //[BIRD][BIRD_SMART_WAKE_UP_SCREEN][冷屏解锁优化][20160701]begin
        /**
        * @hide
        */
        public static final String BIRD_SMART_WAKE_GESTURE_V = "bird_gesture_v";

        /**
        * @hide
        */
        public static final String BIRD_SMART_WAKE_GESTURE_C = "bird_gesture_c";

        /**
        * @hide
        */
        public static final String BIRD_SMART_WAKE_GESTURE_E = "bird_gesture_e";

        /**
        * @hide
        */
        public static final String BIRD_SMART_WAKE_GESTURE_M = "bird_gesture_m";

        /**
        * @hide
        */
        public static final String BIRD_SMART_WAKE_GESTURE_O = "bird_gesture_o";

        /**
        * @hide
        */
        public static final String BIRD_SMART_WAKE_GESTURE_S = "bird_gesture_s";

        /**
        * @hide
        */
        public static final String BIRD_SMART_WAKE_GESTURE_Z = "bird_gesture_z";

        /**
        * @hide
        */
        public static final String BIRD_SMART_WAKE_GESTURE_DOUBLE = "bird_gesture_up";

        /**
        * @hide
        */
        public static final String BIRD_SMART_WAKE_GESTURE_UP = "bird_gesture_up";

        /**
        * @hide
        */
        public static final String BIRD_SMART_WAKE_GESTURE_DOWN = "bird_gesture_down";

        /**
        * @hide
        */
        public static final String BIRD_SMART_WAKE_GESTURE_LEFT = "bird_gesture_left";

        /**
        * @hide
        */
        public static final String BIRD_SMART_WAKE_GESTURE_RIGHT = "bird_gesture_right";
        ...
        * @hide
        */
        public static final String BIRD_DOUBLE_TAP_HOME_SLEEP = "bird_double_tap_home_sleep";
    ...
    public static final class Global extends NameValueTable {
       ...
       public static final String OVERLAY_DISPLAY_DEVICES = "overlay_display_devices";
        ...
        /*[BIRD][BIRD_FINGER_PRINT][指纹功能拓展][zhangaman][20170701]begin*/
        /**
         * @hide
         */
        public static final String BIRD_GOODX_OVER_TIME = "com_bird_goodx_over_time";
        /**
         * @hide
         */
        public static final String BIRD_GOODX_OVER_TIME_PASS = "com_bird_goodx_over_time_pass";
        /*[BIRD][BIRD_FINGER_PRINT][指纹功能拓展][zhangaman][20170701]end*/
        /**
