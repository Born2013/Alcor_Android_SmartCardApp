...
public class Build {
    ...
    /*[BIRD][BIRD_FAKE_HARDWARE][自定义Build.HARDWARE属性值][yangbo][20180331]BEGIN */
    /** The name of the hardware (from the kernel command line or /proc). */
    public static final String HARDWARE = TextUtils.isEmpty(getString("ro.bd_fake_hardware")) ? getString("ro.hardware") : getString("ro.bd_fake_hardware");
    /*[BIRD][BIRD_FAKE_HARDWARE][自定义Build.HARDWARE属性值][yangbo][20180331]END */
