...
/*[BIRD][BIRD_HOMEKEY_WAKE_SCREEN_SUPPROT][HOME键点亮屏幕][zhangaman][20170311]begin*/
import android.os.SystemProperties;
/*[BIRD][BIRD_HOMEKEY_WAKE_SCREEN_SUPPROT][HOME键点亮屏幕][zhangaman][20170311]end*/
...
public class KeyEvent extends InputEvent implements Parcelable {
    ...
    /**
      * @hide
      */
    public static final int KEYCODE_CTP_C          = 58;
    /**
      * @hide
      */
    public static final int KEYCODE_CTP_E          = 113;
    /**
      * @hide
      */
    public static final int KEYCODE_CTP_S          = 114;
    /**
      * @hide
      */
    public static final int KEYCODE_CTP_Z          = 57;
    /**
      * @hide
      */
    public static final int KEYCODE_CTP_W          = 92;
    /**
      * @hide
      */
    public static final int KEYCODE_CTP_M          = 21;
    /**
      * @hide
      */
    public static final int KEYCODE_CTP_O          = 22;
    /**
      * @hide
      */
    public static final int KEYCODE_CTP_UP          = 76;
    /**
      * @hide
      */
    public static final int KEYCODE_CTP_DOWN          = 20;
    /**
      * @hide
      */
    public static final int KEYCODE_CTP_LEFT          = 93;
    /**
      * @hide
      */
    public static final int KEYCODE_CTP_RIGHT          = 124;
    /**
      * @hide
      */
    public static final int KEYCODE_CTP_DOUBLE          = 19;
    ...
    public static final boolean isWakeKey(int keyCode) {
        ...
        /*[BIRD][BIRD_HOMEKEY_WAKE_SCREEN_SUPPROT][HOME键点亮屏幕][zhangaman][20170311]begin*/
        if (SystemProperties.get("ro.bd_homekey_wake_screen").equals("1") && keyCode == KeyEvent.KEYCODE_HOME) {
            return true;
        }
        /*[BIRD][BIRD_HOMEKEY_WAKE_SCREEN_SUPPROT][HOME键点亮屏幕][zhangaman][20170311]end*/

        /*[BIRD][一键静音][Task6105] chengci 20171015 begin */
        if (SystemProperties.get("ro.bd_enable_onestep_toggle").equals("1") && (keyCode == KeyEvent.KEYCODE_F6 || 
            keyCode == KeyEvent.KEYCODE_F7)) {
            Log.d("Bird_oneStep", "enter KeyEvent");
            return true;
        }
