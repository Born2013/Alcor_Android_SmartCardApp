...
public class NumberPicker extends LinearLayout {
    ...
    //[BIRD_OLD_PHONE]songwei 20170815 BEGIN
    private final Paint mUnSelPaint;
    //[BIRD_OLD_PHONE]songwei 20170815 END
    ...
    public NumberPicker(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        //[BIRD_OLD_PHONE]songwei 20170815 BEGIN
        mUnSelPaint = new Paint();
        mUnSelPaint.setAntiAlias(true);
        mUnSelPaint.setTextAlign(Align.CENTER);
        mUnSelPaint.setTextSize(mTextSize);
        mUnSelPaint.setTypeface(mInputText.getTypeface());
        mUnSelPaint.setColor(Color.parseColor("#8F8F8F"));
        //[BIRD_OLD_PHONE]songwei 20170815 END
        ...
        for (int i = 0; i < selectorIndices.length; i++) {
            ...
            if ((showSelectorWheel && i != SELECTOR_MIDDLE_ITEM_INDEX) ||
                ...
                if(i == 1) {
                    ...
                    canvas.drawText(scrollSelectorValue, x, y, mUnSelPaint);
                }
                //[BIRD_OLD_PHONE]songwei 20170815 BEGIN
            }
