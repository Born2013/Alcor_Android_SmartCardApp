...
public class ApplicationPackageManager extends PackageManager {
    ...
    public Resources getResourcesForApplication(@NonNull ApplicationInfo app)
        ...
        try {
            /*[BIRD][BIRD_MY_MM_GMS_FORCE_ENGLISH][系统语言为缅甸语时，GMS包中应用显示为英文][yangbo][20180211]BEGIN */
            Resources resources = mContext.mMainThread.getTopLevelResources(
                 sameUid ? app.sourceDir : app.publicSourceDir,
                 sameUid ? app.splitSourceDirs : app.splitPublicSourceDirs,
                 app.resourceDirs, app.sharedLibraryFiles, Display.DEFAULT_DISPLAY,
                 mContext.mPackageInfo);
            if (BIRD_MY_MM_GMS_FORCE_ENGLISH) {
                if (Locale.getDefault().getLanguage().equals("my") && isMyMmEnglishApps(app.packageName)) {
                    Configuration c = resources.getConfiguration();
                    c.setLocales(new android.os.LocaleList(new Locale("en", "US")));
                    resources.updateConfiguration(c, resources.getDisplayMetrics());
                }
            }
            return resources;
            /*[BIRD][BIRD_MY_MM_GMS_FORCE_ENGLISH][系统语言为缅甸语时，GMS包中应用显示为英文][yangbo][20180103]END */
    ...
    private void installCommon(Uri packageURI,
        ...
        try {
            /*[BIRD][BIRD_AIMEI_STUDENT][艾牛学生机只允许客户的应用市场安装apk]xujing 20170617 begin*/
            if (SystemProperties.get("ro.bd_aimei_student").equals("1")) {
                String fromPackageName = mContext.getPackageName();
                Log.d(TAG, "fromPackageName: " + fromPackageName);
                Log.d(TAG, "installerPackageName: " + installerPackageName);
                installerPackageName = fromPackageName;
            }
            /*[BIRD][BIRD_AIMEI_STUDENT][艾牛学生机只允许客户的应用市场安装apk]xujing 20170617 end*/
    ...
    /*[BIRD][BIRD_MY_MM_GMS_FORCE_ENGLISH][系统语言为缅甸语时，GMS包中应用显示为英文][yangbo][20180211]BEGIN */
    private static final List<String> BIRD_MYMM_ENGLISH_APPS = java.util.Arrays.asList("com.google.android.googlequicksearchbox", "com.google.android.gm", "com.google.android.apps.maps", "com.android.vending", "com.google.android.gms", "com.google.android.apps.photos", "com.google.android.youtube", "com.google.android.apps.tachyon");
    
    /** {@hide} */
    public static final boolean BIRD_MY_MM_GMS_FORCE_ENGLISH = "1".equals(SystemProperties.get("ro.bd_my_mm_gms_force_english"));
    
    /** {@hide} */
    public static boolean isMyMmEnglishApps(String packageName) {
        if (!android.text.TextUtils.isEmpty(packageName) && BIRD_MYMM_ENGLISH_APPS.contains(packageName)) {
            return true;
        }
        return false;
    }
