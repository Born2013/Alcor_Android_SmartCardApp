...
public class AlertDialog extends Dialog implements DialogInterface {
    ...
    /*[BIRD_OLD_PHONE]songwei 20170805 begin*/
    /**
     * @hide
     */
    public static final int THEME_OLDPHONE_LIGHT = 6;
    /*[BIRD_OLD_PHONE]songwei 20170805 end*/
    
    /*[BIRD_OLD_PHONE]chenguangxiang 20170823 begin*/
    /**
     * @hide
     */
    public static final int THEME_OLDPHONE_LIGHT_TOP = 7;
    /*[BIRD_OLD_PHONE]chenguangxiang 20170823 end*/
    /**
     * No layout hint.
     * @hide
     */
    ...
    static int resolveDialogTheme(Context context, int themeResId) {
        ...
        /*[BIRD_OLD_PHONE]songwei 20170805 begin*/
        } else if (themeResId == THEME_OLDPHONE_LIGHT) { 
            return com.android.internal.R.style.Theme_OldPhone_Light_Dialog;
        /*[BIRD_OLD_PHONE]songwei 20170805 end*/
        /*[BIRD_OLD_PHONE]chenguangxiang 20170823 begin*/
        } else if (themeResId == THEME_OLDPHONE_LIGHT_TOP) { 
            return com.android.internal.R.style.Theme_OldPhone_Light_Top_Dialog;
        /*[BIRD_OLD_PHONE]chenguangxiang 20170823 end*/
    ...
    public static class Builder {
        ...
        public Builder(Context context, int themeResId) {
            /*[BIRD_OLD_PHONE]songwei 20170805 begin*/
            if (context.getClass().getSimpleName().startsWith("OldPhoneDateTimeSettingsActivity")) {
                P = new AlertController.AlertParams(new ContextThemeWrapper(
                        context, resolveDialogTheme(context, 6)));
            } else {
                P = new AlertController.AlertParams(new ContextThemeWrapper(
