...
/*[BIRD][BIRD_FAKE_CPU_INFO_FOR_MYTEL][zhangaman][20180205]begin*/
import android.os.SystemProperties;
/*[BIRD][BIRD_FAKE_CPU_INFO_FOR_MYTEL][zhangaman][20180205]end*/
...
public class TextView extends View implements ViewTreeObserver.OnPreDrawListener {
    ...
    /*[BIRD][BIRD_FAKE_CPU_INFO_FOR_MYTEL][zhangaman][20180205]begin*/
    private final static boolean BIRD_FAKE_CPU_INFO_FOR_MYTEL = SystemProperties.get("ro.bd_fake_cpu_mytel").equals("1");
    /*[BIRD][BIRD_FAKE_CPU_INFO_FOR_MYTEL][zhangaman][20180205]end*/
    
    /*[BIRD][BIRD_FAKE_CPU_FREQ_FOR_AIS][泰国ais要求:安兔兔/CPUZ检测出的cpu最大频率修改为1.25Ghz][yangbo][20180331]BEGIN */
    private final static boolean BIRD_FAKE_CPU_FREQ_FOR_AIS = SystemProperties.get("ro.bd_fake_cpu_freq_ais").equals("1");
    /*[BIRD][BIRD_FAKE_CPU_FREQ_FOR_AIS][泰国ais要求:安兔兔/CPUZ检测出的cpu最大频率修改为1.25Ghz][yangbo][20180331]END */
    
    /*[BIRD][BIRD_FAKE_CAMERA_BATTERY_FOR_AIS][泰国ais要求:安兔兔Camera像素 电池容量更改][chenguangxiang][20180408] BEGIN */
    private final static boolean BIRD_FAKE_CAMERA_BATTERY_FOR_AIS = SystemProperties.get("ro.bd_fake_cam_bat_ais").equals("1");
    /*[BIRD][BIRD_FAKE_CAMERA_BATTERY_FOR_AIS][泰国ais要求:安兔兔Camera像素 电池容量更改][chenguangxiang][20180408] END */
    ...
    private void setText(CharSequence text, BufferType type,
        ...
        /*[BIRD][BIRD_FAKE_CAMERA_BATTERY_FOR_AIS][泰国ais要求:安兔兔Camera像素 电池容量更改][chenguangxiang][20180408] BEGIN */
        if (BIRD_FAKE_CAMERA_BATTERY_FOR_AIS) {
            String packageName = getContext().getPackageName();
            if (packageName != null && packageName.equals("com.antutu.ABenchMark")) {
                if (text.toString().contains("1000 mAh")) {
                    text = text.toString().replaceAll("1000 mAh","2200 mAh");
                }
                if (text.toString().contains("6.2")) {
                    text = text.toString().replaceAll("6.2","5");
                }
                if (text.toString().contains("9.4")) {
                    text = text.toString().replaceAll("9.4","8");
                }
            }
        }
        /*[BIRD][BIRD_FAKE_CAMERA_BATTERY_FOR_AIS][泰国ais要求:安兔兔Camera像素 电池容量更改][chenguangxiang][20180408] END */
        ...
        /*[BIRD][BIRD_FAKE_CPU_INFO_FOR_MYTEL][zhangaman][20180205]begin*/
        if (BIRD_FAKE_CPU_INFO_FOR_MYTEL) {
            String packageName = getContext().getPackageName();
            if (packageName != null && packageName.equals("com.antutu.ABenchMark")) {
                if(text.toString().contains("6735")) {
                    text = text.toString().replaceAll("6735","6737");
                } else if (text.toString().contains("1092.0 MHz")) {
                    text = text.toString().replaceAll("1092.0 MHz","1280.0 MHz");
                }
            }
        }
        /*[BIRD][BIRD_FAKE_CPU_INFO_FOR_MYTEL][zhangaman][20180205]end*/
        ...
        /*[BIRD][BIRD_FAKE_CPU_FREQ_FOR_AIS][泰国ais要求:安兔兔/CPUZ检测出的cpu最大频率修改为1.25Ghz][yangbo][20180331]BEGIN */
        if (BIRD_FAKE_CPU_FREQ_FOR_AIS) {
            String packageName = getContext().getPackageName();
            if (("com.antutu.ABenchMark").equals(packageName)) {
                String tmpString = text.toString();
                if (tmpString.contains("1092.0 MHz")) {
                    text = tmpString.replaceAll("1092.0 MHz","1250.0 MHz");
                } else if (tmpString.contains("1092 MHz")) {
                    text = tmpString.replaceAll("1092 MHz","1250 MHz");
                }
            } else if (("com.cpuid.cpu_z").equals(packageName)) {
                String tmpString = text.toString();
                if (tmpString.contains("1092 MHz")) {
                    text = tmpString.replaceAll("1092 MHz","1250 MHz");
                } else if (tmpString.contains("1.09 GHz")) {
                    text = tmpString.replaceAll("1.09 GHz","1.25 GHz");
                }
            }
        }
        /*[BIRD][BIRD_FAKE_CPU_FREQ_FOR_AIS][泰国ais要求:安兔兔/CPUZ检测出的cpu最大频率修改为1.25Ghz][yangbo][20180331]END */
        ...
        if (lcdValue != null && lcdValue.length() > 2) {
            String packageName = getContext().getPackageName();
            String isLcdSet = SystemProperties.get("persist.sys.tt.lcd_set");
            if (isLcdSet != null && packageName != null && (packageName.equals("com.antutu.ABenchMark") || packageName.equals("com.ludashi.benchmark")|| packageName.equals("com.qihoo360.mobilesafe.opti"))) {
                String lcd = Settings.System.getString(getContext().getContentResolver(),"BIRD_SYSTEM_APP_SET_LCD");
                android.util.Log.d("shujiang","text:"+text + ", lcd = " + lcd);
                String[] lcdNews = lcd.replace(" ", "").split("x");
                String s1 = lcdNews[0].replace(" ", "");
                String s2 = lcdNews[1].replace(" ", "");
                if (text.toString().contains(lcd)) {
                    String[] lcds = isLcdSet.split("x");
                    text = text.toString().replace(lcd, lcds[0] + " x " + lcds[1]);
                }
                if(text.toString().contains(s1 + "x" + s2)) {
                    String[] lcds = isLcdSet.split("x");
                    text = text.toString().replace(s1 + "x" + s2, lcds[0] + " x " + lcds[1]);
                }
                if(text.toString().contains(s1 + "*" + s2)) {
                    String[] lcds = isLcdSet.split("x");
                    text = text.toString().replace(s1 + "*" + s2, lcds[0] + " x " + lcds[1]);
                }
                if (text.toString().contains(s2 + "x" + s1)) {
                    String[] lcds = isLcdSet.split("x");
                    text = text.toString().replace(s2 + "x" + s1, lcds[0] + " x " + lcds[1]);
                }
                
                if (text.toString().contains("960*540")) {
                    String[] lcds = isLcdSet.split("x");
                    text = text.toString().replace("960*540", lcds[0] + " x " + lcds[1]);
                }
                if (text.toString().contains("1000 mAh")) {
                    text = "8800 mAh";
                }
