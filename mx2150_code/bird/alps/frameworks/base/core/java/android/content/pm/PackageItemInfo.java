...
/*[BIRD][BIRD_MOVISTAR_STORE][Movistar特殊需求：预置的第三方应用名称"Store"改为"Movistar Store"][yangbo][20170928]BEGIN */
import android.os.SystemProperties;
/*[BIRD][BIRD_MOVISTAR_STORE][Movistar特殊需求：预置的第三方应用名称"Store"改为"Movistar Store"][yangbo][20170928]END */
...
public class PackageItemInfo {
    ...
    public CharSequence loadLabel(PackageManager pm) {
        ...
        if (labelRes != 0) {
            ...
            if (label != null) {
                /*[BIRD][BIRD_MOVISTAR_STORE][Movistar特殊需求：预置的第三方应用名称"Store"改为"Movistar Store"][yangbo][20170928]BEGIN */
                if ("1".equals(SystemProperties.get("ro.bd_movistar_store"))) {
                    if ("com.terra.appcreator.tiendamovistar".equals(packageName) && "Store".equals(label.toString().trim())) {
                        return "Movistar Store";
                    }
                }
                /*[BIRD][BIRD_MOVISTAR_STORE][Movistar特殊需求：预置的第三方应用名称"Store"改为"Movistar Store"][yangbo][20170928]END */
