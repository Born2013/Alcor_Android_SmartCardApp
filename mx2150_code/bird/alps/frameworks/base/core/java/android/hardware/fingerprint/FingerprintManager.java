...
public class FingerprintManager {
   ...
   /**
    ...
    public boolean isAnswerCallEnable(int fingerId, int groupId) {
        ...
        if (mService != null) try {
            result = mService.isAnswerCallEnable(fingerId, groupId);
        } catch (RemoteException e) {
            Log.w(TAG, "isAnswerCallEnable: ", e);
        }
        return result;
    }
    ...
    public String getMakeCallNumber(int fingerId, int groupId) {
        String result = "";
        if (mService != null) try {
            result = mService.getMakeCallNumber(fingerId, groupId);
        } catch (RemoteException e) {
            Log.w(TAG, "getMakeCallNumber: ", e);
        }
        return result;
    }
    ...
    public String getQuickStartPackageName(int fingerId, int groupId) {
        String result = "";
        if (mService != null) try {
            result = mService.getQuickStartPackageName(fingerId, groupId);
        } catch (RemoteException e) {
            Log.w(TAG, "getQuickStartPackageName: ", e);
        }
        return result;
    }
    ...
    public boolean isTakePhotoEnable(int fingerId, int groupId) {
        boolean result = false;
        if (mService != null) try {
            result = mService.isTakePhotoEnable(fingerId, groupId);
        } catch (RemoteException e) {
            Log.w(TAG, "isTakePhotoEnable: ", e);
        }
        return result;
    }
    ...
    public boolean isCallRecordingEnable(int fingerId, int groupId) {
        boolean result = false;
        if (mService != null) try {
            result = mService.isCallRecordingEnable(fingerId, groupId);
        } catch (RemoteException e) {
            Log.w(TAG, "isCallRecordingEnable: ", e);
        }
        return result;
    }
    ...
    public boolean setAnswerCallEnable(int fingerId, int groupId, boolean enable) {
        boolean result = false;
        if (mService != null) try {
            result = mService.setAnswerCallEnable(fingerId, groupId, enable);
        } catch (RemoteException e) {
            Log.w(TAG, "setAnswerCallEnable: ", e);
        }
        return result;
    }
    ...
    public boolean setMakeCallNumber(int fingerId, int groupId, String number) {
        boolean result = false;
        if (mService != null) try {
            result = mService.setMakeCallNumber(fingerId, groupId, number);
        } catch (RemoteException e) {
            Log.w(TAG, "setMakeCallNumber: ", e);
        }
        return result;
    }
    ...
    public boolean setQuickStartPackageName(int fingerId, int groupId, String packageName) {
        boolean result = false;
        if (mService != null) try {
            result = mService.setQuickStartPackageName(fingerId, groupId, packageName);
        } catch (RemoteException e) {
            Log.w(TAG, "setQuickStartPackageName: ", e);
        }
        return result;
    }
    ...
    public boolean setTakePhotoEnable(int fingerId, int groupId, boolean enable) {
        boolean result = false;
        if (mService != null) try {
            result = mService.setTakePhotoEnable(fingerId, groupId, enable);
        } catch (RemoteException e) {
            Log.w(TAG, "setTakePhotoEnable: ", e);
        }
        return result;
    }
    ...
    public boolean setCallRecordingEnable(int fingerId, int groupId, boolean enable) {
        boolean result = false;
        if (mService != null) try {
            result = mService.setCallRecordingEnable(fingerId, groupId, enable);
        } catch (RemoteException e) {
            Log.w(TAG, "setCallRecordingEnable: ", e);
        }
        return result;
    }
