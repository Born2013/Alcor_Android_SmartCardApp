 ...
 */
public class BirdPhotoStackView extends AdapterViewAnimator {
    private final String TAG = "BirdPhotoStackView";
    private static final boolean DBG = false;
    private static final boolean DBG_MOTION = false;
    private static final boolean DBG_SHOW = true;
     ...
     */
    private static final float PERSPECTIVE_SHIFT_FACTOR_Y = 0.0f;
    ...
    private static final float PERSPECTIVE_SCALE_FACTOR = 0.2f;
     ...
     */
    private static final int NUM_ACTIVE_VIEWS = 4;
     ...
     * {@inheritDoc}
     */
    public BirdPhotoStackView(Context context) {
        this(context, null);
    }
     ...
     * {@inheritDoc}
     */
    public BirdPhotoStackView(Context context, AttributeSet attrs) {
     ...
     * {@inheritDoc}
     */
    public BirdPhotoStackView(Context context, AttributeSet attrs, int defStyleAttr) {
     ...
     * {@inheritDoc}
     */
    public BirdPhotoStackView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        a.recycle();
        initBirdPhotoStackView();
    }

    private void initBirdPhotoStackView() {
	...
	private void transformViewAtIndex(int index, final View view, boolean animate) {
        ...
        final float transY =scaleShiftCorrectionY + 10 * index + 10;
        ...
        /*if(view instanceof StackFrame) {
            int count = ((StackFrame) view).getChildCount();
            View child =(View)((StackFrame) view).getChildAt(0);
            int count2 = ((FrameLayout) child).getChildCount();
            View child2 = ((FrameLayout) child).getChildAt(0);
            int count3 = ((FrameLayout) child2).getChildCount();
            View child3 = ((FrameLayout) child2).getChildAt(0);
            if(child3 instanceof ImageView) {

                Drawable drawable=( (ImageView) child3).getDrawable();
                if (drawable==null) {
                ...
                if(drawable!=null){  
                    if(index == 0) {
                        //设置滤镜  
                        drawable.setColorFilter(Color.BLACK,PorterDuff.Mode.DARKEN);
                    }  else {
        ...
        if (animate) {
            PropertyValuesHolder mAlpha = PropertyValuesHolder.ofFloat("alpha", alpha);
            ...
            ObjectAnimator oa = ObjectAnimator.ofPropertyValuesHolder(view, mAlpha, scalePropX, scalePropY,
    ...
    public CharSequence getAccessibilityClassName() {
        return BirdPhotoStackView.class.getName();
    }
