...
public class DateFormat {
    ...
    /*[BIRD][BIRD_SETTINGS_ADD_DATE_FORMAT][add date format][20150729]begin*/
    /**
    ...
    private static String getDateFormatStringForSetting(Context context, String value) {
        ...
        if (value != null) {
            ...
            /// M: @}
                ...
                String template = context.getString(com.mediatek.internal.R.string.numeric_date_template);
                if (year < month && year < day) {
                    if (month < day) {
    ...
    /*[BIRD][BIRD_SETTINGS_ADD_DATE_FORMAT][add date format][20150729]end*/
