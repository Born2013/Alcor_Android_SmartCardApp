...
/* [BIRD][BIRD_LAUNCHER_LEFT_ADD_ADVERT][桌面左一页添加广告页][dingjiayuan][20171229] begin */
import android.os.SystemProperties;
/* [BIRD][BIRD_LAUNCHER_LEFT_ADD_ADVERT][桌面左一页添加广告页][dingjiayuan][20171229] end */
/**
            ...
            if (uid == android.os.Process.ROOT_UID || uid == android.os.Process.SYSTEM_UID) {
				...
				if(!SystemProperties.get("ro.bird_left_add_advert").equals("1")) {				
                	throw new UnsupportedOperationException(
                        "For security reasons, WebView is not allowed in privileged processes----dingjiayuan");
				}
				/* [BIRD][BIRD_LAUNCHER_LEFT_ADD_ADVERT][桌面左一页添加广告页][dingjiayuan][20171229] end */
            }
