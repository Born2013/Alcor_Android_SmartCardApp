...
public class SurfaceTextureRenderer {
    ...
    /*[BIRD][CTS测试失败][android.hardware.camera2.cts.RobustnessTest#testAbandonRepeatingRequestSurface][zhangaman][20171024]begin*/
    private void drawFrame(SurfaceTexture st, int width, int height, int flipType)
            throws LegacyExceptionUtils.BufferQueueAbandonedException {
    /*[BIRD][CTS测试失败][android.hardware.camera2.cts.RobustnessTest#testAbandonRepeatingRequestSurface][zhangaman][20171024]end*/
