...
public class Dialog implements DialogInterface, Window.Callback,
    ...
    public void show() {
		...
		if(mContext.getThemeResId() == com.android.internal.R.style.Theme_OldPhone_Light_Dialog) {
	        WindowManager.LayoutParams localLayoutParams = mWindow.getAttributes();
    	    localLayoutParams.gravity = Gravity.BOTTOM;
        	localLayoutParams.width = mWindowManager.getDefaultDisplay().getWidth();
	        mWindow.setAttributes(localLayoutParams);
		}
        /*[BIRD_OLD_PHONE]songwei 20170805 end*/
        
        /*[BIRD_OLD_PHONE]chenguangxiang 20170823 begin*/
		if(mContext.getThemeResId() == com.android.internal.R.style.Theme_OldPhone_Light_Top_Dialog) {
	        WindowManager.LayoutParams localLayoutParams = mWindow.getAttributes();
