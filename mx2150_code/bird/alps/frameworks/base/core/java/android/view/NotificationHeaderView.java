...
public class NotificationHeaderView extends ViewGroup {
    ...
    protected void onFinishInflate() {
        ...
        if (getBirdOldPhoneMode()) {
            mDateTimeView = (DateTimeView) findViewById(com.android.internal.R.id.time);
        }
        //[BIRD][BIRD_OLD_PHONE] chengci added 20170803 end
    }
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            //[BIRD][BIRD_OLD_PHONE] chengci added 20170803 begin
            if (getBirdOldPhoneMode()) {
                if (child == mDateTimeView) {
                    layoutLeft = getMeasuredWidth()-child.getMeasuredWidth();
                    layoutRight = getMeasuredWidth();
                    int marginTop = getResources().getDimensionPixelSize(
                        com.android.internal.R.dimen.oldphone_notification_time_marginTop);
                    top = top - marginTop; 
