...
public class LocaleHelper {
    ...
    public static final class LocaleInfoComparator implements Comparator<LocaleStore.LocaleInfo> {
        ...
        /*[BIRD][BIRD_LOCALE_LIST_SORT][语言列表排序，可将部分语言排列在前面][yangbo][20180209]BEGIN */
        private String mPriorityLanguages[] = null;
        /*[BIRD][BIRD_LOCALE_LIST_SORT][语言列表排序，可将部分语言排列在前面][yangbo][20180209]END */
        ...
        public int compare(LocaleStore.LocaleInfo lhs, LocaleStore.LocaleInfo rhs) {
            ...
            if (lhs.isSuggested() == rhs.isSuggested()) {
                /*[BIRD][BIRD_LOCALE_LIST_SORT][语言列表排序，可将部分语言排列在前面][yangbo][20180209]BEGIN */
                if (mPriorityLanguages != null && mPriorityLanguages.length > 0) {
                    for(int i = 0; i < mPriorityLanguages.length; i++) {
                        if(mPriorityLanguages[i].equals(lhs.getLocale().toLanguageTag())) {
                            return -1;
                        }
                        if (mPriorityLanguages[i].equals(rhs.getLocale().toLanguageTag())) {
                            return 1;
                        }
                    }
                }
        ...
        /*[BIRD][BIRD_LOCALE_LIST_SORT][语言列表排序，可将部分语言排列在前面][yangbo][20180209]BEGIN */
        public void setPriorityLanguages(final String[] Languages) {
            mPriorityLanguages = Languages;
        }
        /*[BIRD][BIRD_LOCALE_LIST_SORT][语言列表排序，可将部分语言排列在前面][yangbo][20180209]END */
    }
}
