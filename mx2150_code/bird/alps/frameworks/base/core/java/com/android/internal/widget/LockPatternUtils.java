...
public class LockPatternUtils {
    ...
    public boolean checkPatternFromAppLock(String password, int userId) throws RequestThrottledException {
		try {
			VerifyCredentialResponse response = getLockSettings().checkPattern(password, userId);
