...
class ZygoteConnection {
    ...
    public static void applyDebuggerSystemProperty(Arguments args) {
        /*[BIRD][BIRD_ZYGOTE_DEBUG_ENABLE][解决:移动手机营业厅APP摄像头切换时画面卡住的问题][yangbo][20190430]BEGIN */
        if ("1".equals(SystemProperties.get("ro.debuggable")) || "1".equals(SystemProperties.get("ro.bd_zygote_debug_enable"))) {
            args.debugFlags |= Zygote.DEBUG_ENABLE_DEBUGGER;
        }
        /*[BIRD][BIRD_ZYGOTE_DEBUG_ENABLE][解决:移动手机营业厅APP摄像头切换时画面卡住的问题][yangbo][20190430]END */
    }
