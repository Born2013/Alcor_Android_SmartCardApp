...
public class LocalePickerWithRegion extends ListFragment implements SearchView.OnQueryTextListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        String[] priorityLocales = getContext().getResources().getStringArray(R.array.zzzzz_priority_locales);
        if (priorityLocales != null && priorityLocales.length > 0) {
            comp.setPriorityLanguages(priorityLocales);
        }
