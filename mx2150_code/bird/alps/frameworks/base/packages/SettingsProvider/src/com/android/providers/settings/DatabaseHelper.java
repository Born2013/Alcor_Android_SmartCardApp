...
class DatabaseHelper extends SQLiteOpenHelper {
    ...
    //[BIRD][BIRD_DEFAULT_DATEFORMAT][日期格式可配][dingjiayuan][20160627] BEGIN
    private static final String BIRD_DEFAULT_DATEFORMAT = SystemProperties.get("default_date_format","");
    //[BIRD][BIRD_DEFAULT_DATEFORMAT][日期格式可配][dingjiayuan][20160627] END
        ...
        if (upgradeVersion == 102) {
            ...
            try {
                ...
                if (mUserHandle == UserHandle.USER_SYSTEM) {
                    ...
                    if (FeatureOption.BIRD_UNKNOWN_SOURCE_ENABLE_DEFAULT) {
    ...
    private void loadVibrateWhenRingingSetting(SQLiteDatabase db) {
        ...
        try {
            ...
            loadSetting(stmt, Settings.System.VIBRATE_WHEN_RINGING, 
                SystemProperties.get("ro.bird_old_phone").equals("1") ? 1 : FeatureOption.BIRD_VIBRATE_WHEN_RINGING_DEFAULT ? 1 : 0);
    ...
    private void loadSystemSettings(SQLiteDatabase db) {
        ...
        try {
            ...
            //[BIRD][BIRD_SYSTEM_FONT_SIZE][系统字体大小默认值][chenguangxiang][20170325]begin
		    int fontSize = SystemProperties.getInt("ro.bird_font_size",1);
		    if (fontSize == 1) {
			    loadSetting(stmt, Settings.System.FONT_SCALE, 1f);
		    } else if (fontSize == 2) {
		    ...
		    //[BIRD][BIRD_SYSTEM_FONT_SIZE][系统字体大小默认值][chenguangxiang][20170325]end
		    
            //[BIRD][BIRD_DEFAULE_DISPLAY_SLEEP][自定义默认屏幕休眠时间][yangheng][20170313] BEGIN
            if (FeatureOption.BIRD_DEFAULE_DISPLAY_SLEEP) {
                birdLoadIntegerSetting(stmt, Settings.System.SCREEN_OFF_TIMEOUT,
                        FeatureOption.BIRD_DEFAULE_DISPLAY_SLEEP_VALUE);
            } else {
                loadIntegerSetting(stmt, Settings.System.SCREEN_OFF_TIMEOUT,
                        R.integer.def_screen_off_timeout);
            }
            ...
            if (FeatureOption.BIRD_CUSTOM_SYSTEM_SCREEN_LIGHT) {
                birdLoadIntegerSetting(stmt, Settings.System.SCREEN_BRIGHTNESS,
                        FeatureOption.BIRD_CUSTOM_SYSTEM_SCREEN_LIGHT_VALUE);
            } else {
            ...
            //[BIRD][BIRD_OUT_CALL_ANSWER_NOTICE][去电接通震动][pangmeizhou][20160517]BEGIN
            if (SystemProperties.get("ro.bird_out_call_answer_notice").equals("1")) {
                loadSetting(stmt, Settings.System.BIRD_OUT_CALL_ANSWER_NOTICE, 
                                            SystemProperties.get("ro.bd_out_call_answer_enable").equals("1") ? 1: 0);
            }
            //[BIRD][BIRD_OUT_CALL_ANSWER_NOTICE][去电接通震动][pangmeizhou][20160517]END
            loadBooleanSetting(stmt, Settings.System.SCREEN_BRIGHTNESS_MODE,
                    R.bool.def_screen_brightness_automatic_mode);

            loadDefaultAnimationSettings(stmt);

            //[BIRD][BIRD_OLD_PHONE][songwei][20170825]BEGIN
            if(SystemProperties.get("ro.bird_old_phone").equals("1")) {
                loadSetting(stmt, Settings.System.ACCELEROMETER_ROTATION, "0");
            } else {
                loadBooleanSetting(stmt, Settings.System.ACCELEROMETER_ROTATION, 
				       R.bool.def_accelerometer_rotation);
            }
            //[BIRD][BIRD_OLD_PHONE][songwei][20170825]END
            ...
            if(FeatureOption.BIRD_SHOW_BATTERY_PERCENT) {
				loadSetting(stmt, Settings.System.BIRD_SHOW_BATTERY_PERCENT, (FeatureOption.BIRD_SHOW_BATTERY_PERCENT_ON ? "1": "0"));
			}
            ...
            if(FeatureOption.BIRD_TWENTY_FOUR_HOURS_DEFAULT) {
                loadStringSetting(stmt, Settings.System.TIME_12_24, R.string.time_12_24);
            } else {
                loadStringSetting(stmt, Settings.System.TIME_12_24, R.string.time_12_12);
            }
            //[BIRD][BIRD_TWENTY_FOUR_HOURS_DEFAULT][默认使用24小时格式][yangheng][20161117] END
            
            //[BIRD][BIRD_SETTINGS_ADD_DATE_FORMAT][add date format][zhangaman][20150729]begin
            if (SystemProperties.get("ro.bird_add_date_format").equals("1")) {
                loadSetting(stmt, Settings.System.DATE_FORMAT, BIRD_DEFAULT_DATEFORMAT);
            }
            //[BIRD][BIRD_SETTINGS_ADD_DATE_FORMAT][add date format][zhangaman][20150729]end

            /*[BIRD][BIRD_SMART_WAKE_UP_SCREEN][冷屏解锁][dengyang][20160526] begin*/
            if (FeatureOption.BIRD_SMART_WAKE_UP_SCREEN) {
                loadSetting(stmt, Settings.System.BIRD_SMART_WAKE_CTP, (FeatureOption.BIRD_SMART_WAKE_CTP ? "1": "0"));
                loadSetting(stmt, Settings.System.BIRD_SMART_WAKE_CTP_GLOVE, (FeatureOption.BIRD_SMART_WAKE_CTP_GLOVE ? "1": "0"));
                loadSetting(stmt, Settings.System.BIRD_SMART_WAKE_CTP_O, (FeatureOption.BIRD_SMART_WAKE_CTP_O ? "1": "0"));
                loadSetting(stmt, Settings.System.BIRD_SMART_WAKE_CTP_M, (FeatureOption.BIRD_SMART_WAKE_CTP_M ? "1": "0"));
                loadSetting(stmt, Settings.System.BIRD_SMART_WAKE_CTP_C, (FeatureOption.BIRD_SMART_WAKE_CTP_C ? "1": "0"));
                loadSetting(stmt, Settings.System.BIRD_SMART_WAKE_CTP_E, (FeatureOption.BIRD_SMART_WAKE_CTP_E ? "1": "0"));
                loadSetting(stmt, Settings.System.BIRD_SMART_WAKE_CTP_Z, (FeatureOption.BIRD_SMART_WAKE_CTP_Z ? "1": "0"));
                loadSetting(stmt, Settings.System.BIRD_SMART_WAKE_CTP_S, (FeatureOption.BIRD_SMART_WAKE_CTP_S ? "1": "0"));
                loadSetting(stmt, Settings.System.BIRD_SMART_WAKE_CTP_W, (FeatureOption.BIRD_SMART_WAKE_CTP_W ? "1": "0"));
                loadSetting(stmt, Settings.System.BIRD_SMART_WAKE_CTP_DOUBLE, (FeatureOption.BIRD_SMART_WAKE_CTP_DOUBLE ? "1": "0"));
                loadSetting(stmt, Settings.System.BIRD_SMART_WAKE_CTP_UP, (FeatureOption.BIRD_SMART_WAKE_CTP_UP ? "1": "0"));
                loadSetting(stmt, Settings.System.BIRD_SMART_WAKE_CTP_DOWN, (FeatureOption.BIRD_SMART_WAKE_CTP_DOWN ? "1": "0"));
                loadSetting(stmt, Settings.System.BIRD_SMART_WAKE_CTP_RIGHT, (FeatureOption.BIRD_SMART_WAKE_CTP_RIGHT ? "1": "0"));
                loadSetting(stmt, Settings.System.BIRD_SMART_WAKE_CTP_LEFT, (FeatureOption.BIRD_SMART_WAKE_CTP_LEFT ? "1": "0"));
                //[BIRD][BIRD_SMART_WAKE_UP_SCREEN][冷屏解锁优化][20160701]begin
                loadStringSetting(stmt, Settings.System.BIRD_SMART_WAKE_GESTURE_V, R.string.gesture_v_intent);
                loadStringSetting(stmt, Settings.System.BIRD_SMART_WAKE_GESTURE_C, R.string.gesture_c_intent);
                loadStringSetting(stmt, Settings.System.BIRD_SMART_WAKE_GESTURE_E, R.string.gesture_e_intent);
                loadStringSetting(stmt, Settings.System.BIRD_SMART_WAKE_GESTURE_M, R.string.gesture_m_intent);
                loadStringSetting(stmt, Settings.System.BIRD_SMART_WAKE_GESTURE_O, R.string.gesture_o_intent);
                loadStringSetting(stmt, Settings.System.BIRD_SMART_WAKE_GESTURE_S, R.string.gesture_s_intent);
                loadStringSetting(stmt, Settings.System.BIRD_SMART_WAKE_GESTURE_Z, R.string.gesture_z_intent);
                loadStringSetting(stmt, Settings.System.BIRD_SMART_WAKE_GESTURE_UP, R.string.gesture_up_intent);
				loadStringSetting(stmt, Settings.System.BIRD_SMART_WAKE_GESTURE_DOWN, R.string.gesture_down_intent);
				loadStringSetting(stmt, Settings.System.BIRD_SMART_WAKE_GESTURE_LEFT, R.string.gesture_left_intent);
				loadStringSetting(stmt, Settings.System.BIRD_SMART_WAKE_GESTURE_RIGHT, R.string.gesture_right_intent);
				//[BIRD][BIRD_SMART_WAKE_UP_SCREEN][冷屏解锁优化][20160701]end
				//[BIRD][BIRD_DOUBLE_TAP_HOME_SLEEP][双击home键灭屏功能][qianliliang][20151012] BEGIN
                loadSetting(stmt, Settings.System.BIRD_DOUBLE_TAP_HOME_SLEEP, (FeatureOption.BIRD_DOUBLE_TAP_HOME_SLEEP ? "1": "0"));
            ...
            if(FeatureOption.BIRD_SMART_WAKE_MISOPERATION_PREVENT) {
                loadSetting(stmt, Settings.System.BIRD_SMART_WAKE_CTP_MP, (FeatureOption.BIRD_SMART_WAKE_CTP_MP ? "1": "0"));
            }
            ...
            if (FeatureOption.BIRD_DIRECT_WITH_PROXIMITY) {
                loadSetting(stmt, Settings.System.BIRD_DIRECT_TURN_ON, (FeatureOption.BIRD_DIRECT_TURN_ON_DEFAULT_VALUE ? "1": "0"));
                loadSetting(stmt, Settings.System.BIRD_SMS_DIRECT_SEND_CALL, (FeatureOption.BIRD_SMS_DIRECT_SEND_CALL_DEFAULT_VALUE ? "1": "0"));
                loadSetting(stmt, Settings.System.BIRD_CONTACT_DIRECT_SEND_CALL, (FeatureOption.BIRD_CONTACT_DIRECT_SEND_CALL_DEFAULT_VALUE ? "1": "0"));
                loadSetting(stmt, Settings.System.BIRD_DIRECT_ANSWER_CALL, (FeatureOption.BIRD_DIRECT_ANSWER_CALL_DEFAULT_VALUE ? "1": "0"));
                loadSetting(stmt, Settings.System.BIRD_DIRECT_ANSWER_CALL_WITH_SPEAKER_ON, (FeatureOption.BIRD_DIRECT_ANSWER_CALL_WITH_SPEAKER_ON_DEFAULT_VALUE ? "1": "0"));
                loadSetting(stmt, Settings.System.BIRD_DIRECT_PHONE_SILENT, (FeatureOption.BIRD_DIRECT_PHONE_SILENT_DEFAULT_VALUE ? "1": "0"));
                loadSetting(stmt, Settings.System.BIRD_DIRECT_LAUNCHER_PAGE_TURNING, (FeatureOption.BIRD_DIRECT_LAUNCHER_PAGE_TURNING_DEFAULT_VALUE ? "1": "0"));
                loadSetting(stmt, Settings.System.BIRD_DIRECT_PHOTO_SWITCH, (FeatureOption.BIRD_DIRECT_PHOTO_SWITCH_DEFAULT_VALUE ? "1": "0"));
                loadSetting(stmt, Settings.System.BIRD_DIRECT_UNLOCK, (FeatureOption.BIRD_DIRECT_UNLOCK_DEFAULT_VALUE ? "1": "0"));
                loadSetting(stmt, Settings.System.BIRD_DIRECT_MUSIC_NEXT_SONG, (FeatureOption.BIRD_DIRECT_MUSIC_NEXT_SONG_DEFAULT_VALUE ? "1": "0"));
                loadSetting(stmt, Settings.System.BIRD_DIRECT_CAMERA, (FeatureOption.BIRD_DIRECT_CAMERA_DEFAULT_VALUE ? "1": "0"));
            }
            /*[BIRD][BIRD_DIRECT_WITH_PROXIMITY][智能体感][yangbo][20150605]END */
            //[BIRD][BIRD_LAUNCHER_THEME_DEFAULT][默认主题配置][pangmeizhou][20150901]begin
			String defaultTheme = SystemProperties.get("ro.bird_launcher_default_theme");
			Log.i("adfafdafdafa","defaultTheme = "+defaultTheme);
			if(defaultTheme != null && defaultTheme.length() > 0){
				loadSetting(stmt, "key_current_theme_pkgName", defaultTheme);
			}
			//[BIRD][BIRD_LAUNCHER_THEME_DEFAULT][默认主题配置][pangmeizhou][20150901]end
            //[BIRD][三指截屏][BIRD_THREE_POINTER_SCREENSHOT][qianliliang][20160607] BEGIN
            if (SystemProperties.get("ro.bd_screenshot_def_value").equals("1")) {
                SystemProperties.set("persist.sys.bird.screenshot", "1");
            }
            //[BIRD][三指截屏][BIRD_THREE_POINTER_SCREENSHOT][qianliliang][20160607] BEGIN
            /*[BIRD][BIRD_RECENTS_APP_BLUR][模糊显示最近任务列表的应用][zhangaman][20170620]begin*/
            if (FeatureOption.BIRD_RECENTS_APP_BLUR) {
                loadSetting(stmt, Settings.System.BIRD_SYSTEM_SETTINGS_RECENST_APP_BLUR, (FeatureOption.BIRD_RECENTS_APP_BLUR_DEFAULT_VALUE ? "1": "0"));
                loadStringSetting(stmt, Settings.System.BIRD_SETTINGS_NEEDBLUR_APP_PACKAGENAMES, R.string.recent_blur_apps);
            }
            ...
            loadSetting(stmt,Settings.System.BIRD_AUTO_CALL_RECORDING, (FeatureOption.BIRD_CALL_AUTO_RECORD_DEF ? 1:0));
            /*[BIRD][BIRD_CALL_AUTO_RECORD_DEF][通话自动录音按钮默认关闭][luye][20160413] END*/
            /*[BIRD][BIRD_OLD_PHONE] chengci 20170823 begin */
            loadSetting(stmt,Settings.System.BIRD_VOLUME_ENABLE, 0);
            /*[BIRD][BIRD_OLD_PHONE] chengci 20170823 end */

            /*[BIRD][一键静音][Task6105] chengci 20171015 begin */
            loadSetting(stmt,Settings.System.BIRD_ONESTEP_VOLUME_MUTE, 0);
            /*[BIRD][一键静音][Task6105] chengci 20171015 end */

            //[BIRD][MTK_CTA_SUPPORT][CTA][chengci][20171101] BEGIN
            loadSetting(stmt,Settings.System.BIRD_CTA_DATA_MMS_USE, 0);
            loadSetting(stmt,Settings.System.BIRD_CTA_DATA_EMAIL_USE, 0);
            loadSetting(stmt,Settings.System.BIRD_CTA_DATA_TIME_USE, 0);
            //[BIRD][MTK_CTA_SUPPORT][CTA][chengci][20171101] END
            
            /*[BIRD][BIRD_DEFAULT_SYSTEM_LOCALES_LIST][配置"设置-语言"中默认的语言列表][yangbo][20171226]BEGIN */
            String localesString = SystemProperties.get("ro.bd_default_locales_list");
            if (!TextUtils.isEmpty(localesString)) {
                loadSetting(stmt, Settings.System.SYSTEM_LOCALES, localesString);
            }
            /*[BIRD][BIRD_DEFAULT_SYSTEM_LOCALES_LIST][配置"设置-语言"中默认的语言列表][yangbo][20171226]END */
        } finally {
            if (stmt != null) stmt.close();
        }
    }
    ...
    private void loadUISoundEffectsSettings(SQLiteStatement stmt) {
        ...
        if (FeatureOption.BIRD_DIAL_PAD_TONES_OFF) {
            birdLoadBooleanSetting(stmt, Settings.System.DTMF_TONE_WHEN_DIALING, false);
        } else {
        ...
        if (FeatureOption.BIRD_TOUCH_SOUNDS_OFF) {
            birdLoadBooleanSetting(stmt, Settings.System.SOUND_EFFECTS_ENABLED, false);
        } else {
        ...
        if (FeatureOption.BIRD_VIBRATE_ON_TOUCH_OFF) {
            loadSetting(stmt, Settings.System.HAPTIC_FEEDBACK_ENABLED, "0");
        } else {
        ...
        if (FeatureOption.BIRD_SCREEN_LOCKING_SOUNDS_OFF) {
            birdLoadIntegerSetting(stmt, Settings.System.LOCKSCREEN_SOUNDS_ENABLED, 0);
        } else {
    ...
    private void loadSecureSettings(SQLiteDatabase db) {
        ...
        try {
            ...
            //[BIRD][BIRD_IUPUTMETHOD_DEFAULT_SELECTED][语言设置中，第三方输入法 默认勾选][yangheng][20161117] BEGIN
			loadSetting(stmt, Settings.Secure.ENABLED_INPUT_METHODS,
						            SystemProperties.get("ro.bird.ime.selected",""));
			//[BIRD][BIRD_IUPUTMETHOD_DEFAULT_SELECTED][语言设置中，第三方输入法 默认勾选][yangheng][20161117] END
            ...
            //[BIRD][BIRD_SPELL_CHECKER_DISABLE][输入法中拼写检查默认关闭][yangheng][20161117] BEGIN
			if (SystemProperties.get("ro.bd_spell_checker_disable").equals("1")) {
				loadSetting(stmt,Settings.Secure.SPELL_CHECKER_ENABLED ,"0");
			}
			//[BIRD][BIRD_SPELL_CHECKER_DISABLE][输入法中拼写检查默认关闭][yangheng][20161117] END
        } finally {
            if (stmt != null) stmt.close();
        }
    }
    ...
    private void loadGlobalSettings(SQLiteDatabase db) {
        ...
        try {
            ...
            //[BIRD][bug-14949]songwei 20170915 begin
            if("OP01".equals(SystemProperties.get("ro.operator.optr", ""))) {
                loadSetting(stmt, Settings.Global.AUTO_TIME, "1");
            } else {
            ...
            //[BIRD][bug-14949]songwei 20170915 end

            //[BIRD][bug-14949]songwei 20170915 begin
            if("OP01".equals(SystemProperties.get("ro.operator.optr", ""))) {
                loadSetting(stmt, Settings.Global.AUTO_TIME_ZONE, "1");
            } else {
			...
			if(FeatureOption.BIRD_WIFI_DEFAULT_ON) {
		        loadBooleanSetting(stmt, Settings.Global.WIFI_ON,
		                R.bool.bird_def_wifi_on);
			} else {
		        loadBooleanSetting(stmt, Settings.Global.WIFI_ON,
		                R.bool.def_wifi_on);
			}
            ...
            //[BIRD][BIRD_DATA_ROAMING_ENABLE_DEFAULT][默认勾选DATA ROAMING][pangmeizhou][20160603] BEGIN
			if(FeatureOption.BIRD_DATA_ROAMING_ENABLE_DEFAULT) {
			...
			//[BIRD][BIRD_DATA_ROAMING_ENABLE_DEFAULT][默认勾选DATA ROAMING][pangmeizhou][20160603] END
            ...
            /*[BIRD][ALPS03841233][连接任意WIFI后状态栏上会提示“此WLAN网络无法访问互联网”][yangbo][20180328]BEGIN */
            loadBooleanSetting(stmt, Settings.Global.CAPTIVE_PORTAL_DETECTION_ENABLED, R.bool.def_captive_portal_detection_enabled);
            /*[BIRD][ALPS03841233][连接任意WIFI后状态栏上会提示“此WLAN网络无法访问互联网”][yangbo][20180328]END */
            /*
             * IMPORTANT: Do not add any more upgrade steps here as the global,
             * secure, and system settings are no longer stored in a database
             * but are kept in memory and persisted to XML.
    ...
    //[BIRD][BIRD_DIAL_PAD_TONES_OFF][拨号键盘提示音默认关闭][yangheng][20170321] BEGIN
    private void birdLoadBooleanSetting(SQLiteStatement stmt, String key, boolean isTrue) {
        loadSetting(stmt, key,
                isTrue ? "1" : "0");
    }
    //[BIRD][BIRD_DIAL_PAD_TONES_OFF][拨号键盘提示音默认关闭][yangheng][20170321] END
    ...
    //[BIRD][BIRD_CUSTOM_SYSTEM_SCREEN_LIGHT][自定义屏幕亮度][yangheng][20161119] BEGIN
    private void birdLoadIntegerSetting(SQLiteStatement stmt, String key, int value) {
        loadSetting(stmt, key,
