...
public class AccessPoint implements Comparable<AccessPoint>, Cloneable {
    ...
    public AccessPoint(Context context, WifiConfiguration config) { //[BIRD][BIRD_SHOW_MOVISTAR_WIFI][默认增加MOVISTAR WIFI热点][dingjiayuan][20160627] modify
        mContext = context;
        /// M: add mtk feature
        mAccessPointExt = new AccessPointExt(context);
        loadConfig(config);
    ...
    public boolean update(ScanResult result) { //[BIRD][BIRD_SHOW_MOVISTAR_WIFI][默认增加MOVISTAR WIFI热点][dingjiayuan][20160627] modify
        if (matches(result)) {
