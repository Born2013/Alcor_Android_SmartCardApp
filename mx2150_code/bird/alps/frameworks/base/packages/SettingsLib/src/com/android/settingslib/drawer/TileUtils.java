...
//[BIRD][Settings，目录加载问题][chenguangxiang]begin
import android.os.SystemProperties;
//[BIRD][Settings，目录加载问题][chenguangxiang]end
public class TileUtils {
    ...
    public static void getTilesForIntent(Context context, UserHandle user, Intent intent,
        ...
        for (ResolveInfo resolved : results) {
            ...
            //[BIRD][Settings，目录加载问题][chenguangxiang]begin
            if (!SystemProperties.get("ro.mtk_hotknot_support").equals("1")) {
                if (activityInfo.name.equals("com.android.settings.Settings$HotKnotSettingsActivity")) {
                    continue;
                }
            }
            if (!SystemProperties.get("ro.bd_add_quick_touch").equals("1")) {
                if (activityInfo.name.equals("com.android.settings.Settings$QuicktouchSettingsActivity")) {
                    continue;
                }
            }
            //[BIRD][Settings，目录加载问题][chenguangxiang]end
