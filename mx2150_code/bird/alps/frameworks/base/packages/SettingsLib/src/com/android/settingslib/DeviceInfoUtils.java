    ...
    public static String getSecurityPatch() {
        ...
        if (!"".equals(patch)) {
            try {
                ...
                /*[BIRD][BIRD_MY_MM_GMS_FORCE_ENGLISH][系统语言为缅甸语时，"设置-关于手机-Android安全补丁程序级别"显示为英文][yangbo][20180228]BEGIN */
                if (com.mediatek.settingslib.FeatureOption.BIRD_MY_MM_GMS_FORCE_ENGLISH) {
                    Locale locale = Locale.getDefault();
                    if (locale.getLanguage().equals("my")) {
                        locale = new Locale("en", "US");
                        String format = DateFormat.getBestDateTimePattern(locale, "dMMMMyyyy");
                        template = new SimpleDateFormat(format, locale);
                        return template.format(patchDate);
                    }
                }
                /*[BIRD][BIRD_MY_MM_GMS_FORCE_ENGLISH][系统语言为缅甸语时，"设置-关于手机-Android安全补丁程序级别"显示为英文][yangbo][20180228]END */
