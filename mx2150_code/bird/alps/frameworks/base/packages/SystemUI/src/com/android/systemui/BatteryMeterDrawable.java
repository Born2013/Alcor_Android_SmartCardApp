...
public class BatteryMeterDrawable extends Drawable implements
    ...
    //[BUG #7996][普通省电开启，状态栏电池图标并没有变为黄色][yangheng][20161209] BEGIN
    private int mBatteryPaintColor;
    //[BUG #7996][普通省电开启，状态栏电池图标并没有变为黄色][yangheng][20161209] END
    ...
    public void draw(Canvas c) {
        ...
        mBatteryPaintColor = mPluggedIn ? mChargeColor : getColorForLevel(level);
        if (FeatureOption.BIRD_POWER_MANAGER_V2
            ...
            mBatteryPaint.setColor(mContext.getColor(R.color.bird_battery_color));
        } else {
            mBatteryPaint.setColor(mBatteryPaintColor);
        }
        //[BUG #7996][普通省电开启，状态栏电池图标并没有变为黄色][yangheng][20161209] END
