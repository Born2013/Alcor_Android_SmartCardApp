...
class TelephonyIcons {
    ...
    /*[BIRD][3G数据连接时信号栏显示"H+",原本显示3G][luye][20160620]BEGIN */
    static final int QS_DATA_H_PLUS = R.drawable.ic_qs_signal_h_plus;
    /*[BIRD][3G数据连接时信号栏显示"H+",原本显示3G][luye][20160620]END */
    ...
    //[BIRD][BUG #8461 不开启数据网络的SIM卡，信号图标上显示叉叉][chenguangxiang][20170209] BEGIN
    //static final int ICON_DATA_DISABLED = R.drawable.stat_sys_data_disabled;
    static final int ICON_DATA_DISABLED = 0;
    //[BIRD][BUG #8461 不开启数据网络的SIM卡，信号图标上显示叉叉][chenguangxiang][20170209] END
    ...
    //[BIRD][BUG #7923 移动数据网络关闭，状态栏信号上方不要显示×][chenguangxiang][20161201] BEGIN
    //static final int QS_ICON_DATA_DISABLED = R.drawable.ic_qs_data_disabled;
    static final int QS_ICON_DATA_DISABLED = 0;
    //[BIRD][BUG #7923 移动数据网络关闭，状态栏信号上方不要显示×][chenguangxiang][20161201] END
