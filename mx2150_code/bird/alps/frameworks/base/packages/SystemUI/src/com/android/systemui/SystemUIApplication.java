...
import com.aiwinn.facelocksdk.able.initFaceLockResultable;
...
public class SystemUIApplication extends Application {
    ...
    public void onCreate() {
        ...
        //[BIRD][BIRD_FACELOCK_SCREEN] caoyuangui add begin add 20170904
        if (FeatureOption.BIRD_FACELOCK_SCREEN) {
            Log.d(TAG,"init sdk begin");
            FaceLockManager.initLockScreen(this, new initFaceLockResultable() {
                @Override
                public void resultSucc() {
                    Log.d(TAG,"init sdk succ");
                }
                @Override
                public void resultFail(String s) {
                    Log.d(TAG," s = "+ s);
                }
            });
        }
