...
public class KeyguardService extends Service {
    ...
    private final IKeyguardService.Stub mBinder = new IKeyguardService.Stub() {
        ...
        /*[BIRD_SMALL_VIEW_WINDOW] mandy 20150402 begin */
        public void showSmallViewWindow() {
			Log.i(TAG,"showSmallViewWindow...");
            mKeyguardViewMediator.showSmallViewWindow();
        }
        public void hideSmallViewWindow() {
			Log.i(TAG,"hideSmallViewWindow...");
            mKeyguardViewMediator.hideSmallViewWindow();
        }
        /*[BIRD_SMALL_VIEW_WINDOW] mandy 20150402 end */
    };
}
