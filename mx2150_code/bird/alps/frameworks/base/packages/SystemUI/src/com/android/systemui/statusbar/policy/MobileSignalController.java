...
public class MobileSignalController extends SignalController<
    ...
    public MobileSignalController(Context context, Config config, boolean hasMobileData,
        ...
        //[BIRD][BIRD_SIM_ICON_COLORFUL][状态栏SIM卡图标着色][qianliliang][20160519] BEGIN
        mSimCardTintColor = info.getIconTint();
        //[BIRD][BIRD_SIM_ICON_COLORFUL][状态栏SIM卡图标着色][qianliliang][20160519] END
    ...
    public void updateConnectivity(BitSet connectedTransports, BitSet validatedTransports) {
        ...
        if (FeatureOption.BIRD_REMOVE_SIGNAL_EXCLAMATION_MARK) {
            mCurrentState.inetCondition = 1;    //FAQ19312
        }
    ...
    private void mapIconSets() {
        ...
        //[BIRD]["HSPA+"网络时信号栏显示"H+"，之前为"H"][yangbo][20170412] 不加宏控
        if (mConfig.hspaDataDistinguishable || true) {
        ...
        if (FeatureOption.BIRD_SHOW_LTE_FOR_4G) {
            mNetworkToIconLookup.put(TelephonyManager.NETWORK_TYPE_LTE, TelephonyIcons.LTE);
        }
    ...
    public void notifyListeners(SignalCallback callback) {
        ...
        if (FeatureOption.BIRD_SIM_ICON_COLORFUL) {
            ...
            SubscriptionInfo tempSubscriptionInfo = subscriptionManager.getActiveSubscriptionInfo(subid);
            if (tempSubscriptionInfo != null && callback != null) {
                mSimCardTintColor = tempSubscriptionInfo.getIconTint();
                callback.setTintColor(mSubscriptionInfo.getSubscriptionId(), mSimCardTintColor);
            }
        }
        //[BIRD][BIRD_SIM_ICON_COLORFUL][状态栏SIM卡图标着色][qianliliang][20160519] END
        if(callback != null) {
        ...
        if(FeatureOption.BIRD_SEATEL_4G_NOTIFICATION && mNetworkTypeChangedCallback != null) {
            Log.i(TAG,"MobileSignalController notifyListeners mNetworkTypeChangedCallback = "+mNetworkTypeChangedCallback);
            mNetworkTypeChangedCallback.onNetworkTypeChanged(mSubscriptionInfo.getSubscriptionId(), mDataNetType);
        }
    ...
    //[BIRD][BIRD_SEATEL_4G_NOTIFICATION][Seatel运营商卡处于4G状态时通知栏中显示图片，其他运营商不显示][yangheng][20170228] BEGIN
    NetworkControllerImpl.NetworkTypeChangedCallback mNetworkTypeChangedCallback;
    public void setNetworkTypeChangedListener(NetworkControllerImpl.NetworkTypeChangedCallback listener){
        if(mNetworkTypeChangedCallback == null) {
            mNetworkTypeChangedCallback = listener;
        }
    }
    //[BIRD][BIRD_SEATEL_4G_NOTIFICATION][Seatel运营商卡处于4G状态时通知栏中显示图片，其他运营商不显示][yangheng][20170228] END

    //[BIRD][BIRD_SIM_ICON_COLORFUL][状态栏SIM卡图标着色][qianliliang][20160519] BEGIN
    public void setTintColorForController() {
    ...
    void updateNetworkName(boolean showSpn, String spn, String dataSpn,
        ...
        if (showPlmn && plmn != null) {
            ...
            if(FeatureOption.BIRD_SPN_SHOW_FIRST_CAP_OTHER_LOWER && plmn.length() > 1) {
                plmn = plmn.substring(0,1).toUpperCase()
                        + plmn.toString().substring(1).toLowerCase();
            }
        ...
        if (showSpn && spn != null) {
            //[BIRD][BIRD_SPN_SHOW_FIRST_CAP_OTHER_LOWER][SPN显示首字母大写,其余字母小写][LiuQishuai][20170227] BEGIN
            if(FeatureOption.BIRD_SPN_SHOW_FIRST_CAP_OTHER_LOWER && spn.length() > 1) {
                spn = spn.substring(0,1).toUpperCase()
                        + spn.toString().substring(1).toLowerCase();
            }
            //[BIRD][BIRD_SPN_SHOW_FIRST_CAP_OTHER_LOWER][SPN显示首字母大写,其余字母小写][LiuQishuai][20170227] END
            if (str.length() != 0) {
        ...
        if (showSpn && dataSpn != null) {
            ...
            //[BIRD][BIRD_SPN_SHOW_FIRST_CAP_OTHER_LOWER][SPN显示首字母大写,其余字母小写][LiuQishuai][20170227] BEGIN
            if(FeatureOption.BIRD_SPN_SHOW_FIRST_CAP_OTHER_LOWER && dataSpn.length() > 1) {
                dataSpn = dataSpn.substring(0,1).toUpperCase()
                        + dataSpn.toString().substring(1).toLowerCase();
            }
            //[BIRD][BIRD_SPN_SHOW_FIRST_CAP_OTHER_LOWER][SPN显示首字母大写,其余字母小写][LiuQishuai][20170227] END
