...
public class BrightnessMirrorController {
    ...
    private boolean mAutomaticAvailable;//[BIRD][BIRD_ADD_AUTO_BRIGHTNESS_TOOGLE][状态栏中增加自动调节亮度按钮][dingjiayuan][20160519] add
    ...
    public BrightnessMirrorController(StatusBarWindowView statusBarWindow) {
        ...
        mAutomaticAvailable = mBrightnessMirror.getContext().getResources().getBoolean(com.android.internal.R.bool.config_automatic_brightness_available)
        ...
        if(mAutomaticAvailable){
        	View toogleView = mBrightnessMirror.findViewById(R.id.bird_toggle);
        	if(toogleView != null) {
