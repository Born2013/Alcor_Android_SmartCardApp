...
class SaveImageInBackgroundTask extends AsyncTask<Void, Void, Void> {
    //[西班牙语翻译修改][hongzhihao][20161026]begin
    private static final String SCREENSHOTS_DIR_NAME = SystemProperties.get("ro.bd_screenshot_filename", "Screenshots");
    private static final String SCREENSHOT_FILE_NAME_TEMPLATE = SystemProperties.get("ro.bd_screenshot_filename", "Screenshot") + "_%s.png";
    private static final String SCREENSHOT_SHARE_SUBJECT_TEMPLATE = SystemProperties.get("ro.bd_screenshot_filename", "Screenshot") + " (%s)";
    //[西班牙语翻译修改][hongzhihao][20161026]end
    ...
    SaveImageInBackgroundTask(Context context, SaveImageInBackgroundData data,
        ...
        SystemUI.overrideNotificationAppName(context, mNotificationBuilder);
            ...
            if (FeatureOption.BIRD_AIMEI_STUDENT) {
                    if (!FeatureOption.isForbid(context, "com.android.gallery3d")) {
...
class GlobalScreenshot {
    ...
    //[BIRD][BIRD_SUPER_SCREENSHOT_SUPPORT][超级截屏][qianliliang][20160903] BEGIN
    private static final float BACKGROUND_ALPHA = FeatureOption.BIRD_SUPER_SCREENSHOT_SUPPORT ? 0.0f : 0.5f;
    //[BIRD][BIRD_SUPER_SCREENSHOT_SUPPORT][超级截屏][qianliliang][20160903] END
    ...
    public GlobalScreenshot(Context context) {
        ...
        //[BIRD][BIRD_SUPER_SCREENSHOT_SUPPORT][超级截屏][qianliliang][20160903] BEGIN
        if (FeatureOption.BIRD_SUPER_SCREENSHOT_SUPPORT) {
            mWindowLayoutParams.dimAmount = 0.8f;
        }
        //[BIRD][BIRD_SUPER_SCREENSHOT_SUPPORT][超级截屏][qianliliang][20160903] END
    ...
    private void saveScreenshotInWorkerThread(Runnable finisher) {
        ...
        mSaveInBgTask = new SaveImageInBackgroundTask(mContext, data, mNotificationManager)
            ...
            android.util.Log.i("BIRD_THREE_POINTER_SCREENSHOT", "data.image == null");
        }
    ...
    private ValueAnimator createScreenshotDropInAnimation() {
        ...
        anim.addListener(new AnimatorListenerAdapter() {
            ...
            public void onAnimationStart(Animator animation) {
                //[BIRD][BIRD_SUPER_SCREENSHOT_SUPPORT][超级截屏][qianliliang][20160903] BEGIN
                if (FeatureOption.BIRD_SUPER_SCREENSHOT_SUPPORT) {
                    mWindowLayoutParams.flags = mWindowLayoutParams.flags | WindowManager.LayoutParams.FLAG_DIM_BEHIND;
