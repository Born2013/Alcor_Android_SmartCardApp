...
/*[BIRD][BIRD_SMALL_VIEW_WINDOW][深圳版皮套功能][zhangaman][20170627]begin*/     
import com.android.keyguard.KeyguardLeatherHostView;
import com.android.systemui.FeatureOption;
/*[BIRD][BIRD_SMALL_VIEW_WINDOW][深圳版皮套功能][zhangaman][20170627]end*/     
...
public class StatusBarWindowView extends FrameLayout {
    ...
    public boolean dispatchKeyEvent(KeyEvent event) {
        ...
        Log.d("xiaowo", "dis event.getRepeatCount() = " + event.getRepeatCount()) ;
        ...
        switch (event.getKeyCode()) {
            case KeyEvent.KEYCODE_BACK:
                if (down) {
                    mService.onBackPressed(isLongPress);
                }
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        ...
        /*[BIRD][BIRD_SMALL_VIEW_WINDOW][深圳版皮套功能][zhangaman][20170627]begin*/      
        if (FeatureOption.BIRD_SMALL_VIEW_WINDOW && isSmallWindowEnable()) {
    ...
    public boolean isSmallWindowEnable(){
		KeyguardLeatherHostView view = (KeyguardLeatherHostView)findViewById(R.id.leatherview);
