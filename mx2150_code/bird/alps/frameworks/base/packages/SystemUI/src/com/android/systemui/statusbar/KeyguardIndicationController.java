...
public class KeyguardIndicationController {
    ...
    private String computeIndication() {
        ...
        /*[BIRD][BIRD_FINGER_PRINT_HINT][录入指纹后，锁屏界面提示"按下主屏幕以解锁"][zhangaman][20170310]begin*/
        if (FeatureOption.BIRD_FINGER_PRINT_HINT && mFpm.isHardwareDetected() && mFpm.hasEnrolledFingerprints()) {
            return mContext.getResources().getString(R.string.bird_fingerprint_hint);
        }
        /*[BIRD][BIRD_FINGER_PRINT_HINT][录入指纹后，锁屏界面提示"按下主屏幕以解锁"][zhangaman][20170310]end*/
    ...
    private String computePowerIndication() {
        ...
        //[BIRD][BIRD_SHOW_CHARGE_LOCKSCREEN][锁屏界面显示充电百分比][chenguangxiang][20170613] begin
        if (FeatureOption.BIRD_SHOW_CHARGE_LOCKSCREEN) {
            return mContext.getResources().getString(R.string.keyguard_plugged_in) + levelString;
