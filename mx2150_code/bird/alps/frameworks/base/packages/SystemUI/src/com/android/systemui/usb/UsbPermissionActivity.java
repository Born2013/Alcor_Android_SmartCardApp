...
public class UsbPermissionActivity extends AlertActivity
    ...
    public void onCreate(Bundle icicle) {
       ...
       Intent intent = getIntent();
        ...
        //[BIRD][TASK #4298][喔图,拍立享APP允许默认权限][chenguangxiang][20170411] BEGIN
        if(mPackageName.equals("com.alltuu.android") || 
                mPackageName.equals("www.pailixiang.com.photoshare")) {//双引号内为你要给权限的包名----即当前的喔图包名
        ...
        //[BIRD][TASK #4298][喔图,拍立享APP允许默认权限][chenguangxiang][20170411] END
