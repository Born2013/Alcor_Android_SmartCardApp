    ...
    @Override
     public void onClick(final View v) {
        ...
        if (FeatureOption.BIRD_AIMEI_STUDENT) {
            ...
            boolean isStuSos = "com.android.incallui.InCallActivity".equals(mTask.getTopComponent().getClassName());
            /*[BIRD][BIRD_AIMEI_STUDENT][gaowei][20170707]END*/ 
            if (!FeatureOption.isForbid(mContext,mTask.getTopComponent().getPackageName()) || isStuSos) {
