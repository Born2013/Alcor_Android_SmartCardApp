...
//[BIRD][BIRD_MULTI_TASK][多任务功能增强][chenguangxiang][20161128] begin
import android.util.Log;
import android.os.SystemProperties;
//[BIRD][BIRD_MULTI_TASK][多任务功能增强][chenguangxiang][20161128] end
   ...
   public void updateLayoutAlgorithm(boolean boundScrollToNewMinMax) {
    ...
    void onFirstLayout() {
        ...
        if ((mStackScroller.getStackScroll() < SHOW_STACK_ACTION_BUTTON_SCROLL_THRESHOLD || 
                SystemProperties.get("ro.bird_multi_task").equals("1")) &&
    ...
    public void onStackScrollChanged(float prevScroll, float curScroll, AnimationProps animation) {
        ...
        if (mEnterAnimationComplete) {
            if (prevScroll > SHOW_STACK_ACTION_BUTTON_SCROLL_THRESHOLD &&
                ...
                //[BIRD][BIRD_MULTI_TASK][多任务功能增强][chenguangxiang][20161128] begin
                if (!SystemProperties.get("ro.bird_multi_task").equals("1")) {
                    EventBus.getDefault().send(new HideStackActionButtonEvent());
                }
                //[BIRD][BIRD_MULTI_TASK][多任务功能增强][chenguangxiang][20161128] end
            }
    ...
    public final void onBusEvent(final DismissAllTaskViewsEvent event) {
        ...
        event.addPostAnimationCallback(new Runnable() {
            ...
            public void run() {
                ...
                for (int i = tasks.size() - 1; i >= 0; i--) {
                    //[BIRD][BIRD_CLEAN_RECENT_APP_WOTU][喔图 每小时自动清理recent app][yangheng][20170508] BEGIN
                    if (tasks.get(i).topActivity != null && FeatureOption.BIRD_CLEAN_RECENT_APP_WOTU) {
                        if (tasks.get(i).topActivity.getPackageName().equals("com.alltuu.android") || tasks.get(i).topActivity.getPackageName().equals("www.pailixiang.com.photoshare")) {
                            continue;
                        }
                    }
                    //[BIRD][BIRD_CLEAN_RECENT_APP_WOTU][喔图 每小时自动清理recent app][yangheng][20170508] END
