...
import com.android.systemui.BirdBatteryMeterView;
...
import com.aiwinn.facelocksdk.FaceLockManager;
import com.aiwinn.facelocksdk.able.lockScreenFaceResultable;
//[BIRD][BIRD_FACELOCK_SCREEN] caoyuangui add end add 20170904

/*[BIRD] [BIRD_TRAFFIC_MANAGE] caoyuangui  begin 20170919*/
import com.bird.traffic.TrafficController;
...
public class PhoneStatusBar extends BaseStatusBar implements DemoMode,
    ...
    //[BIRD][BIRD_FACELOCK_SCREEN] caoyuangui add begin add 20170904
    private boolean isFaceLockSuccess = false;
    private boolean mIsFaceLockIng = false;
    //[BIRD][BIRD_FACELOCK_SCREEN] caoyuangui add begin add 20170904
    ...
    /*[BIRD][BIRD_FREEZE_PHONE_WHEN_SLOT_PERMANENTLY_LOCKED][当卡槽被完全锁死(锁网剩余次数为0)时，手机将无法使用][yangbo][20170506]BEGIN */
    private View mBirdFreezeTipView;
    private boolean mBirdIsFreezeTipViewShowing = false;
    /*[BIRD][BIRD_FREEZE_PHONE_WHEN_SLOT_PERMANENTLY_LOCKED][当卡槽被完全锁死(锁网剩余次数为0)时，手机将无法使用][yangbo][20170506]END */
    ...
    /*[BIRD][TASK-5939][关闭锁屏壁纸功能，设置桌面壁纸时，锁屏背景不会随着桌面变化][yangbo][20170913]BEGIN */
    private static final boolean ENABLE_LOCKSCREEN_WALLPAPER = true && com.android.systemui.FeatureOption.BIRD_LOCKSCREEN_WALLPAPER;
    /*[BIRD][TASK-5939][关闭锁屏壁纸功能，设置桌面壁纸时，锁屏背景不会随着桌面变化][yangbo][20170913]END */
    ...
    private BirdEncryptStatementView mBirdEncryptStatementView;
    private boolean mBirdEncryptStatementShowing = false;
    ...
    private ContentObserver mScreenOffTimeOutObserver = new ContentObserver(new Handler()) {
        @Override
        public void onChange(boolean selfChange) {
            Log.i(TAG, "BIRD_POWER_MANAGER_V2, SCREEN_OFF_TIME_OUT changed ???");
            if (com.android.systemui.FeatureOption.BIRD_POWER_MANAGER_V2
                    ...
                    Settings.System.SCREEN_BRIGHTNESS_MODE_MANUAL) != GENERAL_SCREEN_BRIGHTNESS_MODE_VALUE
                    || Settings.System.getInt(mContext.getContentResolver(), Settings.System.SCREEN_BRIGHTNESS, 255)
                    != GENERAL_SCREEN_BRIGHTNESS_VALUE)) {
                Log.i(TAG, "BIRD_POWER_MANAGER_V2, SCREEN_OFF_TIME_OUT changed now");
    ...
    /*[BIRD] [BIRD_TRAFFIC_MANAGE] caoyuangui  begin 20170919*/
    private TextView mTraffic = null;
    ...
    public void start() {
        ...
        /*[BIRD][BIRD_FREEZE_PHONE_WHEN_SLOT_PERMANENTLY_LOCKED][当卡槽被完全锁死(锁网剩余次数为0)时，手机将无法使用][yangbo][20170506]BEGIN */
        if (com.android.keyguard.FeatureOptions.BIRD_FREEZE_PHONE_WHEN_SLOT_PERMANENTLY_LOCKED) {
            SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(mContext);
            if (prefs.getBoolean(com.android.keyguard.FeatureOptions.BIRD_PREF_PHONE_FREEZE, false)) { //卡槽被完全锁死了
                birdShowFreezeTipView();
            }
            prefs.registerOnSharedPreferenceChangeListener(mBirdPhoneFreezePrefListener);
        }
        /*[BIRD][BIRD_FREEZE_PHONE_WHEN_SLOT_PERMANENTLY_LOCKED][当卡槽被完全锁死(锁网剩余次数为0)时，手机将无法使用][yangbo][20170506]END */

        /*[BIRD][BIRD_ENCRYPT_SPACE][加密空间][yangbo][20170629]BEGIN */
        if (com.android.systemui.FeatureOption.BIRD_ENCRYPT_SPACE) {
            birdShowEncryptStatementView();
        }
        /*[BIRD][BIRD_ENCRYPT_SPACE][加密空间][yangbo][20170629]END */
        ...
        //[BIRD][BIRD_POWER_MANAGER_V2][省电管理V2.0][qianliliang][20160527] BEGIN
        if (com.android.systemui.FeatureOption.BIRD_POWER_MANAGER_V2) {
            mContext.getContentResolver().registerContentObserver(Settings.System.getUriFor(Settings.System.SCREEN_OFF_TIMEOUT),
                    true, mScreenOffTimeOutObserver);
        }
        //[BIRD][BIRD_POWER_MANAGER_V2][省电管理V2.0][qianliliang][20160527] END
    ...
    protected PhoneStatusBarView makeStatusBarView() {
        ...
        //[BIRD][BIRD_SHOW_BATTERY_PERCENT][状态栏上显示电池电量百分比][dingjiayuan][20160519]begin
        mBatteryLevel = (TextView) mStatusBarView.findViewById(R.id.bird_battery_level);
        final boolean show = Settings.System.getInt(mContext.getContentResolver(),
                    Settings.System.BIRD_SHOW_BATTERY_PERCENT, 1) != 0;
        mBatteryLevel.setVisibility(FeatureOption.BIRD_SHOW_BATTERY_PERCENT && show ? View.VISIBLE : View.GONE);
        //[BIRD][BIRD_SHOW_BATTERY_PERCENT][状态栏上显示电池电量百分比][dingjiayuan][20160519]end
        ...
        /*[BIRD] [BIRD_TRAFFIC_MANAGE] caoyuangui  begin 20170919*/
        mTraffic = (TextView)mStatusBarView.findViewById(R.id.traffic);
        if (com.android.systemui.FeatureOption.BIRD_TRAFFIC_MANAGE) {
            mTrafficController = new TrafficController(mContext);
            mTrafficController.addTrafficView(mTraffic);
        } else {
        ...
        ((BatteryMeterView) mStatusBarView.findViewById(R.id.battery)).setBatteryController(
                mBatteryController);
        /*[BIRD][BIRD_STATUS_BAR_BATTERY_ICON_CUSTOM][状态栏电量图标客制化][zhangaman][20170316]begin*/
        ((BirdBatteryMeterView) mStatusBarView.findViewById(R.id.bird_battery)).setBatteryController(mBatteryController);
        if (com.android.systemui.FeatureOption.BIRD_STATUS_BAR_BATTERY_ICON_CUSTOM) {
            ((BirdBatteryMeterView) mStatusBarView.findViewById(R.id.bird_battery)).setVisibility(View.VISIBLE);
        }
        /*[BIRD][BIRD_STATUS_BAR_BATTERY_ICON_CUSTOM][状态栏电量图标客制化][zhangaman][20170316]end*/
        ...
        //[BIRD][BIRD_SHOW_BATTERY_PERCENT][状态栏上显示电池电量百分比][dingjiayuan][20160519]begin
        filter.addAction("com.bird.action.SHOW_BATTERY_PERCENT");
        //[BIRD][BIRD_SHOW_BATTERY_PERCENT][状态栏上显示电池电量百分比][dingjiayuan][20160519]end

        //[BIRD][BIRD_AIMEI_STUDENT] caoyuangui 20170613 BEGIN
        if (com.android.systemui.FeatureOption.BIRD_AIMEI_STUDENT) {
            filter.addAction("android.intent.action.COMMONDCODE_CHANGED");
        }
        //[BIRD][BIRD_AIMEI_STUDENT] caoyuangui 20170613 END

        //[BIRD][BIRD_FACELOCK_SCREEN] caoyuangui add begin add 20170904
        if (com.android.systemui.FeatureOption.BIRD_FACELOCK_SCREEN) {
    ...
    protected void inflateStatusBarWindow(Context context) {
        ...
        /*[BIRD][BIRD_SMALL_VIEW_WINDOW] mandy.wu 20150605 begin */
        /*[BIRD][BIRD_CUSTOMED_KEYGUARD][客制化锁屏][zhangaman][20170222]begin */
        if (com.android.systemui.FeatureOption.BIRD_CUSTOMED_KEYGUARD) {
            mStatusBarWindow = (StatusBarWindowView) View.inflate(context,
                R.layout.bird_super_status_bar, null);
        } else if (com.android.systemui.FeatureOption.BIRD_KUSAI_KEYGUARD) {/*[BIRD][BIRD_KUSAI_KEYGUARD][基于原生锁屏的酷赛锁屏][zhangaman][20170623]*/
            mStatusBarWindow = (StatusBarWindowView) View.inflate(context,
                R.layout.bird_kusai_super_status_bar, null);
        } else {
            mStatusBarWindow = (StatusBarWindowView) View.inflate(context,
                R.layout.super_status_bar, null);
        }
        /*[BIRD][BIRD_CUSTOMED_KEYGUARD][客制化锁屏][zhangaman][20170222]end */
        /*[BIRD][BIRD_SMALL_VIEW_WINDOW] mandy.wu 20150605 end */
    }
   ...
   /// @}
    ...
    public void addNotification(StatusBarNotification notification, RankingMap ranking,
        ...
        if (com.android.systemui.FeatureOption.BIRD_AIMEI_STUDENT) {
            if (isForbid(notification.getPackageName())) {
                return;
            }
        }
    ...
    boolean panelsEnabled() {
        //[BIRD][BIRD_POWER_MANAGER_V2][省电管理V2.0][qianliliang][20160527] BEGIN
        if (com.android.systemui.FeatureOption.BIRD_POWER_MANAGER_V2
                &&Settings.System.getInt(mContext.getContentResolver(), Settings.System.BIRD_SUPER_SAVING_STATUS, 0) == 1) {
            return false;
        }
        //[BIRD][BIRD_POWER_MANAGER_V2][省电管理V2.0][qianliliang][20160527] END
    ...
    public void postRefreshAll() {
        mHandler.post(mRefreshAllAnimateCollapsePanels);
    }

    private final Runnable mRefreshAllAnimateCollapsePanels = new Runnable() {
        @Override
        public void run() {
            refreshAll();
        }
    ...
    public void refreshAll() {
        if (mStatusBarWindow != null && false) {
            // release focus immediately to kick off focus change transition
            mStatusBarWindowManager.setStatusBarFocusable(false);
    ...
    public void startActivityDismissingKeyguard(final Intent intent, boolean onlyProvisioned,
        ...
        Runnable runnable = new Runnable() {
            public void run() {
                ...
                /*[BIRD][BIRD_FINGER_PRINT][指纹功能拓展][yangbo][20160826]BEGIN */
                if (android.os.SystemProperties.get("ro.bd_fingerprint_ex").equals("1")) {
                    if (Settings.System.getInt(mContext.getContentResolver(), Settings.System.BIRD_SYSTEM_SETTINGS_FP_APPLOCK, 0) == 1) {
                        String packageName = "";
                        if (Intent.ACTION_DIAL.equals(intent.getAction())) {
                            packageName = "com.android.dialer";
                        } else if (MediaStore.INTENT_ACTION_STILL_IMAGE_CAMERA_SECURE.equals(intent.getAction()) || MediaStore.INTENT_ACTION_STILL_IMAGE_CAMERA.equals(intent.getAction())) {
                            packageName = "com.mediatek.camera";
                        }
                        if (!TextUtils.isEmpty(packageName)) {
                            KeyguardUpdateMonitor.getInstance(mContext).saveToUnlockedAppsList(packageName);
                        }
                    }
                }
                /*[BIRD][BIRD_FINGER_PRINT][指纹功能拓展][yangbo][20160826]END */
    ...
    private BroadcastReceiver mBroadcastReceiver = new BroadcastReceiver() {
        public void onReceive(Context context, Intent intent) {
            ...
            //[BIRD][BIRD_SHOW_BATTERY_PERCENT][状态栏上显示电池电量百分比][dingjiayuan][20160519]begin
            else if("com.bird.action.SHOW_BATTERY_PERCENT".equals(action)) {
                final boolean show = Settings.System.getInt(mContext.getContentResolver(),
                    Settings.System.BIRD_SHOW_BATTERY_PERCENT, 1) != 0;
                if(mBatteryLevel != null){
                    mBatteryLevel.setVisibility(FeatureOption.BIRD_SHOW_BATTERY_PERCENT && show ?
                            View.VISIBLE : View.GONE);
                }
                if(mKeyguardStatusBar != null) {
                    mKeyguardStatusBar.setBatteryPercentVisiblt(show);
                }

                if(mHeader != null) {
                    setBatteryPercentVisiblt(show);
                }
            }
            //[BIRD][BIRD_SHOW_BATTERY_PERCENT][状态栏上显示电池电量百分比][dingjiayuan][20160519]end
           //[BIRD][BIRD_AIMEI_STUDENT] caoyuangui 20170613 BEGIN
           else if ("android.intent.action.COMMONDCODE_CHANGED".equals(action)) {
                android.util.Log.d("CAOYUANGUI", "action = "+action);
        ...
        new AsyncTask<Void,Void,Void>(){
            ...
            protected Void doInBackground(Void... params) {
                ...
                for (ActivityManager.RunningAppProcessInfo appProcessInfo:appProcessInfos) {
                    android.util.Log.d("CAOYUANGUI", "appProcessInfo.processName = "+appProcessInfo.processName);
                    if(appProcessInfo.processName.equals("android")
                            || appProcessInfo.processName.contains("com.android.systemui")
                            || appProcessInfo.processName.contains("com.android.launcher3")
                            || appProcessInfo.processName.contains("system")
                            || appProcessInfo.processName.contains("com.android.phone")
                            || appProcessInfo.processName.contains("com.xycm.schoolbased")
                            || appProcessInfo.processName.contains("com.google.android.inputmethod.pinyin")
                            || appProcessInfo.processName.contains("com.bird.trafficmgr")
                            || appProcessInfo.processName.contains("android.process.media")
                            || (appProcessInfo.pid <=1000)
                    ...
                    for(int i=0;i<pkNameList.length;i++){
                        ...
                        android.util.Log.d("CAOYUANGUI", "pkName.pkName = "+pkName);
                        //[BIRD][BIRD_AIMEI_STUDENT][gaowei][20171225] BEGIN
                        if (!"com.android.dialer".equals(pkName)) {
                            android.util.Log.d("gaowei1025", "PhoneStatusBar forceStopPackage pkName = "+pkName);
                            activityManager.forceStopPackage(pkName);//杀死该进程
                        }
                        //[BIRD][BIRD_AIMEI_STUDENT][gaowei][20171225] END
    ...
    //[BIRD][BIRD_SHOW_BATTERY_PERCENT][状态栏上显示电池电量百分比][dingjiayuan][20160519]begin
    public void setBatteryPercentVisiblt(boolean visible) {
        mBatteryLevel.setVisibility(visible ? View.VISIBLE : View.GONE);
    }
    //[BIRD][BIRD_SHOW_BATTERY_PERCENT][状态栏上显示电池电量百分比][dingjiayuan][20160519]end
    ...
    public void destroy() {
        ...
        //[BIRD][BIRD_POWER_MANAGER_V2][省电管理V2.0][qianliliang][20160527] BEGIN
        if (com.android.systemui.FeatureOption.BIRD_POWER_MANAGER_V2) {
            mContext.getContentResolver().unregisterContentObserver(mScreenOffTimeOutObserver);
        }
        //[BIRD][BIRD_POWER_MANAGER_V2][省电管理V2.0][qianliliang][20160527] END
    ...
    public boolean onBackPressed(boolean isLongPress) {
        if (mStatusBarKeyguardViewManager.onBackPressed(isLongPress)) {
    ...
    public void onTrackingStopped(boolean expand) {
        if (mState == StatusBarState.KEYGUARD || mState == StatusBarState.SHADE_LOCKED) {
            if (!expand && !mUnlockMethodCache.canSkipBouncer()) {
                //[BIRD][BIRD_FACELOCK_SCREEN] caoyuangui add begin add 20170904
                if (com.android.systemui.FeatureOption.BIRD_FACELOCK_SCREEN) {
                    Log.d(TAG, "isSecure() = "+mStatusBarKeyguardViewManager.isSecure());
                    Log.d(TAG, "FaceLockManager.isRegistered()= "+FaceLockManager.isRegistered());
                    if (mStatusBarKeyguardViewManager.isSecure() && FaceLockManager.isRegistered()) {
                        isFaceLockSuccess = true;
                        mIsFaceLockIng = true;
                        FaceLockManager.openLockScreen(mContext, 9000, new lockScreenFaceResultable() {
                            @Override
                            public void resultSucc() {
                                    FaceLockManager.closeLockScreen(mContext);
                                    Log.d(TAG, " openLockScreen resultSucc  = ");
                                    isFaceLockSuccess = true;
                                    mIsFaceLockIng = false;
                                    hideKeyguard();
                                    mStatusBarKeyguardViewManager.dismiss(true);
                            }
                            @Override
                            public void resultFail(int i) {
                                Log.d(TAG, " openLockScreen fail i = "+i);
                                FaceLockManager.closeLockScreen(mContext);
                                isFaceLockSuccess = false;
                                mIsFaceLockIng = false;
                                showBouncer();
                            }
                        });
    ...
    private boolean isForbid(String pkgname) {
        Log.d(TAG+"gaowei0621", "pkgname = "+pkgname);
        if ("com.android.dialer".equals(pkgname)) {
            return false;
        }
        String selection = "pkgname=?";
        Cursor cursor = mContext.getContentResolver().query(mUri, COL_S, selection, new String[]{pkgname}, null);
        Log.d(TAG+"gaowei0621", "cursor = "+cursor);
        if (cursor != null) {
            int stateIndex = cursor.getColumnIndex(COL_STATE);
            while (cursor.moveToNext()) {
                int state = cursor.getInt(stateIndex);
                Log.d(TAG+"gaowei0621", "state = "+state);
                if (state == LOCK) {
                    return true;
                }
            }
    ...
    /*[BIRD][BIRD_FREEZE_PHONE_WHEN_SLOT_PERMANENTLY_LOCKED][当卡槽被完全锁死(锁网剩余次数为0)时，手机将无法使用][yangbo][20170506]BEGIN */
    private void birdShowFreezeTipView() {
        if (mBirdIsFreezeTipViewShowing == true) {
            return;
        }
        if (mBirdFreezeTipView == null) {
            mBirdFreezeTipView = View.inflate(mContext, R.layout.bird_freeze_view, null);
        }
        WindowManager.LayoutParams lp = new WindowManager.LayoutParams(
                LayoutParams.MATCH_PARENT, LayoutParams.MATCH_PARENT,
        ...
        lp.windowAnimations = 0;
        try {
            mWindowManager.addView(mBirdFreezeTipView, lp);
        } catch (Exception e) {
            Log.i(TAG, "birdAddFreezeTipView Exception");
        }
        mBirdIsFreezeTipViewShowing = true;
    }

    private final OnSharedPreferenceChangeListener mBirdPhoneFreezePrefListener = new OnSharedPreferenceChangeListener() {
        @Override
        public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String key) {
            if (com.android.keyguard.FeatureOptions.BIRD_PREF_PHONE_FREEZE.equals(key)) {
                birdShowFreezeTipView();
            }
        }
    };
    ...
    /*[BIRD][BIRD_ENCRYPT_SPACE][加密空间][yangbo][20170629]BEGIN */
    private void birdShowEncryptStatementView() {
        if (mBirdEncryptStatementShowing == true) {
            return;
        }
        if (mBirdEncryptStatementView == null) {
            mBirdEncryptStatementView = new BirdEncryptStatementView(mContext);
        }
        mBirdEncryptStatementView.setOkClickListener(new View.OnClickListener() {

            @Override
            public void onClick(View v) {
                // TODO Auto-generated method stub
                if (mBirdEncryptStatementView != null) {
                    mWindowManager.removeViewImmediate(mBirdEncryptStatementView);
                    mBirdEncryptStatementView = null;
                    mBirdEncryptStatementShowing = false;
                }
            }
        });
        ...
        WindowManager.LayoutParams lp = new WindowManager.LayoutParams(
                ...
                WindowManager.LayoutParams.FLAG_LAYOUT_IN_SCREEN,
                PixelFormat.TRANSLUCENT);
        lp.setTitle("Encryptstatement");
        lp.windowAnimations = 0;
        try {
            mWindowManager.addView(mBirdEncryptStatementView, lp);
        } catch (Exception e) {
            Log.i(TAG, "birdShowEncryptStatementView Exception");
        }
        mBirdEncryptStatementShowing = true;
    }

    //[BIRD][BIRD_FACELOCK_SCREEN] caoyuangui add begin add 20170904
    public  void resetFaceLockIng() {
           isFaceLockSuccess = false;
    }

    public boolean isFaceLocking() {
        return mIsFaceLockIng;
    }

    public boolean getFaceLockSuccess() {
        return isFaceLockSuccess;
    }
    //[BIRD][BIRD_FACELOCK_SCREEN] caoyuangui add end add 20170904
