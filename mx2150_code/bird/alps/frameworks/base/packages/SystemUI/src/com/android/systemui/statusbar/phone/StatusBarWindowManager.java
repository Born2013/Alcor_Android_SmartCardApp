...
import com.android.keyguard.KeyguardLeatherHostView;
...
public class StatusBarWindowManager implements RemoteInputController.Callback {
    ...
    private void apply(State state) {
        ...
        if (mLp.copyFrom(mLpChanged) != 0) {
            /*[BIRD][BIRD_SMALL_VIEW_WINDOW] mandy.wu 20150602 begin*/
            if (com.android.systemui.FeatureOption.BIRD_SMALL_VIEW_WINDOW && readHallStatus()) {
                boolean hasNaviBar = false;
                try {
                    hasNaviBar = mWindowManagerService.hasNavigationBar();
                    Log.d("Leather","hasNaviBar" + hasNaviBar);
                } catch (RemoteException e) {
                    Log.e("Leather", "RemoteException occured");
                }
                int naviBarHeght = 0;
                if (hasNaviBar) {
                    naviBarHeght = mContext.getResources().getDimensionPixelSize(com.android.internal.R.dimen.navigation_bar_height);
                }
                ...
                if (mTelecomManager != null) {
                    ...
                    if (callState == TelephonyManager.CALL_STATE_IDLE) {
                        mLp.height = mContext.getResources().getDisplayMetrics().heightPixels + naviBarHeght;
                    }
                }
            }
            /*[BIRD][BIRD_SMALL_VIEW_WINDOW] mandy.wu 20150602 end*/
    ...
    /*[BIRD][BIRD_SMALL_VIEW_WINDOW] mandy.wu 20150602 begin*/
    public void adjustStatusBarHeight(boolean showing){
        KeyguardLeatherHostView view = (KeyguardLeatherHostView)mStatusBarView.findViewById(R.id.leatherview);
        boolean hasNaviBar = false;
        try {
            hasNaviBar = mWindowManagerService.hasNavigationBar();
            Log.d("Leather","hasNaviBar" + hasNaviBar);
    ...
    public boolean isSmallWindowEnable(){
		KeyguardLeatherHostView view = (KeyguardLeatherHostView)mStatusBarView.findViewById(R.id.leatherview);
