    ...
    private int getDrawableResourceId(boolean expanded) {
        ...
        if (FeatureOption.BIRD_KUSAI_VOLUME_DIALOG) {
            if (mIsDefaultDirection) {
                return expanded ? R.drawable.bird_kusai_ic_volume_collapse_animation
                        : R.drawable.bird_kusai_ic_volume_expand_animation;
            } else {
                return expanded ? R.drawable.bird_kusai_ic_volume_expand_animation
                        : R.drawable.bird_kusai_ic_volume_collapse_animation;
            }
        } else {
            if (mIsDefaultDirection) {
