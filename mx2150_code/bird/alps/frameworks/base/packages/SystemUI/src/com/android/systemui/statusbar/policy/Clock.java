...
public class Clock extends TextView implements DemoMode, Tunable {
    ...
    public Clock(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray a = context.getTheme().obtainStyledAttributes(
                ...
                0, 0);
        try {
			//[BIRD][bug][设置-日期和时间，选择和取消使用24小时格式制时，通知栏不提示AM时间或者PM时间][pangmeizhou][20150720]begin
            mAmPmStyle = a.getInt(R.styleable.Clock_amPmStyle, AM_PM_STYLE_NORMAL);
			//[BIRD][bug][设置-日期和时间，选择和取消使用24小时格式制时，通知栏不提示AM时间或者PM时间][pangmeizhou][20150720]end
        } finally {
            a.recycle();
        }
    }
