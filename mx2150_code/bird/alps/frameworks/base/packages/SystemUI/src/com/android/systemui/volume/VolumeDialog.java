...
import android.os.SystemProperties;//[BIRD_SMT_SW][贴片测试][dengyang]
...
public class VolumeDialog implements TunerService.Tunable {
    ...
    public VolumeDialog(Context context, int windowType, VolumeDialogController controller,
        ...
        /*[BIRD][BIRD_KUSAI_VOLUME_DIALOG][基于原生的的酷赛音量调节][zhangaman][20170623]begin*/
        if (FeatureOption.BIRD_KUSAI_VOLUME_DIALOG) {
            mContext.setTheme(R.style.BirdKusaiSeekbarTheme);
            mActiveSliderTint = loadColorStateList(R.color.bird_kusai_system_accent_color);
            mInactiveSliderTint = loadColorStateList(R.color.bird_kusai_volume_slider_inactive);
        } else {
        ...
        /*[BIRD][一键静音][Task6105] chengci 20171024 begin */
        if (SystemProperties.get("ro.bd_enable_onestep_toggle").equals("1")) {
            mSettingsObserver = new ContentObserver(mHandler) {
                @Override
                public void onChange(boolean selfChange) {
                    Log.d("Bird_oneStep","enter ContentObserver onChange");
                    isContinusToggle = true;
                    mDialogView.setAlpha(0.5f);
                }
            };
            mContext.getContentResolver().registerContentObserver(
                Settings.System.getUriFor("bird_onestep_volume_mute"), false,
                mSettingsObserver);
        }
        /*[BIRD][一键静音][Task6105] chengci 20171024 begin */
    }
    ...
    private void initDialog() {
        ...
        /*[BIRD][BIRD_KUSAI_VOLUME_DIALOG][基于原生的的酷赛音量调节][zhangaman][20170623]begin*/
        if (FeatureOption.BIRD_KUSAI_VOLUME_DIALOG) {
            mDialogView.setBackgroundColor(0xffffffff);
        }
        /*[BIRD][BIRD_KUSAI_VOLUME_DIALOG][基于原生的的酷赛音量调节][zhangaman][20170623]end*/
        ...
        /*[BIRD][BIRD_KUSAI_VOLUME_DIALOG][基于原生的的酷赛音量调节][zhangaman][20170623]begin*/
        if (FeatureOption.BIRD_KUSAI_VOLUME_DIALOG) {
            mExpandButton.setImageResource(R.drawable.bird_kusai_ic_volume_collapse_animation);
        }
        /*[BIRD][BIRD_KUSAI_VOLUME_DIALOG][基于原生的的酷赛音量调节][zhangaman][20170623]end*/
        ...
        if (mRows.isEmpty()) {
            ...
            if (FeatureOption.BIRD_KUSAI_VOLUME_DIALOG) {
                addRow(AudioManager.STREAM_RING,
                        R.drawable.zzzz_bird_kusai_ic_volume_ringer, R.drawable.zzzz_bird_kusai_ic_volume_ringer_vibrate, true);
                addRow(AudioManager.STREAM_MUSIC,
                        R.drawable.zzzz_bird_kusai_ic_volume_media, R.drawable.zzzz_bird_kusai_ic_volume_media_mute, true);
                addRow(AudioManager.STREAM_ALARM,
                        R.drawable.zzzz_bird_kusai_ic_volume_alarm, R.drawable.zzzz_bird_kusai_ic_volume_alarm_mute, false);
            } else {
                addRow(AudioManager.STREAM_RING,
    ...
    private void initRow(final VolumeRow row, final int stream, int iconRes, int iconMuteRes,
        ...
        /*[BIRD][BIRD_KUSAI_VOLUME_DIALOG][基于原生的的酷赛音量调节][zhangaman][20170623]begin*/
        if (FeatureOption.BIRD_KUSAI_VOLUME_DIALOG) {
            row.view = mDialog.getLayoutInflater().inflate(R.layout.bird_kusai_volume_dialog_row, null);
        } else {
		...
		/*[BIRD][一键静音][Task6105] chengci 20171025 begin */
		if (SystemProperties.get("ro.bd_enable_onestep_toggle").equals("1")) {
	        row.slider.setOnTouchListener(new OnTouchListener() {
	            @Override
	            public boolean onTouch(View v, MotionEvent event) {
	                 if (isContinusToggle) {
					 	Log.d("Bird_oneStep", "slider OnTouchListener ");
	                    return true;
	                }
	                return false;
	            }
		...
		/*[BIRD][一键静音][Task6105] chengci 20171025 end */
        row.anim = null;
        ...
        row.icon.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                /*[BIRD][一键静音][Task6105] chengci 20171025 begin */
                if (SystemProperties.get("ro.bd_enable_onestep_toggle").equals("1") && isContinusToggle) {
                    return;
                }
                /*[BIRD][一键静音][Task6105] chengci 20171025 end */
    ...
    private void showH(int reason) {
        ...
        if (SystemProperties.get("ro.bd_enable_onestep_toggle").equals("1")) {
            if (isContinusToggle) {
                Log.d("Bird_oneStep","enter onViewAttachedToWindow volume mute");
                mExpandButton.setEnabled(false);
            } 
        }
        /*[BIRD][一键静音][Task6105] chengci 20171015 end */
    ...
    /*[BIRD][一键静音][Task6105] chengci 20171024 begin */
    //防止用户连续不断拨动开关导致UI问题
    private boolean isContinusToggle;
    private ContentObserver mSettingsObserver;
    /*[BIRD][一键静音][Task6105] chengci 20171024 end */
    ...
    protected void dismissH(int reason) {
        Log.d("Bird_oneStep", "dismiss");
        if (mMotion.isAnimating()) {
            Log.d("Bird_oneStep", "dismiss return");
            return;
        }
        mHandler.removeMessages(H.DISMISS);
        mHandler.removeMessages(H.SHOW);
        ...
        /*[BIRD][一键静音][Task6105] chengci 20171025 begin */
        if (SystemProperties.get("ro.bd_enable_onestep_toggle").equals("1") && isContinusToggle) {
            mExpandButton.setEnabled(true);
            mDialogView.setAlpha(1f);
            isContinusToggle = false;
        }
        /*[BIRD][一键静音][Task6105] chengci 20171025 end */
        mShowing = false;
    ...
    private void updateExpandButtonH() {
        ...
        int res;
        if (FeatureOption.BIRD_KUSAI_VOLUME_DIALOG) {
            res = mExpanded ? R.drawable.bird_kusai_ic_volume_collapse_animation
                : R.drawable.bird_kusai_ic_volume_expand_animation;
        } else {
        ...
        if (hasTouchFeature()) {
            ...
            /*[BIRD][BIRD_KUSAI_VOLUME_DIALOG][基于原生的的酷赛音量调节][zhangaman][20170623]begin*/
            if (FeatureOption.BIRD_KUSAI_VOLUME_DIALOG) {
                mExpandButton.setImageResource(R.drawable.zzzz_bird_kusai_ic_volume_ringer);
            } else {
    ...
    private void updateVolumeRowH(VolumeRow row) {
        ...
        /*[BIRD][BIRD_KUSAI_VOLUME_DIALOG][基于原生的的酷赛音量调节][zhangaman][20170623]*/
        final int iconRes =
                isRingVibrate ? FeatureOption.BIRD_KUSAI_VOLUME_DIALOG ? R.drawable.zzzz_bird_kusai_ic_volume_ringer_vibrate : R.drawable.ic_volume_ringer_vibrate
        ...
        /*[BIRD][BIRD_KUSAI_VOLUME_DIALOG][基于原生的的酷赛音量调节][zhangaman][20170623]*/
        row.iconState =
                iconRes == (FeatureOption.BIRD_KUSAI_VOLUME_DIALOG ? R.drawable.zzzz_bird_kusai_ic_volume_ringer_vibrate : R.drawable.ic_volume_ringer_vibrate) ? Events.ICON_STATE_VIBRATE
    ...
    private void showSafetyWarningH(int flags) {
        if ((flags & (AudioManager.FLAG_SHOW_UI | AudioManager.FLAG_SHOW_UI_WARNINGS)) != 0
            ...
            synchronized (mSafetyWarningLock) {
                ...
                //[BIRD_SMT_SW][贴片测试][dengyang][20160128]begin
                if(SystemProperties.get("ro.bird_smt_sw").equals("1") == true){
                    mSafetyWarning.disableSafeMediaVolume();
                } else {
                    mSafetyWarning.show();
                }
                //[BIRD_SMT_SW][贴片测试][dengyang][20160128]end
            }
            recheckH(null);
        }
        rescheduleTimeoutH();
