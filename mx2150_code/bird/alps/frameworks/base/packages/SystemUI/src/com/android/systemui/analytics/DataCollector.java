...
public class DataCollector implements SensorEventListener {
    ...
    private void updateConfiguration() {
        //[BIRD][锁屏界面亮屏后近距灯一直闪,不知道这么做什么原因，好像是数据采集分析之类的需要研究下][pangmeizhou][20161201]begin
        //mEnableCollector = Build.IS_DEBUGGABLE && 0 != Settings.Secure.getInt(
        //        mContext.getContentResolver(),
        //        COLLECTOR_ENABLE, 0);
        mEnableCollector = false;//
        //[BIRD][锁屏界面亮屏后近距灯一直闪,不知道这么做什么原因，好像是数据采集分析之类的需要研究下][pangmeizhou][20161201]end
