...
/*[BIRD][BIRD_SMALL_VIEW_WINDOW] mandy.wu 20150618 begin*/
import android.content.ComponentName;
import android.telecom.TelecomManager;
import com.android.systemui.FeatureOption;
import android.app.HallcoverManager;
/*[BIRD][BIRD_SMALL_VIEW_WINDOW] mandy.wu 20150618 end*/
/*[BIRD][BIRD_LOCKSCREEN_WALLPAPER][锁屏壁纸][zhangaman][20170223]begin*/
import android.app.WallpaperManager;
import java.io.InputStream;
import android.graphics.Bitmap;
/*[BIRD][BIRD_LOCKSCREEN_WALLPAPER][锁屏壁纸][zhangaman][20170223]end*/
...
public class KeyguardViewMediator extends SystemUI {
    ...
    /*[BIRD][BIRD_SMALL_VIEW_WINDOW] mandy 20150402 begin*/
    private static final int SHOW_SMALL_WINOW = 25;
    private static final int HIDE_SMALL_WINOW = 26;
    /*[BIRD][BIRD_SMALL_VIEW_WINDOW] mandy 20150402 end*/
    /**
    ...
    /*[BIRD][BIRD_SMALL_VIEW_WINDOW]灭屏，来电，小窗口不显示来电界面：mandy.wu 20150618 begin*/
    private TelecomManager mTelecomManager;
    private PhoneStatusBar mPhoneStatusBar;
    private PowerManager mPowerManager;
    /*[BIRD][BIRD_SMALL_VIEW_WINDOW]灭屏，来电，小窗口不显示来电界面：mandy.wu 20150618 end*/
    ...
    KeyguardUpdateMonitorCallback mUpdateCallback = new KeyguardUpdateMonitorCallback() {
        ...
        public void onPhoneStateChanged(int phoneState) {
            synchronized (KeyguardViewMediator.this) {
				...
				if(FeatureOption.BIRD_SMALL_VIEW_WINDOW) {
		            if(TelephonyManager.CALL_STATE_IDLE == phoneState){
	             		if(readHallStatus()){
							if (PowerOffAlarmManager.isAlarmBoot()) {
								return;
							}
                        mStatusBarKeyguardViewManager.showSmallWindow(true);
		            ...
		            } else if(TelephonyManager.CALL_STATE_IDLE != phoneState){
	                	if(readHallStatus()){
	                		if(mStatusBarKeyguardViewManager.isShowLeather()){
	                			mStatusBarKeyguardViewManager.showSmallWindow(false);
	                		}
	                	}
		            }
				}
    ...
    ViewMediatorCallback mViewMediatorCallback = new ViewMediatorCallback() {
        ...
        /*[BIRD][BIRD_SMALL_VIEW_WINDOW][zhangaman][20160906]begin*/
        @Override
        public boolean isLeatherShowing() {
            return KeyguardViewMediator.this.isLeatherShowing();
        }

        @Override
        public void hideSmallViewWindow() {
            KeyguardViewMediator.this.hideSmallViewWindowForAlarm() ;
        }
        /*[BIRD][BIRD_SMALL_VIEW_WINDOW][zhangaman][20160906]end*/
    ...
    private void doKeyguardLocked(Bundle options) {
        ...
        if (android.os.SystemProperties.get("ro.bd_fingerprint_ex").equals("1")) {
            Settings.System.putString(mContext.getContentResolver(), Settings.System.BIRD_LAST_APP_LOCK_PACKAGE_NAME, "com.fingerprint.applock");
            Settings.System.putString(mContext.getContentResolver(), Settings.System.BIRD_ALREADY_UNLOCKED_PACKAGESNAME, "");
        }
    ...
    private Handler mHandler = new Handler(Looper.myLooper(), null, true /*async*/) {
        ...
        private String getMessageString(Message message) {
            switch (message.what) {
                ...
                /*[BIRD][BIRD_SMALL_VIEW_WINDOW] mandy 20150402 begin */
                case SHOW_SMALL_WINOW:
                    return "SHOW_SMALL_WINOW";
                case HIDE_SMALL_WINOW:
                    return "HIDE_SMALL_WINOW";
                /*[BIRD][BIRD_SMALL_VIEW_WINDOW] mandy 20150402 end */ 
                default:
                    break;
            }
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case ON_ACTIVITY_DRAWN:
                  ...
                  /*[BIRD][BIRD_SMALL_VIEW_WINDOW] mandy 20150402 begin */
                case SHOW_SMALL_WINOW:
                    handleShowSmallWindow();
                    break;
                case HIDE_SMALL_WINOW:
                    handleHideSmallWindow();
                    break;
                /*[BIRD][BIRD_SMALL_VIEW_WINDOW] mandy 20150402 end */
            }
        }
    ...
    private void handleShow(Bundle options) {
        /*[BIRD][BIRD_LOCKSCREEN_WALLPAPER][锁屏壁纸][zhangaman][20170223]begin*/
        if (FeatureOption.BIRD_LOCKSCREEN_WALLPAPER) {
            try {
                WallpaperManager wpm = (WallpaperManager) mContext.getSystemService(Context.WALLPAPER_SERVICE);
                Bitmap bitmap = wpm.getLockScreenWallpaperBitmap();
                if (bitmap == null) {
                    wpm.setResource(com.android.internal.R.drawable.zzzzz_default_lockscreen,WallpaperManager.FLAG_LOCK);
                }
            } catch (Exception e) {
                e.printStackTrace();
            }
    ...
    private void handleNotifyScreenTurnedOn() {
        synchronized (this) {
            ...
            if(FeatureOption.BIRD_SMALL_VIEW_WINDOW){
                ...
                if (mTelecomManager != null) {
					int callState = mTelecomManager.getCallState();
    ...
    /*[BIRD][BIRD_SMALL_VIEW_WINDOW] mandy 20150602 begin */
    private void showLock() {
        synchronized (KeyguardViewMediator.this) {
            ...
            mHideAnimationRun = false;
            updateActivityLockScreenState();
            //updateActivityLockScreenState(true);
            adjustStatusBarLocked();
            userActivity();
            mHandler.postDelayed(new Runnable() {
                public void run() {
    ...
    private void playHallSounds(boolean show) {
        // User feedback for keyguard.
    	playHallSound(show ? mLockSoundId : mUnlockSoundId);
    }
    private void playHallSound(int soundId) {
    	if (soundId == 0) return;
    	mLockSounds.stop(mLockSoundStreamId);
    	// Init mAudioManager
    	if (mAudioManager == null) {
	...
	/*[BIRD][BIRD_SMALL_VIEW_WINDOW]:mandy.wu 20150627 begin*/
    public void showSmallViewWindow() {
    	boolean show = false; 
    	if(FeatureOption.BIRD_SMALL_VIEW_WINDOW == false || PowerOffAlarmManager.isAlarmBoot()){
    		return;
    	}
			...
			if (callState == TelephonyManager.CALL_STATE_IDLE) {
				...
				final ActivityManager am = (ActivityManager) mContext.getSystemService(Context.ACTIVITY_SERVICE);
		         ...
		         if(list!= null && list.size() > 0) {
		             ...
		             String pkgName = cn.getClassName();
		             Log.d("mandy","pkgName"+pkgName);
		             if(!pkgName.equals("com.android.incallui.InCallActivity")){
		            	 show = true;
		             }
		         }
			}
        ...
        if(show){
        	Message msg = mHandler.obtainMessage(SHOW_SMALL_WINOW);
	        mHandler.sendMessage(msg);
        }
    }
    ...
    public void hideSmallViewWindow() {
        ...
        if(hide){
        	Message msg = mHandler.obtainMessage(HIDE_SMALL_WINOW);
	        mHandler.sendMessage(msg);
        }
        if(mPowerManager == null){
    		mPowerManager = (PowerManager)mContext.getSystemService(Context.POWER_SERVICE);
    ...
    private void handleShowSmallWindow(){
        mStatusBarKeyguardViewManager.showSmallWindow(true);
    }
    
    private void handleHideSmallWindow(){
        mStatusBarKeyguardViewManager.showSmallWindow(false);
        if(mShowing){
        	showLock();
        }
	...
	boolean readHallStatus() {
		HallcoverManager hallcoverManager = (HallcoverManager)mContext.getSystemService(Context.HALL_COVER_SERVICE);
		return !hallcoverManager.readClamState();
	}

    /**
     * Is the small view window currently showing?
     * @return isShowLeather
     */
    public boolean isLeatherShowing() {
        if (mStatusBarKeyguardViewManager != null) {
            return mStatusBarKeyguardViewManager.isShowLeather();
        } else {
            return false;
        }
    }

    public void hideSmallViewWindowForAlarm() {
    	if(FeatureOption.BIRD_SMALL_VIEW_WINDOW == false){
    		return;
    	}
        Message msg = mHandler.obtainMessage(HIDE_SMALL_WINOW);
        mHandler.sendMessage(msg);
    }
    /*[BIRD][BIRD_SMALL_VIEW_WINDOW]:mandy.wu 20150627 end*/
