...
//[BIRD][BIRD_FACELOCK_SCREEN] caoyuangui add begin end 20170904
...
public class KeyguardBouncer {
    ...
    public void show(boolean resetSecuritySelection, boolean authenticated) {
        if (DEBUG) {
            ...
            Log.d(TAG, "show(authenticated) = " + authenticated);            
        }
        ...
        if (mRoot.getVisibility() == View.VISIBLE || mShowingSoon) {
            //[BIRD][BIRD_FACELOCK_SCREEN] caoyuangui add begin add 20170904
            boolean isFaceLock = mPhoneStatusBar !=null && mPhoneStatusBar.getFaceLockSuccess();
            if (!isFaceLock) {
                return;
            } 
            //[BIRD][BIRD_FACELOCK_SCREEN] caoyuangui add begin add 20170904
