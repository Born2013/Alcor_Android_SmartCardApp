...
/*[BIRD][BIRD_ENCRYPT_SPACE][加密空间][yangbo][20170920]BEGIN */
import com.android.systemui.FeatureOption;
import android.app.AlertDialog;
import com.bird.security.ContainerManager;
import android.content.DialogInterface;
/*[BIRD][BIRD_ENCRYPT_SPACE][加密空间][yangbo][20170920]END */
...
public abstract class BaseStatusBar extends SystemUI implements
    ...
    /*[BIRD][BIRD_ENCRYPT_SPACE][加密空间][yangbo][20170920]BEGIN */
    private static final String YUNEASY_TOEC_PACKAGENAME = "com.yuneasy.toec";
    ...
    private RemoteViews.OnClickHandler mOnClickHandler = new RemoteViews.OnClickHandler() {
        ...
        public boolean onClickHandler(
            ...
            if (FeatureOption.BIRD_ENCRYPT_SPACE) {
                if (YUNEASY_TOEC_PACKAGENAME.equals(view.getContext().getPackageName())) {
                    if (mContainerManager.isCurrentContainerUser() == false) {
                        switchToSecurityContainerConfirm();
                        return true;
                    }
                }
            }
    ...
    public void start() {
        ...
        /*[BIRD][BIRD_ENCRYPT_SPACE][加密空间][yangbo][20170920]BEGIN */
        if (FeatureOption.BIRD_ENCRYPT_SPACE) {
            mContainerManager = (ContainerManager) mContext.getSystemService(Context.BIRD_CONTAINER_SERVICE);
        }
        /*[BIRD][BIRD_ENCRYPT_SPACE][加密空间][yangbo][20170920]BEGIN */
    ...
    private final class NotificationClicker implements View.OnClickListener {
        ...
        public void register(ExpandableNotificationRow row, StatusBarNotification sbn) {
            ...
            /*[BIRD][BIRD_ENCRYPT_SPACE][加密空间][yangbo][20170920]BEGIN */
            if (FeatureOption.BIRD_ENCRYPT_SPACE) {
                if (YUNEASY_TOEC_PACKAGENAME.equals(sbn.getPackageName())) {
                    row.setOnClickListener(mSecurityContainerNotificationClicker);
                }
            }
            /*[BIRD][BIRD_ENCRYPT_SPACE][加密空间][yangbo][20170920]END */
        }
    ...
    /*[BIRD][BIRD_ENCRYPT_SPACE][加密空间][yangbo][20170920]BEGIN */
    private void switchToSecurityContainerConfirm() {
        if (mSwitchAlertDialog == null) {
            AlertDialog.Builder builder = new AlertDialog.Builder(mContext);
            builder.setTitle(R.string.switch_to_security_container_title);
            builder.setMessage(R.string.switch_to_security_container_message);
            builder.setNegativeButton(android.R.string.cancel, null);
            builder.setPositiveButton(android.R.string.ok, new DialogInterface.OnClickListener() {
                @Override
                public void onClick(DialogInterface dialog, int which) {
                    if (mSwitchAlertDialog != null) {
                        mSwitchAlertDialog.dismiss();
                        mSwitchAlertDialog = null;
                    }
                    //切换
                    mContainerManager.switchToSecurityContainer();
                }
            });
            ...
            mSwitchAlertDialog = builder.create();
            mSwitchAlertDialog.getWindow().setType(WindowManager.LayoutParams.TYPE_STATUS_BAR_PANEL);
            mSwitchAlertDialog.getWindow().addFlags(WindowManager.LayoutParams.FLAG_SHOW_WHEN_LOCKED);
        }
        mSwitchAlertDialog.show();
    }
    
    private View.OnClickListener mSecurityContainerNotificationClicker = new View.OnClickListener() {

        @Override
        public void onClick(View v) {
            if (mContainerManager.isCurrentContainerUser()) {
                if (!(v instanceof ExpandableNotificationRow)) {
                    return;
                }
                final ExpandableNotificationRow row = (ExpandableNotificationRow) v;
                ...
                if (notification.contentIntent != null || notification.fullScreenIntent != null) {
                    mNotificationClicker.onClick(v);
                }
            } else {
                if (v instanceof ExpandableNotificationRow) {
                    final ExpandableNotificationRow row = (ExpandableNotificationRow) v;
                    row.makeInactive(false);
                }
                switchToSecurityContainerConfirm();
            }
        }
