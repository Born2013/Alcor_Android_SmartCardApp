...
public class TaskStack {
    ...
    public void removeAllTasks() {
        ...
        for (int i = tasks.size() - 1; i >= 0; i--) {
            Task t = tasks.get(i);
            //[BIRD][BIRD_CLEAN_RECENT_APP_WOTU][喔图 每小时自动清理recent app][yangheng][20170508] BEGIN
            if (t.topActivity != null  && FeatureOption.BIRD_CLEAN_RECENT_APP_WOTU) {
                if (t.topActivity.getPackageName().equals("com.alltuu.android") || t.topActivity.getPackageName().equals("www.pailixiang.com.photoshare")) {
                    continue;
                }
            }
            //[BIRD][BIRD_CLEAN_RECENT_APP_WOTU][喔图 每小时自动清理recent app][yangheng][20170508] END
