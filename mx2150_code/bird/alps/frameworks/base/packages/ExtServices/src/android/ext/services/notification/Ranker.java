...
//[BIRD][BIRD_OLD_PHONE][bug14503] chengci 20170904 begin
import android.provider.Settings; 
import android.os.SystemProperties;
import android.app.ActivityThread;
//[BIRD][BIRD_OLD_PHONE][bug14503] chengci 20170904 end
...
public final class Ranker extends NotificationRankerService {
    ...
    //[BIRD][BIRD_OLD_PHONE][bug14503] chengci added 20170904 begin
    private boolean getBirdOldPhoneMode() {
        return SystemProperties.get("ro.bird_old_phone").equals("1") && 
            (Settings.System.getInt(/*ActivityThread.currentApplication().getApplicationContext()*/
                getContext().getContentResolver(), "is_oldphoneluancher_mode", 0) ==1);
    }
    //[BIRD][BIRD_OLD_PHONE][bug14503] chengci 20170904 end
