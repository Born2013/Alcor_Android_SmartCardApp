...
public class DefaultCarrierTextExt implements ICarrierTextExt {
    ...
    public static final boolean BIRD_MULTI_SIMLOCK_VIETTEL_IMPROVE = SystemProperties.get("ro.bird_mulit_simlock_viettel").equals("1");
    ...
    public CharSequence customizeCarrierTextCapital(CharSequence carrierText) {
        if (carrierText != null) {
            ...
            /*[BIRD][BIRD_MULTI_SIMLOCK_VIETTEL_IMPROVE][Viettel双卡锁网需求改进][字符串部分][yangbo][20171221]BEGIN */
            } if (BIRD_MULTI_SIMLOCK_VIETTEL_IMPROVE) {
                return carrierText;
            /*[BIRD][BIRD_MULTI_SIMLOCK_VIETTEL_IMPROVE][Viettel双卡锁网需求改进][字符串部分][yangbo][20171221]END */
            } else {
