...
public class KeyguardUpdateMonitor implements TrustManager.TrustListener {
    ...
    private void handleBatteryUpdate(BatteryStatus status) {
        ...
        mBatteryStatus = status;
            Log.d(TAG, "handleBatteryUpdate batteryUpdateInteresting = "+batteryUpdateInteresting);
...
/**    private void handleSimStateChange(int subId, int slotId, State state) {
    ...
    private static boolean isBatteryUpdateInteresting(BatteryStatus old, BatteryStatus current) {
        ...
        final boolean stateChangedWhilePluggedIn = wasPluggedIn == true && nowPluggedIn == true  && (old.status != current.status);
