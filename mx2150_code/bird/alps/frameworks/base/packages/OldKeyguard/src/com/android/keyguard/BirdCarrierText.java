...
public class BirdCarrierText extends TextView {
    private static final boolean DEBUG = KeyguardConstants.DEBUG;
    private static final String TAG = "BirdCarrierText";
    ...
    public BirdCarrierText(Context context) {
        this(context, null);
        /// M: Support GeminiPlus
        initMembers();
    }

    public BirdCarrierText(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context ;
    ...
    protected void updateCarrierText() {
        ...
        for (int i = 0 ; i < mNumOfPhone ; i++) {
            ...
            //if (simState == IccCardConstants.State.READY) {
                if (mCarrierNeedToShow[i] && (mCarrier[i] != null)) {
                    String operatorName = mTelephonyManager.getSimOperatorNameForPhone(i);
                    if (operatorName != null) {
                        if (operatorName.equals("CHN-UNICOM")) {
                            operatorName = "CU";
                        }
                        if (isZh()) {
                            if (operatorName.equals("cmcc") || operatorName.equals("CMCC") || mCarrier[i] .equals("Cmcc")) {
                                operatorName = "中国移动";
                            } else if (operatorName.equals("CU")) {
                                operatorName = "中国联通";
                            }
                        }
                    }
                    if (carrierFinalContent == null) {
                        ...
                        carrierFinalContent = operatorName;
                    } else {
                        carrierFinalContent = new StringBuilder(carrierFinalContent).
                                              append(" ").
                                              append(operatorName).toString();
                    }
                }
            //}
        }
        ...
        Log.d(TAG, "updateCarrierText() - after combination, carrierFinalContent = " +
                   carrierFinalContent) ;
        /*if (isZh() && carrierFinalContent != null) {
            if (carrierFinalContent.equals("cmcc") || carrierFinalContent.equals("CMCC")) {
                carrierFinalContent = "中国移动";
            } else if (carrierFinalContent.equals("CHN-UNICOM")) {
                carrierFinalContent = "中国联通";
            }
        }*/
        if (carrierFinalContent != null) {
