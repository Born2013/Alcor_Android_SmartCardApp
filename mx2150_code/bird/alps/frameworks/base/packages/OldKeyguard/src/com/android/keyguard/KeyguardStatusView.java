...
public class KeyguardStatusView extends GridLayout {
    ...
    public void refreshTime() {
        ...
        if (SystemProperties.get("ro.bird_add_date_format").equals("1")) {
            dateFormat = Settings.System.getString(getContext().getContentResolver(),Settings.System.DATE_FORMAT);
            if(dateFormat != null && dateFormat.equals("")) {
                LocaleData d = LocaleData.get(getContext().getResources().getConfiguration().locale);
                dateFormat = d.shortDateFormat4;
            }
            if (dateFormat == null) {
                dateFormat = "MM-dd-yyyy";
            }
            java.text.DateFormat shortDateFormat = DateFormat.getDateFormatForSetting(getContext(),dateFormat); //[BIRD][BIRD_SETTINGS_ADD_DATE_FORMAT][add date format][20150729]
            final Calendar now = Calendar.getInstance();
            mDateView.setFormat24Hour(shortDateFormat.format(now.getTime()));
            mDateView.setFormat12Hour(shortDateFormat.format(now.getTime()));
        } else {
        ...
        /*[BIRD][BIRD_KUSAI_KEYGUARD][基于原生锁屏的酷赛锁屏][zhangaman][20170623]begin*/
        if (FeatureOption.BIRD_KUSAI_KEYGUARD) {
            dateFormat = getResources().getString(R.string.bird_kusai_dateformat);
            mDateView.setFormat24Hour(dateFormat);
            mDateView.setFormat12Hour(dateFormat);
        }
        /*[BIRD][BIRD_KUSAI_KEYGUARD][基于原生锁屏的酷赛锁屏][zhangaman][20170623]end*/
