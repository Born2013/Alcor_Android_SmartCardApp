...
public class KeyguardSecurityContainer extends FrameLayout implements KeyguardSecurityView {
    ...
    private static boolean getValue(String key) {
        return android.os.SystemProperties.get(key).equals("1");
    }
    /*[BIRD][BIRD_ENCRYPT_SPACE][加密空间][yangbo][20170629]END */


    /*[BIRD][BIRD_OLD_PHONE]add by caoyuangui 20170801 begin */
    private View mBirdLockScreen;
    /*[BIRD][BIRD_OLD_PHONE]add by caoyuangui 20170801 begin */
    ...
    /*[BIRD][BIRD_OLD_PHONE]add by caoyuangui 20170801 end */
    ...
    public KeyguardSecurityContainer(Context context, AttributeSet attrs, int defStyle) {
        ...
        /*[BIRD][BIRD_ENCRYPT_SPACE][加密空间][yangbo][20170629]BEGIN */
        if (BIRD_ENCRYPT_SPACE) {
            mContainerManager = (ContainerManager) context.getSystemService(Context.BIRD_CONTAINER_SERVICE);
        }
        /*[BIRD][BIRD_ENCRYPT_SPACE][加密空间][yangbo][20170629]END */
    }
    ...
    public void onResume(int reason) {
        ...
        if (mCurrentSecuritySelection != SecurityMode.None) {
            if (FeatureOption.isOldPhoneUI(mContext)) {
               final int securityViewIdForMode = getSecurityViewIdForMode(mCurrentSecuritySelection);
               final int children = mSecurityViewFlipper.getChildCount();
               for (int child = 0; child < children; child++) {
                  if (mSecurityViewFlipper.getChildAt(child).getId() == securityViewIdForMode) {
                      KeyguardSecurityView  view = ((KeyguardSecurityView)mSecurityViewFlipper.getChildAt(child));
                      if (view.needsInput() && mSecurityViewFlipper.getVisibility() != View.INVISIBLE) {
        ...
        if (mBirdLockScreen !=null) {
            ((KeyguardSecurityView)mBirdLockScreen).onResume(reason);
        } 
        /*[BIRD][BIRD_OLD_PHONE]add by caoyuangui 20170801 end */   
    }
    ...
    public void onPause() {
        ...
        /*[BIRD][BIRD_OLD_PHONE]add by caoyuangui 20170801 begin */
        if (mCurrentSecuritySelection != SecurityMode.None || FeatureOption.isOldPhoneUI(mContext)) {
                //getSecurityView(mCurrentSecuritySelection).onPause();
               if (mBirdLockScreen !=null) {
                    ((KeyguardSecurityView)mBirdLockScreen).onPause();
               }
               final int securityViewIdForMode = getSecurityViewIdForMode(mCurrentSecuritySelection);
               final int children = mSecurityViewFlipper.getChildCount();
                for (int child = 0; child < children; child++) {
    ...
    public void startAppearAnimation() {
        ...
        if (mCurrentSecuritySelection != SecurityMode.None || FeatureOption.isOldPhoneUI(mContext)) {
           ...
           final int children = mSecurityViewFlipper.getChildCount();
            ...
            if (mBirdLockScreen !=null) {
                ((KeyguardSecurityView)mBirdLockScreen).startAppearAnimation();
            }
        }
        /*[BIRD][BIRD_OLD_PHONE]add by caoyuangui 20170801 end */
    }
    ...
    public boolean startDisappearAnimation(Runnable onFinishRunnable) {
        /*[BIRD][BIRD_OLD_PHONE]add by caoyuangui 20170801 begin */
        if (mCurrentSecuritySelection != SecurityMode.None) {
            //return getSecurityView(mCurrentSecuritySelection).startDisappearAnimation(onFinishRunnable);
           final int securityViewIdForMode = getSecurityViewIdForMode(mCurrentSecuritySelection);
           final int children = mSecurityViewFlipper.getChildCount();
            for (int child = 0; child < children; child++) {
                if (mSecurityViewFlipper.getChildAt(child).getId() == securityViewIdForMode) {
                   KeyguardSecurityView  view = ((KeyguardSecurityView)mSecurityViewFlipper.getChildAt(child));
                   return view.startDisappearAnimation(onFinishRunnable);
                }
            }
        }
        /*[BIRD][BIRD_OLD_PHONE]add by caoyuangui 20170801 begin */
    ...
    private KeyguardSecurityView getSecurityView(SecurityMode securityMode) {
       ...
       /*[BIRD][BIRD_OLD_PHONE]add by caoyuangui 20170801 begin */
        if (FeatureOption.isOldPhoneUI(mContext) && securityMode != SecurityMode.AlarmBoot) {
            KeyguardSecurityView  views =  getBirdLockScreenView();
            if (securityMode == SecurityMode.None) {
                if (views != null) {
                    return views;
                }
            } else {
                views.setKeyguardCallback(mNullCallback);
            }
        }
        if (securityMode == SecurityMode.AlarmBoot 
                ...
                || securityMode == SecurityMode.SimPinPukMe4) {
                    if (mBirdLockScreen !=null) {
                           KeyguardSecurityContainer.this.removeView(mBirdLockScreen);
                     }
        }
        /*[BIRD][BIRD_OLD_PHONE]add by caoyuangui 20170801 end */
    ...
    boolean showNextSecurityScreenOrFinish(boolean authenticated) {
        ...
        /*[BIRD][BIRD_OLD_PHONE]add by caoyuangui 20170801 begin */
        } else if (SecurityMode.None == mCurrentSecuritySelection && !FeatureOption.isOldPhoneUI(mContext)) {
        /*[BIRD][BIRD_OLD_PHONE]add by caoyuangui 20170801 end */
        
            SecurityMode securityMode = mSecurityModel.getSecurityMode();
            if (SecurityMode.None == securityMode) {
                if (DEBUG) {
                    Log.d(TAG, "showNextSecurityScreenOrFinish() " +  "- securityMode is None, just finish.");
                }
    ...
    private void showSecurityScreen(SecurityMode securityMode) {
        ...
        /*[BIRD][BIRD_OLD_PHONE]add by caoyuangui 20170801 begin */
        if ((securityMode == mCurrentSecuritySelection)  && (securityMode != SecurityMode.AntiTheft)
              && securityMode != SecurityMode.None && mCurrentSecuritySelection != SecurityMode.None) {
              if (FeatureOption.isOldPhoneUI(mContext) && securityMode != SecurityMode.None) {
                  getBirdLockScreenView().setKeyguardCallback(mNullCallback);
              }
              return;
        }
         /*[BIRD][BIRD_OLD_PHONE]add by caoyuangui 20170801 end */
        ...
        /*[BIRD][BIRD_OLD_PHONE]add by caoyuangui 20170801 begin */
        if (securityMode != SecurityMode.None || FeatureOption.isOldPhoneUI(mContext)) {
        /*[BIRD][BIRD_OLD_PHONE]add by caoyuangui 20170801 end */
            /// M: fix ALPS01832185,
        ...
        if (newView !=null) {
            mSecurityCallback.onSecurityModeChanged(securityMode,
                (securityMode != SecurityMode.None || !FeatureOption.isOldPhoneUI(mContext)) && newView.needsInput());
        } 
    ...
    private KeyguardSecurityCallback mCallback = new KeyguardSecurityCallback() {
        ...
        public void reportUnlockAttempt(int userId, boolean success, int timeoutMs) {
            ...
            if (success) {
                ...
                /*[BIRD][BIRD_ENCRYPT_SPACE][加密空间][yangbo][20170629]BEGIN */
                if (BIRD_ENCRYPT_SPACE) {
                    mContainerManager.reportSuccessfulPasswordAttempt();
                }
                /*[BIRD][BIRD_ENCRYPT_SPACE][加密空间][yangbo][20170629]END */
                ...
                /*[BIRD][BIRD_ENCRYPT_SPACE][加密空间][yangbo][20170629]BEGIN */
                if (BIRD_ENCRYPT_SPACE) {
                    mContainerManager.reportFailedPasswordAttempt();
                }
                /*[BIRD][BIRD_ENCRYPT_SPACE][加密空间][yangbo][20170629]END */
            }
        }
    ...
    void setSecurityMode(KeyguardSecurityModel securityMode) {
        ...
        /*[BIRD][BIRD_OLD_PHONE]add by caoyuangui 20170801 begin */
        if (mBirdLockScreen !=null) {
             ((BridOldLockScreen) mBirdLockScreen).setKeyguardSecurityModel(mSecurityModel);
        }
        /*[BIRD][BIRD_OLD_PHONE]add by caoyuangui 20170801 begin */
    ...
    /*[BIRD][BIRD_OLD_PHONE]add by caoyuangui 20170801 begin */
    private KeyguardSecurityView getBirdLockScreenView() {
        if (mBirdLockScreen == null) {
            mBirdLockScreen = createBirdLockScreen();
            if (mBirdLockScreen != null) {
                this.addView(mBirdLockScreen);
                updateSecurityView(mBirdLockScreen);
            } else {
                return null;
            }
        }
        return (KeyguardSecurityView)mBirdLockScreen;
    }

    private View createBirdLockScreen() {
        BridOldLockScreen lockView = new BridOldLockScreen(mContext,mCallback,mLockPatternUtils);
        lockView.setKeyguardSecurityModel(mSecurityModel);
        return  lockView;
    }
    /*[BIRD][BIRD_OLD_PHONE]add by caoyuangui 20170801 end */
