...
public class KeyguardServiceDelegate {
    ...
    // [BIRD_REMOVE_FIRST_BLACK]caoyuangui add 20180306 begin
    private static final boolean BIRD_REMOVE_FIRST_BLACK = android.os.SystemProperties.get("ro.remove_first_black").equals("1");
    // [BIRD_REMOVE_FIRST_BLACK]caoyuangui add 20180306 end    
    ...
    private static View createScrim(Context context, Handler handler) {
        ...
        // [BIRD_REMOVE_FIRST_BLACK]caoyuangui add 20180306 begin
        if (BIRD_REMOVE_FIRST_BLACK) {
            view.setBackgroundResource(com.android.internal.R.drawable.zzzzz_log_haishitong);
        }
        // [BIRD_REMOVE_FIRST_BLACK] caoyuangui add 20180306 end
    ...
    public void dump(String prefix, PrintWriter pw) {
     ...
     /*[BIRD_SMALL_VIEW_WINDOW] wurongfu 20150402 begin */
    public void showSmallViewWindow(boolean show) {
        Log.i(TAG+"hall","showSmallViewWindow show= "+show);
        if (mKeyguardService != null) {
            if (show) {
                mKeyguardService.showSmallViewWindow();
            } else {
                mKeyguardService.hideSmallViewWindow();
            }
            
        }
    }
    /*[BIRD_SMALL_VIEW_WINDOW] wurongfu 20150402 end */
}
