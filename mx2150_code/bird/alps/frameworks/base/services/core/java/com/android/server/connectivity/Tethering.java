...
public class Tethering extends BaseNetworkObserver {
    ...
    /*[BIRD][BIRD_HIDE_TETHER_NOTIFICATION_WHEN_USB_DISCONNECTED][USB断开连接，关闭共享网络][zhangaman][20170904]begin*/
    private boolean mUsbHwDisconnected;
    /*[BIRD][BIRD_HIDE_TETHER_NOTIFICATION_WHEN_USB_DISCONNECTED][USB断开连接，关闭共享网络][zhangaman][20170904]end*/
    ...
    private void sendTetherStateChangedBroadcast() {
        ...
        /** M: Hotspot Manager @{ */
        //add para2 to showTetheredNotification()
        if (usbTethered) {
        ...
        public void onReceive(Context content, Intent intent) {
            ...
            if (action.equals(UsbManager.ACTION_USB_STATE)) {
                synchronized (Tethering.this.mPublicSync) {
                    ...
                    //mUsbTetherRequested = false;
                    /*[BIRD][BIRD_HIDE_TETHER_NOTIFICATION_WHEN_USB_DISCONNECTED][USB断开连接，关闭共享网络][zhangaman][20170904]begin*/
                    if (SystemProperties.get("ro.bd_hide_tether_notifi").equals("1")) {
                        mUsbHwDisconnected = intent.getBooleanExtra("USB_HW_DISCONNECTED", false);
                        Log.d("aaman","mUsbHwDisconnected = "+mUsbHwDisconnected);
                        if (mUsbHwDisconnected) {
                            ...
                            Log.d("aaman","usbTethered = "+usbTethered);
                            if (usbTethered) {
                                cm.stopTethering(ConnectivityManager.TETHERING_USB);
                            }
                        }
                    }
                    /*[BIRD][BIRD_HIDE_TETHER_NOTIFICATION_WHEN_USB_DISCONNECTED][USB断开连接，关闭共享网络][zhangaman][20170904]end*/
