...
class AppErrors {
    ...
    void handleShowAnrUi(Message msg) {
        ...
        synchronized (mService) {
            ...
            /*[BIRD][BIRD_REMOVE_ANR_DIALOG][去掉anr弹框][zhangaman][20180208]begin*/
            if (!"1".equals(SystemProperties.get("ro.bird_remove_anr_dialog")) && (mService.canShowErrorDialogs() || (mService.mANRManager.DISABLE_ALL_ANR_MECHANISM
                != mService.mANRManager.enableANRDebuggingMechanism()))) {
            /// @}
            /*[BIRD][BIRD_REMOVE_ANR_DIALOG][去掉anr弹框][zhangaman][20180208]end*/
