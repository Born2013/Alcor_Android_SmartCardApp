...
public final class PowerManagerService extends SystemService
    ...
    public void systemReady(IAppOpsService appOps) {
        synchronized (mLock) {
            ...
            mContext.registerReceiver(new DockReceiver(), filter, null, mHandler);
             // add by dayin
            /*[BIRD_HEART_RATE_TEST][心率测试][zhangaman][20161027]begin*/
            if (SystemProperties.get("ro.bd_heart_rate").equals("1")) {
            ...
            /*[BIRD_HEART_RATE_TEST][心率测试][zhangaman][20161027]end*/
    ...
    private void updateStayOnLocked(int dirty) {
        if ((dirty & (DIRTY_BATTERY_STATE | DIRTY_SETTINGS)) != 0) {
            ...
            if (com.android.server.FeatureOption.BIRD_DISPLAY_ADD_STAY_ON_OPTION) {
