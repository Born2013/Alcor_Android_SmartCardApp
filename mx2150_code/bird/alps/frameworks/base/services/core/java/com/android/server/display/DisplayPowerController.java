...
final class DisplayPowerController implements AutomaticBrightnessController.Callbacks {
    ...
    private void initialize() {
        ...
        /*[BIRD][BIRD_REMOVE_POWERKEY_ANIMATION][去掉POWER键灭屏动画][zhangaman][20170309]begin*/
        if (SystemProperties.get("ro.bd_remove_powerkey_ani").equals("1")) {
            mColorFadeOffAnimator.setDuration(0);
        } else {
            mColorFadeOffAnimator.setDuration(COLOR_FADE_OFF_ANIMATION_DURATION_MILLIS);
        }
        /*[BIRD][BIRD_REMOVE_POWERKEY_ANIMATION][去掉POWER键灭屏动画][zhangaman][20170309]end*/
