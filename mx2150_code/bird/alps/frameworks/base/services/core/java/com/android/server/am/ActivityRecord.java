...
final class ActivityRecord {
    ...
    void scheduleConfigurationChanged(Configuration config, boolean reportToActivity) {
        ...
        try {
            ...
            /*[BIRD][BIRD_MY_MM_GMS_FORCE_ENGLISH][系统语言为缅甸语时，GMS包中应用显示为英文][yangbo][20180211]BEGIN */
            if (FeatureOption.BIRD_MY_MM_GMS_FORCE_ENGLISH) {
                Configuration forceConfig = service.forceConfigurationLocaleIfNeeded(overrideConfig, app, "scheduleConfigurationChanged");
                app.thread.scheduleActivityConfigurationChanged(
                        appToken, forceConfig, reportToActivity);
            } else {
                app.thread.scheduleActivityConfigurationChanged(
