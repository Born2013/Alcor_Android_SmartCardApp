...
public class MtkPermErrorDialog extends MtkAppErrorDialog implements View.OnClickListener {
    ...
    private void setupUiComponents() {
		...
		boolean isCtaSupport = SystemProperties.get("ro.mtk_cta_support").equals("1");
        if (!TextUtils.isEmpty(permissionName)) {
            if (isWlanPerm || isBtPerm) {
				//[BIRD][CTA权限提示框提示错误][pangmeizhou][20180123]begin
                message = res.getString(
                        isCtaSupport ? com.android.internal.R.string.zzzzz_aerr_application_permission_connectivity : 
						com.mediatek.internal.R.string.aerr_application_permission_connectivity,
                        applicationName,
                        permissionName);
				//[BIRD][CTA权限提示框提示错误][pangmeizhou][20180123]end
            } else {
                message = res.getString(
        ...
        setButton(DialogInterface.BUTTON_POSITIVE,
                res.getText(isCtaSupport ? com.android.internal.R.string.zzzzz_mtk_perm_err_dialog_ok : 
							com.mediatek.internal.R.string.mtk_perm_err_dialog_ok),
		//[BIRD][CTA权限提示框提示错误][pangmeizhou][20180123]end
