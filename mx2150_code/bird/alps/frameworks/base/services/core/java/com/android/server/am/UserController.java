...
final class UserController {
    ...
    private void finishUserUnlockedCompleted(UserState uss) {
        ...
        synchronized (mService) {
            ...
            if (com.android.server.FeatureOption.BIRD_ZX_SHOUFUBAO_APPS) {
                Intent intent = new Intent();
                intent.setComponent(new android.content.ComponentName("com.njzx.lock", "com.njzx.lock.StarLockService"));
