...
import com.android.server.FeatureOption;//[BIRD][BIRD_HOOK_NEXT_MUSIC][music播放音乐时长按进入下一首][hongzhihao][20170607]

import android.os.SystemProperties; /*[BIRD][一键静音][Task6105] chengci 20171024 */
/**
...
public class MediaSessionService extends SystemService implements Monitor {
    ...
    class SessionManagerImpl extends ISessionManager.Stub {
        ...
        public void dispatchMediaKeyEvent(KeyEvent keyEvent, boolean needWakeLock) {
            ...
            try {
                ...
                synchronized (mLock) {
                    ...
                    if (isVoiceKey(keyEvent.getKeyCode()) && (!isMusicActive() || !FeatureOption.BIRD_HOOK_NEXT_MUSIC)) {
                    //[BIRD][BIRD_HOOK_NEXT_MUSIC][music播放音乐时长按进入下一首][hongzhihao][20170607]
        ...
        private void dispatchAdjustVolumeLocked(int suggestedStream, int direction, int flags,
            ...
            /*[BIRD][一键静音][Task6105]  added getOneStepEnable() chengci 20171024 */
            if (session == null || preferSuggestedStream || getOneStepEnable()) {
                if ((flags & AudioManager.FLAG_ACTIVE_MEDIA_ONLY) != 0
                        && !AudioSystem.isStreamActive(AudioManager.STREAM_MUSIC, 0)) {
                    if (DEBUG) {
                        Log.d(TAG, "No active session to adjust, skipping media only volume event");
                    }
                    Log.d("Bird_oneStep", "enter mService sendAdjustVolumeBy ccc");
                    return;
                }
                try {
                    Log.d("Bird_oneStep", "enter mService sendAdjustVolumeBy ddd");
                ...
                Log.d("Bird_oneStep", "enter mService sendAdjustVolumeBy eee");
