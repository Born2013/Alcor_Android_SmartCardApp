...
public class GestureLauncherService extends SystemService {
    ...
    private void updateCameraDoubleTapPowerEnabled() {
        ...
        synchronized (this) {
            /*[BIRD][BUG-14341][放大镜]放大镜界面按电源按钮两次打开相机,提示：older tool停止运行][zhangaman][20170831]begin*/
            boolean isOldPhone = SystemProperties.get("ro.bird_old_phone").equals("1")
                    && Settings.System.getInt(mContext.getContentResolver(), "is_oldphoneluancher_mode", 0)==1;
            if (isOldPhone) {
                mCameraDoubleTapPowerEnabled = false;
            } else {
                mCameraDoubleTapPowerEnabled = enabled;
            }
            /*[BIRD][BUG-14341][放大镜]放大镜界面按电源按钮两次打开相机,提示：older tool停止运行][zhangaman][20170831]end*/
        }
    }
    ...
    public boolean interceptPowerKeyDown(KeyEvent event, boolean interactive,
        ...
        /*[BIRD][BIRD_AIMEI_STUDENT] caoyuangui 20170613 BEGIN*/
        if (BIRD_AIMEI_STUDENT && isForbid(mContext)) {
              return false;
        }
        /*[BIRD][BIRD_AIMEI_STUDENT] caoyuangui 20170613 BEGIN*/
    ...
    private static final String SELECTION = "pkgname='com.mediatek.camera'";
