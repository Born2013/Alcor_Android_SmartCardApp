...
public class AudioService extends IAudioService.Stub {
    ...
    /// @}
    //[BIRD][BIRD_CB_SAE_FEATURE_CUSTOM][小区广播SAE功能客制化][zhangaman][20170122]begin
    private static boolean mUseFixedAlertVolume = false;
    //[BIRD][BIRD_CB_SAE_FEATURE_CUSTOM][小区广播SAE功能客制化][zhangaman][20170122]end
    ...
    private void adjustSuggestedStreamVolume(int direction, int suggestedStreamType, int flags,
        ...
        if (mVolumeControlStream != -1 && !getOneStepEnable()) {
            Log.d("Bird_oneStep", "enter AudioService sendAdjustVolumeBy ccc");
            streamType = mVolumeControlStream;
        } else {
            Log.d("Bird_oneStep", "enter AudioService sendAdjustVolumeBy ddd");
    ...
    private void adjustStreamVolume(int streamType, int direction, int flags,
        ...
        if (DEBUG_VOL) Log.d(TAG, "adjustStreamVolume() stream=" + streamType + ", dir=" + direction
                + ", flags=" + flags + ", caller=" + caller);
        //[BIRD][BIRD_CB_SAE_FEATURE_CUSTOM][小区广播SAE功能客制化][zhangaman][20170122]begin
        if (SystemProperties.get("ro.bd_sae_custom").equals("1")) {
            Log.d(TAG, "lll adjustStreamVolume mUseFixedAlertVolume="+mUseFixedAlertVolume);
            if(mUseFixedAlertVolume && ((streamType==AudioSystem.STREAM_RING) || (streamType==AudioSystem.STREAM_NOTIFICATION))) {
        ...
        if (isMuteAdjust && !isStreamAffectedByMute(streamType) && !getOneStepEnable()) {
            Log.d("Bird_oneStep", "enter AudioService sendAdjustVolumeBy iii");
            return;
        }
        ...
        Log.d("Bird_oneStep", "enter AudioService sendAdjustVolumeBy ooo" + adjustVolume);
    ...
    private void setStreamVolume(int streamType, int index, int flags, String callingPackage,
        ...
        if (SystemProperties.get("ro.bd_sae_custom").equals("1")) {
            ...
            if (mUseFixedAlertVolume && ((streamType==AudioSystem.STREAM_RING)
    ...
    private void sendVolumeUpdate(int streamType, int oldIndex, int index, int flags) {
        ...
        Log.d("Bird_oneStep", "enter AudioService sendAdjustVolumeBy www " + streamType);
    ...
    /*[BIRD][一键静音][Task6105] chengci 20171024 begin */
    //通话是否等待接听中
    private boolean isWaitCalling() {
        TelephonyManager mTelephonyMgr = (TelephonyManager) mContext.getSystemService(
            Context.TELEPHONY_SERVICE);
        if (mTelephonyMgr != null && mTelephonyMgr.getCallState() == TelephonyManager.CALL_STATE_RINGING) {
            return true;
        } else {
            return false;
        }     
    ...
    private int getActiveStreamType(int suggestedStreamType) {
        ...
        case AudioSystem.PLATFORM_VOICE:
            if (isInCommunication()) {
                if (AudioSystem.getForceUse(AudioSystem.FOR_COMMUNICATION)
                    ...
                    if (getOneStepEnable()) {
                        if (isWaitCalling()) {
                            Log.d("Bird_oneStep", "enter AudioService getActiveStreamType WaitCall true");
                            return AudioSystem.STREAM_RING;
                        } else if (getOneStepMuteMode()) {
                            Log.d("Bird_oneStep", "enter AudioService getActiveStreamType WaitCall false");
            ...
            /*[BIRD][一键静音][Task6105] chengci 20171024 begin */
            else if (getOneStepEnable() && suggestedStreamType == AudioManager.STREAM_RING) {
                Log.d("Bird_oneStep", "getActiveStreamType: Forcing STREAM_RING b/c default");
                return AudioSystem.STREAM_RING;
            }
            /*[BIRD][一键静音][Task6105] chengci 20171024 end */
        ...
        if (DEBUG_VOL) Log.v(TAG, "getActiveStreamType: Returning suggested type "
                + suggestedStreamType);
        Log.d("Bird_oneStep", "enter AudioService getActiveStreamType default222 " + suggestedStreamType);
