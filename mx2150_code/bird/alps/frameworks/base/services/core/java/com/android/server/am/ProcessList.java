...
final class ProcessList {
    ...
    ProcessList() {
        ...
        if ((mOomAdj == null) || (mOomMinFree == null) || (mOomMinFree[0] == 0)) {
            ...
            /*[BIRD][BIRD_OOM_FOR_2G][调整2G内存项目的oom阈值]xujing 20170810 begin*/
            } else if (SystemProperties.get("ro.bird_oom_for_2g").equals("1")) {
                mOomAdj = new int[] {
                    FOREGROUND_APP_ADJ,
                    VISIBLE_APP_ADJ,
                    PERCEPTIBLE_APP_ADJ,
                ...
                mOomMinFree = new int[] {
                    73728, // 72 * 1024 (ADJ 0 -> 72MB)
                    92160, // 90 * 1024 (ADJ 1 -> 90MB)
                    110592, // 108 * 1024 (ADJ 2 -> 60MB)
                    129024, // 126 * 1024 (ADJ 3 -> 72MB)
                    235520, // 230 * 1024 (ADJ 9 -> 200MB) (based on performance test)
                    307200  // 300 * 1024 (ADJ 15 -> 290MB (= 200MB x 1.25 x 1.75 / 1.5)
                };
            /*[BIRD][BIRD_OOM_FOR_2G][调整2G内存项目的oom阈值]xujing 20170810 end*/
