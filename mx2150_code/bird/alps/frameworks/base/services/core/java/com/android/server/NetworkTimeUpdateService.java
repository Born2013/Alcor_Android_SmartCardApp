...
public class NetworkTimeUpdateService extends Binder {
    ...
    //<!--[BIRD][配置网络自动校时功能可用][dengyang][20160127]-->
    private static final String[] SERVERLIST =  new String[]{
                                            "asia.pool.ntp.org",
                                             "asia.pool.ntp.org",
                                             "2.android.poll.ntp.org"
                                             };
    //<!--[BIRD][配置网络自动校时功能可用][dengyang][20160127]-->
    ...
    public void systemRunning() {
        ...
        if (isFirstBoot) {
           ...
           if ("".equals(decryptState) || DECRYPT_STATE.equals(decryptState)) {
              ...
              /*[BIRD][系统默认日期配置][pangmeizhou][20161117]BEGIN*/
              //today.set(1, 0, mDefaultYear);
              today.set(0, 0, 0, 1, 0, 2018); 
              /*[BIRD][系统默认日期配置][pangmeizhou][20161117]END*/ 
