    ...
    private void startOtherServices() {
        ...
        if (mFactoryTestMode != FactoryTest.FACTORY_TEST_LOW_LEVEL) {
            ...
            if(true == SystemProperties.get("ro.bd_hall_leather").equals("1") 
		        ...
		        try {
		            Slog.i("HallcoverManager", "hallCover Service");
		            hallCover = new HallcoverManagerService(context);
					Slog.i("HallcoverManager", "aa hallCover Service = "+hallCover);
		            ServiceManager.addService(Context.HALL_COVER_SERVICE, hallCover);
					Slog.i("HallcoverManager", "bb hallCover Service = "+hallCover);
		        } catch (Throwable e) {
					Slog.e("HallcoverManager", "starting hallCover Service", e);
		        }
			}
            /*[BIRD][BIRD_SMALL_VIEW_WINDOW][深圳皮套功能][接口部分][pangmeizhou][20160614] END*/
            ...
            if (FeatureOption.BIRD_ENCRYPT_SPACE) {
                ServiceManager.addService(Context.BIRD_CONTAINER_SERVICE, BirdContainerManagerService.getInstance());
                BirdContainerManagerService.getInstance().init();
            }
            /*[BIRD][BIRD_ENCRYPT_SPACE][加密空间][yangbo][20170629]END */
        }
