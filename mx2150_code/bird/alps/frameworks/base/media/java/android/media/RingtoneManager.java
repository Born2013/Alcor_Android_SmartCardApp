...
//[BUG-12727] caoyuangui add begin 20170711
import android.os.SystemProperties;
//[BUG-12727] caoyuangui add end 20170711
/**
...
public class RingtoneManager {
    ...
    * @hide
    */
   public static final boolean IS_RINGTONE_RELEASE = SystemProperties.get("ro.bird_ringtone_release").equals("1");
    //[BUG-12727] caoyuangui add end 20170711
    ...
    /*[BUG-9266][来电铃声设为手机存储上的铃声，删除手机存储上的声音后，设置-声音-来电铃声显示“位置铃声”，且铃声列表没有默认][zhangaman][20170314]begin*/
    ...
    /*[BUG-9266][来电铃声设为手机存储上的铃声，删除手机存储上的声音后，设置-声音-来电铃声显示“位置铃声”，且铃声列表没有默认][zhangaman][20170314]end*/
...
*/
    ...
    private static Ringtone getRingtone(final Context context, Uri ringtoneUri, int streamType) {
        ...
        try {
            ...
            int ringtoneType = -1;
            //[BUG-12727] caoyuangui add begin 20170711
            if (! IS_RINGTONE_RELEASE) {
                if (ringtoneUri != null) {
                    ringtoneType = getDefaultType(ringtoneUri);
                    if (ringtoneType == TYPE_RINGTONE) {
