...
//[BIRD][BIRD_DEFAULT_RING_VOLUME_VALUE][默认铃声音量大小][yangheng][20161116] BEGIN
import com.bird.FeatureOption;
//[BIRD][BIRD_DEFAULT_RING_VOLUME_VALUE][默认铃声音量大小][yangheng][20161116] END
...
public class AudioSystem
{
    ...
    */
    public static int[] DEFAULT_STREAM_VOLUME = new int[] {
        FeatureOption.BIRD_DEFAULT_CALL_VOLUME_VALUE,  // STREAM_VOICE_CALL old:4 [BIRD][BIRD_DEFAULT_CALL_VOLUME_VALUE][默认通话音量大小][zhangaman][20170722]
        15,  // STREAM_SYSTEM
        FeatureOption.BIRD_DEFAULT_RING_VOLUME_VALUE,  // STREAM_RING//[BIRD][BIRD_DEFAULT_RING_VOLUME_VALUE][默认铃声音量大小][yangheng][20161116]
        FeatureOption.BIRD_DEFAULT_MEDIA_VOLUME_VALUE, // STREAM_MUSIC//[BIRD][BIRD_DEFAULT_RING_VOLUME_VALUE][默认铃声音量大小][yangheng][20161116]
        FeatureOption.BIRD_DEFAULT_ALARM_VOLUME_VALUE,  // STREAM_ALARM//[BIRD][BIRD_DEFAULT_RING_VOLUME_VALUE][默认铃声音量大小][yangheng][20161116]
        FeatureOption.BIRD_DEFAULT_RING_VOLUME_VALUE,  // STREAM_NOTIFICATION//[BIRD][BIRD_DEFAULT_RING_VOLUME_VALUE][默认铃声音量大小][yangheng][20161116]
