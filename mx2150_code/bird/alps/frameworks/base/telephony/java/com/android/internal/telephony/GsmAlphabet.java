...
//[BIRD_7BIT_LOSSY_CODING][西班牙文7位有损编码][hongzhihao][20161209] start 
import android.os.SystemProperties;
//[BIRD_7BIT_LOSSY_CODING][西班牙文7位有损编码][hongzhihao][20161209] end 
...
public class GsmAlphabet {
    ...
    static {
        ...
        // [BIRD_7BIT_LOSSY_CODING][西班牙文7位有损编码][hongzhihao][20161209] begin
        if (SystemProperties.get("ro.bd_7bit_lossy_coding").equals("1")){
            SparseIntArray defaultCharToGsm = sCharsToGsmTables[0];
            defaultCharToGsm.put('\u0116', 0x45);//E
            defaultCharToGsm.put('\u00CA', 0x45);
            defaultCharToGsm.put('\u0118', 0x45);
            defaultCharToGsm.put('\u0112', 0x45);
            defaultCharToGsm.put('\u00C8', 0x45);
            defaultCharToGsm.put('\u00C9', 0x45);
            defaultCharToGsm.put('\u00CB', 0x45);
            defaultCharToGsm.put('\u0117', 0x65);//e
            defaultCharToGsm.put('\u00EA', 0x65);
            defaultCharToGsm.put('\u0119', 0x65);
            defaultCharToGsm.put('\u0113', 0x65);
            defaultCharToGsm.put('\u00E8', 0x65);
            defaultCharToGsm.put('\u00E9', 0x65);
            defaultCharToGsm.put('\u00EB', 0x65);

            defaultCharToGsm.put('\u016A', 0x55);//U
            defaultCharToGsm.put('\u00D9', 0x55);
            defaultCharToGsm.put('\u00DB', 0x55);
            defaultCharToGsm.put('\u00DC', 0x55);
            defaultCharToGsm.put('\u00DA', 0x55);
            defaultCharToGsm.put('\u016B', 0x75);//u
            defaultCharToGsm.put('\u00F9', 0x75);
            defaultCharToGsm.put('\u00FB', 0x75);
            defaultCharToGsm.put('\u00FC', 0x75);
            defaultCharToGsm.put('\u00FA', 0x75);

            defaultCharToGsm.put('\u012A', 0x49);//I
            defaultCharToGsm.put('\u00CE', 0x49);
            defaultCharToGsm.put('\u012E', 0x49);
            defaultCharToGsm.put('\u00CC', 0x49);
            defaultCharToGsm.put('\u00CF', 0x49);
            defaultCharToGsm.put('\u00CD', 0x49);
            defaultCharToGsm.put('\u012B', 0x69);//i
            defaultCharToGsm.put('\u00EE', 0x69);
            defaultCharToGsm.put('\u012F', 0x69);
            defaultCharToGsm.put('\u00EF', 0x69);
            defaultCharToGsm.put('\u00EC', 0x69);
            defaultCharToGsm.put('\u00ED', 0x69);

            defaultCharToGsm.put('\u014C', 0x4F);//O
            defaultCharToGsm.put('\u0152', 0x4F);
            defaultCharToGsm.put('\u00D8', 0x4F);
            defaultCharToGsm.put('\u00D5', 0x4F);
            defaultCharToGsm.put('\u00D4', 0x4F);
            defaultCharToGsm.put('\u00D6', 0x4F);
            defaultCharToGsm.put('\u00D2', 0x4F);
            defaultCharToGsm.put('\u00D3', 0x4F);
            defaultCharToGsm.put('\u00BA', 0x6F);//o
            defaultCharToGsm.put('\u014D', 0x6F);
            defaultCharToGsm.put('\u0153', 0x6F);
            defaultCharToGsm.put('\u00F8', 0x6F);
            defaultCharToGsm.put('\u00F5', 0x6F);
            defaultCharToGsm.put('\u00F4', 0x6F);
            defaultCharToGsm.put('\u00F6', 0x6F);
            defaultCharToGsm.put('\u00F2', 0x6F);
            defaultCharToGsm.put('\u00F3', 0x6F);

            defaultCharToGsm.put('\u00C5', 0x41);//A
            defaultCharToGsm.put('\u0104', 0x41);
            defaultCharToGsm.put('\u00C6', 0x41);
            defaultCharToGsm.put('\u0100', 0x41);
            defaultCharToGsm.put('\u00C1', 0x41);
            defaultCharToGsm.put('\u00C0', 0x41);
            defaultCharToGsm.put('\u00C4', 0x41);
            defaultCharToGsm.put('\u00C2', 0x41);
            defaultCharToGsm.put('\u00C3', 0x41);
            defaultCharToGsm.put('\u00E5', 0x61);//a
            defaultCharToGsm.put('\u0105', 0x61);
            defaultCharToGsm.put('\u00E6', 0x61);
            defaultCharToGsm.put('\u0101', 0x61);
            defaultCharToGsm.put('\u00AA', 0x61);//ª
            defaultCharToGsm.put('\u00E1', 0x61);
            defaultCharToGsm.put('\u00E0', 0x61);
            defaultCharToGsm.put('\u00E4', 0x61);
            defaultCharToGsm.put('\u00E2', 0x61);
            defaultCharToGsm.put('\u00E3', 0x61);

            defaultCharToGsm.put('\u010C', 0x43);//C
            defaultCharToGsm.put('\u00C7', 0x43);
            defaultCharToGsm.put('\u0106', 0x43);
            defaultCharToGsm.put('\u010D', 0x63);//c
            defaultCharToGsm.put('\u00E7', 0x63);
            defaultCharToGsm.put('\u0107', 0x63);

            defaultCharToGsm.put('\u0143', 0x4E);//N
            defaultCharToGsm.put('\u00D1', 0x4E);
            defaultCharToGsm.put('\u0144', 0x6E);//n
            defaultCharToGsm.put('\u00F1', 0x6E);

            defaultCharToGsm.put('\u00F7', 0xF6);//÷
            defaultCharToGsm.put('\u2022', 0x2022);//·
            defaultCharToGsm.put('\u0060', 0x60);//`
            defaultCharToGsm.put('\u221A', 0xFB);//√
            defaultCharToGsm.put('\u03C0', 0xE3);//π
            defaultCharToGsm.put('\u00D7', 0xD7);//×
            defaultCharToGsm.put('\u2206', 0x2206);//∆
            defaultCharToGsm.put('\u00B0', 0xF8);//°
            defaultCharToGsm.put('\u2122', 0x2122);//™
            defaultCharToGsm.put('\u00A2', 0xA2);//¢
            defaultCharToGsm.put('\u00A9', 0xA9);//©
            defaultCharToGsm.put('\u00AE', 0xAE);//®
            defaultCharToGsm.put('\u2105', 0x2105);//℅
            defaultCharToGsm.put('\u007E', 0x7E);//∼
            defaultCharToGsm.put('\u007C', 0x7C);//|
            defaultCharToGsm.put('\u20AC', 0x20AC);//€
            defaultCharToGsm.put('\u007D', 0x7D);//}
            defaultCharToGsm.put('\u007B', 0x7B);//{
            defaultCharToGsm.put('\u005E', 0x5E);//^
            defaultCharToGsm.put('\u005B', 0x5B);//[
            defaultCharToGsm.put('\u005D', 0x5D);//]
            defaultCharToGsm.put('\u00B6', 0xB6);//¶
        }
        //[BIRD_7BIT_LOSSY_CODING][西班牙文7位有损编码][hongzhihao][20161209] end 
        //[BIRD_7BIT_LOSSY_CODING_2][西班牙文7位有损编码 部分保留帽子][yangheng][20170405] BEGIN
        if (SystemProperties.get("ro.bd_7bit_lossy_coding_2").equals("1")){
            SparseIntArray defaultCharToGsm = sCharsToGsmTables[0];
            defaultCharToGsm.put('\u0116', 0x45);//E
            defaultCharToGsm.put('\u00CA', 0x45);
            defaultCharToGsm.put('\u0118', 0x45);
        ...
        //[BIRD_7BIT_LOSSY_CODING_2][西班牙文7位有损编码 部分保留帽子][yangheng][20170405] END 
