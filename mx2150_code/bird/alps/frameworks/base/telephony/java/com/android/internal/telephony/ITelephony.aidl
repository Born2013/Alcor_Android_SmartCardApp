...
interface ITelephony {
    ...
    //[BIRD_SMT_SW][贴片软件 写barcode接口][dengyang][20160310]begin
    void invokeOemRilRequestString(in String[] at, int cmdtype);
    //[BIRD_SMT_SW][贴片软件 写barcode接口][dengyang][20160310]end
}
