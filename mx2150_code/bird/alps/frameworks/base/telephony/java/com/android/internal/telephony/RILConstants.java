...
public interface RILConstants {
    ...
    */
    //[BIRD][BIRD_NET_MODE_3G_2G][首先网络默认选中3G/2G][yangheng][20170915] BEGIN
    //[BIRD][BIRD_NETWORK_WIRHOUT_WCDMA][网络模式去掉3G][chenguangxiang][20171221] BEGIN
    int PREFERRED_NETWORK_MODE = SystemProperties.get("ro.bird_net_without_wcma").equals("1") ? NETWORK_MODE_LTE_GSM : SystemProperties.get("ro.bird_net_mode_3g_2g").equals("1") ? NETWORK_MODE_WCDMA_PREF : 
            (SystemProperties.get("ro.bird_net_mode_cus_style").equals("1") ? NETWORK_MODE_LTE_ONLY : (SystemProperties.get("ro.boot.opt_c2k_support").equals("1") ?
    ...
    //[BIRD][BIRD_NETWORK_WIRHOUT_WCDMA][网络模式去掉3G][chenguangxiang][20171221] END
    //[BIRD][BIRD_NET_MODE_3G_2G][首先网络默认选中3G/2G][yangheng][20170915] END
...
*/
    ...
    int RIL_REQUEST_IMS_ECT = (RIL_REQUEST_VENDOR_BASE + 153);
    /// @}

    // M: VDF MMS over ePDG @{
    int RIL_REQUEST_SYNC_APN_TABLE_TO_RDS = (RIL_REQUEST_VENDOR_BASE + 154);
    /// @}

    int RIL_REQUEST_WIFI_CONNECT_IND = (RIL_REQUEST_VENDOR_BASE + 155);
    ...
    /// M: IMS ECC SUPPORT @{
    int RIL_UNSOL_IMS_SUPPORT_ECC = (RIL_UNSOL_VENDOR_BASE + 104);
    /// @}
}
