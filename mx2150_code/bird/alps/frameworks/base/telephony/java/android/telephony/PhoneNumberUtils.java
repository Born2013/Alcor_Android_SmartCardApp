...
public class PhoneNumberUtils
{
    ...
    public static class EccEntry {
        ...
        //[BIRD][BIRD_ADD_ECC_HAS_SIM][增加插卡时紧急号码][qianliliang][20160723] BEGIN
        public static final String ECC_HAS_SIM = "3";
        //[BIRD][BIRD_ADD_ECC_HAS_SIM][增加插卡时紧急号码][qianliliang][20160723] END

        private String mEcc;
        private String mCategory;
        //[BIRD][BIRD_ADD_ECC_HAS_SIM][增加插卡时紧急号码][qianliliang][20160723] BEGIN
        private String mCondition; // ECC_NO_SIM, ECC_ALWAYS, or ECC_FOR_MMI, ECC_HAS_SIM
        //[BIRD][BIRD_ADD_ECC_HAS_SIM][增加插卡时紧急号码][qianliliang][20160723] END
    ...
    /*[BIRD][BIRD_CUSTOM_NUMBER_MIN_MATCH][自定义号码匹配长度][yangbo][20160127]BEGIN */
    private static final int BIRD_CUSTOM_NUMBER_MIN_MATCH = SystemProperties.getInt("ro.bird_num_min_match", 0);
    private static boolean sIsBirdCustomMinMatchSupport = false;
    static {
        if (BIRD_CUSTOM_NUMBER_MIN_MATCH == 0) {
            sIsBirdCustomMinMatchSupport = false;
        } else {
            sIsBirdCustomMinMatchSupport = true;
        }
    }
    /*[BIRD][BIRD_CUSTOM_NUMBER_MIN_MATCH][自定义号码匹配长度][yangbo][20160127]END */

	//[BIRD][BIRD_REMOVE_CTA_EMMERGENCE_NUMBER][删除CTA模式下的一些紧急号码][pangmeizhou][20160624]begin
	private static final boolean BIRD_REMOVE_CTA_EMMERGENCE_NUMBER = "1".equals(SystemProperties.get("ro.bd_rm_cta_ecc_num"));
	//[BIRD][BIRD_REMOVE_CTA_EMMERGENCE_NUMBER][删除CTA模式下的一些紧急号码][pangmeizhou][20160624]end
    //[BIRD][BIRD_ADD_ECC_HAS_SIM][增加插卡时紧急号码][qianliliang][20160723] BEGIN
    private static final boolean BIRD_ADD_ECC_HAS_SIM = "1".equals(SystemProperties.get("ro.bd_add_ecc_has_sim"));
    //[BIRD][BIRD_ADD_ECC_HAS_SIM][增加插卡时紧急号码][qianliliang][20160723] END
    static {
    ...
    compareLoosely(String a, String b) {
        ...
        /*[BIRD][BIRD_CUSTOM_NUMBER_MIN_MATCH][自定义号码匹配长度][yangbo][20160127]BEGIN */
            ...
            if (sIsBirdCustomMinMatchSupport) {
                minMatchLen = BIRD_CUSTOM_NUMBER_MIN_MATCH;
            } else {
                if (sPhoneNumberExt != null) {
    ...
    */
     ...
     * @hide
     */
    public synchronized static boolean isEmergencyNumberExtBySubId(String number,
            int phoneType, int subId) {
        if (DBG) {
        ...
        //[BIRD][BIRD_REMOVE_ALL_ECC_NUM][删除所有的紧急号码,包括插卡和不插卡情况下的][pangmeizhou][20161009]begin
        if("1".equals(SystemProperties.get("ro.bd_rm_all_ecc_num"))) {
            return false;
        }
        //[BIRD][BIRD_REMOVE_ALL_ECC_NUM][删除所有的紧急号码,包括插卡和不插卡情况下的][pangmeizhou][20161009]end
                    ...
                    for (EccEntry eccEntry : sCdmaCustomizedEccList) {
                        ...
                        if (BIRD_ADD_ECC_HAS_SIM) {
                            ...
                            if (ecc.equals(number)
                                ...
                                if (eccEntry.getCondition().equals(EccEntry.ECC_HAS_SIM)) {
                                    return false;
                                } else {
                                    return true;
                                }
     ...
     * @hide
     */
    public synchronized static void setSpecificEccCategory(int eccCat) {
    ...
    private synchronized static void addRemoveCtaEccSet() {
        ...
        //[BIRD][BIRD_REMOVE_CTA_EMMERGENCE_NUMBER][删除CTA模式下的一些紧急号码][pangmeizhou][20160624]begin
        if (needCheck && !BIRD_REMOVE_CTA_EMMERGENCE_NUMBER) {
        //[BIRD][BIRD_REMOVE_CTA_EMMERGENCE_NUMBER][删除CTA模式下的一些紧急号码][pangmeizhou][20160624]end
