...
public class TelephonyManager {
    ...
    public static String getNetworkTypeName(int type) {
        switch (type) {
            ...
            case NETWORK_TYPE_UMTS:
                return "UMTS";
            case NETWORK_TYPE_HSDPA:
                //[BIRD][BIRD_SIM_CELLULAR_NETWORK_TYPE][关于手机-sim卡状态下 网络类型修改][chenguangxiang][20171026]begin
                if (SystemProperties.get("ro.bd_sim_cellular_network").equals("1")) {
                    return "H";
                } else {
                    return "HSDPA";
                }
                //[BIRD][BIRD_SIM_CELLULAR_NETWORK_TYPE][关于手机-sim卡状态下 网络类型修改][chenguangxiang][20171026]end
            case NETWORK_TYPE_HSUPA:
                return "HSUPA";
            case NETWORK_TYPE_HSPA:
                //[BIRD][BIRD_SIM_CELLULAR_NETWORK_TYPE][关于手机-sim卡状态下 网络类型修改][chenguangxiang][20171026]begin
    ...
    */
    ...
    public void setDataEnabled(int subId, boolean enable) {
        ...
        //[BIRD][BIRD_SIM_TWO_DATA_CONNECTION_DISABLED][禁止卡2使用数据连接][chenguangxiang][20180126] begin
        if (SystemProperties.get("ro.bd_sim_data_connect_dis").equals("1")) {
            int PhoneId = SubscriptionManager.getPhoneId(subId);
            if (PhoneId == 1) {
                enable = false;
            }
        }
        //[BIRD][BIRD_SIM_TWO_DATA_CONNECTION_DISABLED][禁止卡2使用数据连接][chenguangxiang][20180126] end
        try {
    ...
    */
    ...
    //[BIRD_SMT_SW][贴片软件 写barcode接口][dengyang][20160310]
    public void invokeOemRilRequestString(String[] at, int cmdtype) {
        try { 
            Log.d("TelephonyManager", "invokeOemRilRequestString ");
            getITelephony().invokeOemRilRequestString(at, cmdtype);
        } catch (RemoteException ex) {
            Log.d("TelephonyManager", "RemoteException ");
            return ;
        } catch (NullPointerException ex) {
            Log.d("TelephonyManager", "NullPointerException ");
            return ;
        }
    }
    //[BIRD_SMT_SW][贴片软件 写barcode接口][dengyang][20160310]
