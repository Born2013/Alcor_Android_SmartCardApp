...
public abstract class PreferenceDialogFragment extends DialogFragment implements
    ...
    //[BIRD][BIRD_OLD_PHONE][老人机][songwei][20170805]BEGIN
    public static boolean isOld = false;
    public void setIsOldMode(boolean old) {
        isOld = old;
    }
    //[BIRD][BIRD_OLD_PHONE][老人机][songwei][20170805]END
    ...
    Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        //[BIRD][BIRD_OLD_PHONE][老人机][songwei][20170805]
        final AlertDialog.Builder builder = new AlertDialog.Builder(context, isOld ? 6 : 0)
