...
#ifdef CONFIG_BIRD_WALKIE_TALKIES_AM2120U_SUPPORT
extern int am2120u_wt_is_opening_flag;
#endif

//add by Crystal Shen(BIRD_C) 20170614
#ifdef CONFIG_BIRD_AW87319_SPEAKER_PA_SUPPORT
...
#ifdef CONFIG_MTK_SPEAKER
#ifdef CONFIG_MTK_SPEAKER_USE_CLASSD
...
#define SPK_WARM_UP_TIME        (25)	/* unit is ms */
	...
	if (enable) {
...
#else
#if 0 //modify by Crystal Shen(BIRD_C) 20160327
		AudDrv_GPIO_EXTAMP_Select(false);
#else
	#if defined(CONFIG_BIRD_EXT_SPEAKER_AMP_SINGLE_PULSE)	// [add by Sky for big speaker with one pulse 2016-04-28]
		AudDrv_GPIO_EXTAMP_Select(false);
		mdelay(10);
		AudDrv_GPIO_EXTAMP_Select(true);
		udelay(2);
	#elif defined(CONFIG_BIRD_EXT_SPEAKER_AMP_TWO_PULSE)
		AudDrv_GPIO_EXTAMP_Select(false);
		mdelay(10);
		AudDrv_GPIO_EXTAMP_Select(true);
		udelay(2);
		...
		AudDrv_GPIO_EXTAMP_Select(true);
		udelay(2);
	#elif defined(CONFIG_BIRD_EXT_SPEAKER_AMP_FIVE_PULSE)
		AudDrv_GPIO_EXTAMP_Select(false);
		mdelay(10);
		AudDrv_GPIO_EXTAMP_Select(true);
		udelay(2);
...
#endif
		//AudDrv_GPIO_EXTAMP2_Select(false);//modify by Crystal Shen(BIRD_C) 20160327
...
#else
#ifdef CONFIG_BIRD_WALKIE_TALKIES_AM2120U_SUPPORT
if(1==am2120u_wt_is_opening_flag){
		//AudDrv_GPIO_EXTAMP_Select(false);
		//mdelay(10);//add by Crystal Shen(BIRD_C) 20160327
		//AudDrv_GPIO_EXTAMP2_Select(false);
		//mdelay(10);//add by Crystal Shen(BIRD_C) 20160623
}
else{
		AudDrv_GPIO_EXTAMP_Select(false);
		mdelay(10);
