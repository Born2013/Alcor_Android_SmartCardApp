...
#ifdef CONFIG_BIRD_MTK_FM_SHORT_ANTENNA_SUPPORT //Crystal Shen for FM EXT
#include <linux/gpio.h>
#ifdef CONFIG_BIRD_MTK_FM_SHORT_ANTENNA_SUPPORT_FOR_MX2150E
#define GPIO_FM_LNA_EN         121
#else
#define GPIO_FM_LNA_EN         124
#endif
...
#ifdef CONFIG_BIRD_MTK_FM_SHORT_ANTENNA_SUPPORT //Crystal Shen for FM EXT
	gpio_set_value(GPIO_FM_LNA_EN, 1);
	printk("--FM open, then GPIO_FM_LNA_EN set 1----\n");
#endif
...
#ifdef CONFIG_BIRD_MTK_FM_SHORT_ANTENNA_SUPPORT //Crystal Shen for FM EXT
	gpio_set_value(GPIO_FM_LNA_EN, 0);
	printk("--FM close, then GPIO_FM_LNA_EN set 0----\n");
#endif
	return 0;
}
