...
unsigned char AW87319_Audio_Speaker(void)
{
	...
	I2C_write_reg(0x06, 0x08);		// AGC3_Po  //default=0x03 0x08:1.73w@6ohm
...
static int AW87319_i2c_probe(struct i2c_client *client, const struct i2c_device_id *id)
{
	...
	AW87319_pa_client->addr = 0x59;//add by Crystal Shen(BIRD_C) 20170619 AD1=VDD18 AD2=GND DEFAULT=0X58
...
static const struct of_device_id extpa_of_match[] = {
	//{.compatible = "awinic,aw87319_i2c"},
	{.compatible = "mediatek,AW87319"},
	{},
};
#endif
