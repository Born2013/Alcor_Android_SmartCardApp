...
/*=============================================================*/
    ...
    int g_TpVirtualKey[] = {TOUCH_KEY_BACK, TOUCH_KEY_MENU, TOUCH_KEY_HOME, TOUCH_KEY_SEARCH};
#elif defined(VH2526B_YUYE_E5011)
    int g_TpVirtualKey[] = {TOUCH_KEY_MENU, TOUCH_KEY_BACK, TOUCH_KEY_HOME, TOUCH_KEY_SEARCH};
#elif defined(VH2531_HONGZHAN_L7P)
...
void DrvPlatformLyrTouchDeviceRegulatorPowerOn(bool nFlag)
{
    ...
    if (nFlag == true)
    {
    #if defined(CONFIG_TPD_POWER_VTP28_USE_VCAMA)
...
*/
    ...
    input_set_capability(g_InputDevice, EV_KEY, KEYCODE_DOUBLE_CLICK);
    input_set_capability(g_InputDevice, EV_KEY, KEYCODE_CTPUP);
    input_set_capability(g_InputDevice, EV_KEY, KEYCODE_CTPDOWN);
    input_set_capability(g_InputDevice, EV_KEY, KEYCODE_CTPLEFT);
    input_set_capability(g_InputDevice, EV_KEY, KEYCODE_CTPRIGHT);
    input_set_capability(g_InputDevice, EV_KEY, KEYCODE_CTPW);
    input_set_capability(g_InputDevice, EV_KEY, KEYCODE_CTPZ);
    input_set_capability(g_InputDevice, EV_KEY, KEYCODE_CTPV);
    input_set_capability(g_InputDevice, EV_KEY, KEYCODE_CTPO);
    input_set_capability(g_InputDevice, EV_KEY, KEYCODE_CTPM);
    input_set_capability(g_InputDevice, EV_KEY, KEYCODE_CTPC);
    input_set_capability(g_InputDevice, EV_KEY, KEYCODE_CTPE);
    input_set_capability(g_InputDevice, EV_KEY, KEYCODE_CTPS);
#endif //CONFIG_ENABLE_GESTURE_WAKEUP
...
*/
    ...
    input_set_capability(g_InputDevice, EV_KEY, KEYCODE_DOUBLE_CLICK);
    input_set_capability(g_InputDevice, EV_KEY, KEYCODE_CTPUP);
    input_set_capability(g_InputDevice, EV_KEY, KEYCODE_CTPDOWM);
    input_set_capability(g_InputDevice, EV_KEY, KEYCODE_CTPLEFT);
    input_set_capability(g_InputDevice, EV_KEY, KEYCODE_CTPRIGHT);
    input_set_capability(g_InputDevice, EV_KEY, KEYCODE_CTPW);
    input_set_capability(g_InputDevice, EV_KEY, KEYCODE_CTPZ);
