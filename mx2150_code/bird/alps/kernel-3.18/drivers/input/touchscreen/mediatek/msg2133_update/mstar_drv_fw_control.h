...
#elif defined(MX2135F_E5017)
typedef enum {
    MSG22XX_SW_ID_XXXX = 0x0058,
    MSG22XX_SW_ID_YYYY = 0x0059,  
    MSG22XX_SW_ID_UNDEFINED = 0xFFFF
} Msg22xxSwId_e;
...
typedef enum {
    MSG22XX_SW_ID_XXXX = 0x0051,
    MSG22XX_SW_ID_YYYY = 0x0038,
    MSG22XX_SW_ID_ZZZZ = 0x002F,
    MSG22XX_SW_ID_UNDEFINED = 0xFFFF
} Msg22xxSwId_e;
#else
typedef enum {
