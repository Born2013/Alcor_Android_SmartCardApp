...
#if defined(VH2522_YUYE_E4008)
    #include "vh2522_yuye_msg22xx_xxxx_update_bin.h" // for MSG22xx
    #include "vh2522_yuye_msg22xx_yyyy_update_bin.h"
#elif defined(VH2526B_YUYE_E5011)
    #include "vh2526b_yuye_e5011_0x0002_msg22xx_xxxx_update_bin.h" // for MSG22xx
    #include "vh2526b_yuye_e5011_0x0003_msg22xx_yyyy_update_bin.h"
#elif defined(MX1091F_F511)
    #include "msg22xx_xxxx_update_bin_mx1091e_aw_f511_hx_0x338_v008.h" // for MSG22xx
    #include "msg22xx_yyyy_update_bin_mx1091e_aw_f511_hx_0x339_v008.h"
#elif defined(VH2526B_YUYE_E4506)
    #include "vh2526c_yuye_e4506_0x0001_msg22xx_xxxx_update_bin.h" // for MSG22xx
    #include "vh2526c_yuye_e4506_0x0002_msg22xx_yyyy_update_bin.h"
#elif defined(VH2521C_HONGZHAN_X5S)
    #include "vh2521c_hongzhan_x5s_0x0001_msg22xx_xxxx_update_bin.h" // for MSG22xx
    #include "vh2521c_hongzhan_x5s_0x0002_msg22xx_yyyy_update_bin.h"
#elif defined(MX2131F_SZBD_I589)
    #include "msg22xx_xxxx_update_bins_mx2131f_i589.h" // for MSG22xx
    #include "msg22xx_yyyy_update_bin.h"
#elif defined(MX2131F_S45261)
    #include "mx2131f_s45261_msg22xx_xxxx_update_bin.h" // for MSG22xx HELITAI
    #include "mx2131f_s45261_msg22xx_yyyy_update_bin.h" //YIXING
#elif defined(MX2521E_SOP_N1_HD)
    #include "mx2521e_sop_n1_hd_0x0051_msg22xx_xxxx_update_bin.h" //hongfazhan
    #include "mx2521e_sop_n1_hd_0x0038_msg22xx_yyyy_update_bin.h" //hongzhan
#else
...
#if defined(VH2531_HONGZHAN_L7P)
    #include "vh2531_hongzhan_l7p_0x338_msg28xx_xxxx_update_bin.h" // for MSG28xx
    #include "vh2531_hongzhan_l7p_0x339_msg28xx_yyyy_update_bin.h"
#elif defined(MX2120E_ARES_A5508)
	#include "msg28xx_xxxx_update_bin_mx2120e_ares_a5508_hz_0x338_000b.h"
	#include "msg28xx_yyyy_update_bin_mx2120e_ares_a5508_release.h"
#else
...
static s32 _DrvFwCtrlSelfParsePacket(u8 *pPacket, u16 nLength, SelfTouchInfo_t *pInfo) // for MSG21xxA/MSG22xx
{
    ...
    if (g_GestureWakeupFlag == 1)
    {
        ...
        if (bIsCorrectFormat) 
        {
            ...
            {
                case 0x58:
					 //liangjiaqiang modify for DOUBLE_CLICK gesture wakeup don't Light up screen
                    ...
                    input_report_key(g_InputDevice, KEYCODE_DOUBLE_CLICK, 1);
                    input_sync(g_InputDevice);
                    input_report_key(g_InputDevice, KEYCODE_DOUBLE_CLICK, 0);
                    input_sync(g_InputDevice);
                    break;		
#if 1
                case 0x60:
                    ...
                    input_report_key(g_InputDevice, KEYCODE_CTPUP, 1);
                    input_sync(g_InputDevice);
                    input_report_key(g_InputDevice, KEYCODE_CTPUP, 0);
                    input_sync(g_InputDevice);
                    break;		
                case 0x61:
                    ...
                    input_report_key(g_InputDevice, KEYCODE_CTPDOWM, 1);
                    input_sync(g_InputDevice);
                    input_report_key(g_InputDevice, KEYCODE_CTPDOWM, 0);
                    input_sync(g_InputDevice);
                    break;		
                case 0x62:
                    ...
                    input_report_key(g_InputDevice, KEYCODE_CTPLEFT, 1);
                    input_sync(g_InputDevice);
                    input_report_key(g_InputDevice, KEYCODE_CTPLEFT, 0);
                    input_sync(g_InputDevice);
                    break;		
                case 0x63:
                    ...
                    input_report_key(g_InputDevice, KEYCODE_CTPRIGHT, 1);
                    input_sync(g_InputDevice);
                    input_report_key(g_InputDevice, KEYCODE_CTPRIGHT, 0);
                    input_sync(g_InputDevice);
                    break;	
#endif	
                case 0x64:
                    ...
                    input_report_key(g_InputDevice, KEYCODE_CTPM, 1);
                    input_sync(g_InputDevice);
                    input_report_key(g_InputDevice, KEYCODE_CTPM, 0);
                    input_sync(g_InputDevice);
                    break;		
                case 0x65:
                    ...
                    input_report_key(g_InputDevice, KEYCODE_CTPW, 1);
                    input_sync(g_InputDevice);
                    input_report_key(g_InputDevice, KEYCODE_CTPW, 0);
                    input_sync(g_InputDevice);
                    break;		
                case 0x66:
                    ...
                    input_report_key(g_InputDevice, KEYCODE_CTPC, 1);
                    input_sync(g_InputDevice);
                    input_report_key(g_InputDevice, KEYCODE_CTPC, 0);
                    input_sync(g_InputDevice);
                    break;
                case 0x67:
                    ...
                    input_report_key(g_InputDevice, KEYCODE_CTPE, 1);
                    input_sync(g_InputDevice);
                    input_report_key(g_InputDevice, KEYCODE_CTPE, 0);
                    input_sync(g_InputDevice);
                    break;
                case 0x68:
                    ...
                    input_report_key(g_InputDevice, KEYCODE_CTPV, 1);
                    input_sync(g_InputDevice);
                    input_report_key(g_InputDevice, KEYCODE_CTPV, 0);
                    input_sync(g_InputDevice);
                    break;
                case 0x69:
                    ...
                    input_report_key(g_InputDevice, KEYCODE_CTPO, 1);
                    input_sync(g_InputDevice);
                    input_report_key(g_InputDevice, KEYCODE_CTPO, 0);
                    input_sync(g_InputDevice);
                    break;
                case 0x6A:
		    ...
		    input_report_key(g_InputDevice, KEYCODE_CTPS, 1);
                    input_sync(g_InputDevice);
                    input_report_key(g_InputDevice, KEYCODE_CTPS, 0);
                    input_sync(g_InputDevice);
                    break;
                case 0x6B:
                    ...
                    input_report_key(g_InputDevice, KEYCODE_CTPZ, 1);
                    input_sync(g_InputDevice);
                    input_report_key(g_InputDevice, KEYCODE_CTPZ, 0);
                    input_sync(g_InputDevice);
                    break;
#if 0 //delete by liangjiaqiang					
                case 0x6C:
    ...
    if (0 == _DrvFwCtrlSelfParsePacket(pPacket, nReportPacketLength, &tInfo))
    {
        ...
        else //touch on screen
        {
            if (tInfo.nTouchKeyCode != 0)
            {
                ...
                if (tpd_dts_data.use_tpd_button)
                {
	#ifdef CONFIG_TPD_COMPATIBILITY_REPORT_KEY
		    if (tInfo.nTouchKeyCode == 4) // TOUCH_KEY_HOME
		    {
			nTouchKeyCode = g_TpVirtualKey[1];           
		    }
