...
#if defined(MX2117_ARES_A4519)
	#include "KLL_ARES_A4519_FT6336U_Ver0x01_20160408_app.i"
#elif defined(MX1091G_HBBD_L6D)
	#include "L6D-BD_FT6436_4Col_V0x04_20160523_app.i"
#elif defined(BIRD_TPD_AUTO_UPGRADE_MX2109F_HBBD_L7P)
	#include "FT3327_BD-L7P_0X82_55067__V03_D01_20151228_app.i"
#elif defined(BIRD_TPD_AUTO_UPGRADE_MX2109F_HBBD_L7P)
	#include "FT34x7_JT_SHINING8_98-83050-6390B_V01_D07_20160309_app.i"
#elif defined(FT6406_V01)
	#include "FT6406_V01_20140426_app.i"
#elif defined(MX2131F_HBBD_I589)
	#include "MX2131F_HBBD_I589_app.i"	
#else
	#include "L6D-BD_FT6436_4Col_V0x04_20160523_app.i"
#endif
};
 ...
 struct fts_Upgrade_Info fts_updateinfo[] =
{
	...
	#if defined(MX1091G_HBBD_L6D)
        {0x00,FTS_MAX_POINTS_2,AUTO_CLB_NONEED,10, 10, 0x79, 0x18, 10, 2000}, //,"FT6x36" upgrade fail chip_id = 0x00;  
	#endif
...
int fts_ctpm_get_i_file_ver(void)
{
	...
	{
		#if defined(MX1091G_HBBD_L6D)
	    if(fts_updateinfo_curr.CHIP_ID==0x36 ||fts_updateinfo_curr.CHIP_ID==0x00 || fts_updateinfo_curr.CHIP_ID==0x86  || fts_updateinfo_curr.CHIP_ID==0x64)
		#else
...
int fts_ctpm_fw_upgrade_with_i_file(struct i2c_client *client)
{
	...
	*/
	...
	#if defined(MX1091G_HBBD_L6D)
	else if ((fts_updateinfo_curr.CHIP_ID==0x36)||(fts_updateinfo_curr.CHIP_ID==0x00))
	#else
	else if ((fts_updateinfo_curr.CHIP_ID==0x36))
	#endif
	{
