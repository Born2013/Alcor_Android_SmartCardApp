...
/* add for wakeup hung bug on: Sat, 23 Apr 2016 14:09:12 +0800
 */
...
s32 gesture_event_handler(struct input_dev * dev)
{
	...
	mutex_unlock(&gesture_data_mutex);
        ...
        switch (doze_buf[0]){
            ...
            case 0x63:
                key_code = KEYCODE_CTPC;
                break;
            case 0x65:
                key_code = KEYCODE_CTPE;
                break;
            case 0x6F:
                key_code = KEYCODE_CTPO;
                break;
            case 0x73:
                key_code = KEYCODE_CTPS;
                break;
            case 0x7A:
                key_code = KEYCODE_CTPZ;
                break;
            case 0x77:
                key_code = KEYCODE_CTPW;
                break;
            case 0x6D:
                key_code = KEYCODE_CTPM;
                break;
            case 0xCC:
                key_code =  KEYCODE_CTPUP;
                break;
/*
            case 0x76:
                key_code = KEY_V;
...
/* add by wakeup hung on: Sat, 23 Apr 2016 14:09:25 +0800
 */
...
/* add by wakeup hung on: Sat, 23 Apr 2016 14:09:49 +0800
 */
    msleep(200);
// End
