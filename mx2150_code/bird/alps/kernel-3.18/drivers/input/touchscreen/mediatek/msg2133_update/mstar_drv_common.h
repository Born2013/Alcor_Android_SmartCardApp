 ...
 * By default, this compile option is disabled.
 */
#if defined(BIRD_GESTURE_WAKEUP)
...
#if defined(BIRD_FIRMWARE_MSG21XXA)
	#define CONFIG_ENABLE_CHIP_TYPE_MSG21XXA
#elif defined(BIRD_FIRMWARE_MSG22XX)
	#define CONFIG_ENABLE_CHIP_TYPE_MSG22XX
#elif defined(BIRD_FIRMWARE_MSG26XXM)
	#define CONFIG_ENABLE_CHIP_TYPE_MSG26XXM
#elif defined(BIRD_FIRMWARE_MSG28XX)
 ...
 * Open this, please open BIRD_FIRMWARE_MSG21XXA or BIRD_FIRMWARE_MSG22XX or BIRD_FIRMWARE_MSG26XXM or BIRD_FIRMWARE_MSG28XX.
 * By default, this compile option is disabled.
 */
 ...
 * By default, this compile option is enabled.
 */
#ifdef MSG22XX_UP_FW_BY_ONE_ARRAY
