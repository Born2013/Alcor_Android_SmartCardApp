...
//BIRD BEGIN
	...
	{1, AFDRV_OV5695AF, OV5695AF_SetI2Cclient, OV5695AF_Ioctl, OV5695AF_Release},
	#endif
	#ifdef CONFIG_MTK_LENS_OV8856AF_SUPPORT
	{1, AFDRV_OV8856AF, OV8856AF_SetI2Cclient, OV8856AF_Ioctl, OV8856AF_Release},
	#endif
	...
	{1, AFDRV_OV5647AF, OV5647AF_SetI2Cclient, OV5647AF_Ioctl, OV5647AF_Release},
	#endif
		#ifdef CONFIG_MTK_LENS_OV5647AAF_SUPPORT
	{1, AFDRV_OV5647AAF, OV5647AAF_SetI2Cclient, OV5647AAF_Ioctl, OV5647AAF_Release},
	#endif

#ifdef CONFIG_MTK_LENS_GC8034AF_SUPPORT
	{1, AFDRV_GC8034AF, GC8034AF_SetI2Cclient, GC8034AF_Ioctl, GC8034AF_Release},
#endif
	...
	{1, AFDRV_GC5025AF, GC5025AF_SetI2Cclient, GC5025AF_Ioctl, GC5025AF_Release},
#endif
	...
	{1, AFDRV_S5K5E2YAAF, S5K5E2YAAF_SetI2Cclient, S5K5E2YAAF_Ioctl, S5K5E2YAAF_Release},
#endif

#ifdef CONFIG_MTK_LENS_S5K3M2AF_SUPPORT
	{1, AFDRV_S5K3M2AF, S5K3M2AF_SetI2Cclient, S5K3M2AF_Ioctl, S5K3M2AF_Release},
#endif

	#ifdef CONFIG_MTK_LENS_BF2507AF_SUPPORT
	{1, AFDRV_BF2507AF, BF2507AF_SetI2Cclient, BF2507AF_Ioctl, BF2507AF_Release},
	#endif

	#ifdef CONFIG_MTK_LENS_AR0543AF_SUPPORT
	{1, AFDRV_AR0543AF, AR0543AF_SetI2Cclient, AR0543AF_Ioctl, AR0543AF_Release},
	#endif
