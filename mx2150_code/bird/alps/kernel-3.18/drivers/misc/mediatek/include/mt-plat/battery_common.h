...
#ifdef CONFIG_BIRD_SYSTEM_OFF_VOLTAGE_3400
#define SYSTEM_OFF_VOLTAGE                  (3400) //modify by Crystal Shen(BIRD_C) 20160106 //3400
#else
#define SYSTEM_OFF_VOLTAGE                  (3250) //modify by Crystal Shen(BIRD_C) 20160106 //3400
#endif
