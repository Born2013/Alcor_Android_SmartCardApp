...
//    memcpy(cali_sensor_data, buf, sizeof(cali_sensor_data));
	...
	cali_sensor_xdata = buf[0];
	cali_sensor_ydata = buf[1];
...
#if 0
int mxc400_gsensor_operate(void* self, uint32_t command, void* buff_in, int size_in,
...
static int mxc400x_i2c_probe(struct i2c_client *client, const struct i2c_device_id *id)
{
	...
	struct acc_data_path data={0};
	 ...
	 obj_i2c_data = obj;
	 obj->client = client;
	 obj->client->addr = 0x15;//add by Crystal Shen(BIRD_C) 20160414 15
