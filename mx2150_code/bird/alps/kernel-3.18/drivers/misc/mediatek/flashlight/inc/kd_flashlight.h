...
/*add litianfeng   begin 170210*/
#define FLASH_IOC_SET_ON_FILLLIGHT    _IOR(FLASHLIGHT_MAGIC, 210, int)
#define FLASH_IOC_SET_OFF_FILLLIGHT   _IOR(FLASHLIGHT_MAGIC, 215, int)
/*add litianfeng   end 170210*/
