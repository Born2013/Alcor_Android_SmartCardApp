...
static unsigned int charging_hw_init(void *data)
{
	...
	bq24296_set_vindpm(0x6); 	//VIN DPM check 4.68V /*0XA-->0X6 modify by liangjiaqiang*/
	...
	bq24296_set_en_term(0x0);	/* Enable termination */ /*0x1,modified by Michael YU BIRD_C 20170111*/
...
static unsigned int charging_set_cv_voltage(void *data)
{
	...
	if (batt_cust_data.high_battery_voltage_support) {
		if (cv_value >= BATTERY_VOLT_04_300000_V)
			cv_value = 4352000;    /*4304000; modified by Michael YU BIRD_C 20170111 */ 
	}
