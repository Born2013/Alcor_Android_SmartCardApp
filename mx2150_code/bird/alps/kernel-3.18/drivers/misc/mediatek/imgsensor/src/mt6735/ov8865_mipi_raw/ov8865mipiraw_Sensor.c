...
static imgsensor_info_struct imgsensor_info = { 
	...
	.cap = {//30fps 74.4M bps/lane
		.pclk = 74400000,//this value just for calculate shutter 2lane 74400000  4laen148800000
...
static void sensor_init(void)
{
	...
	//write_cmos_sensor(0x030d,0x1f);// ; PLL	  ;1e   4lane 1f  2lane no
	...
	write_cmos_sensor(0x3018,0x32);// ; MIPI 4 lane 72   2lane 32
	...
	write_cmos_sensor(0x3106,0x21);// ; PLL 4 lane 01   2 lane  21
...
static void preview_setting(void)
{
	...
	write_cmos_sensor(0x030f,0x09);//; PLL
	write_cmos_sensor(0x3018,0x32);// 4lane 72    2lane 32
	write_cmos_sensor(0x3106,0x21);// 4lane 01   2lane 21
