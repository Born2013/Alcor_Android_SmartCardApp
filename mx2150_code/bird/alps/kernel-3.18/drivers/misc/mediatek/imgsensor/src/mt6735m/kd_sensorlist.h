...
UINT32 GS5604_YUV_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc);
...
UINT32 GC032A_YUV_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc);
...
/*OV (OmniVision)*/
    ...
    {OV5647A_MIPI_SENSOR_ID, SENSOR_DRVNAME_OV5647A_MIPI_RAW, OV5647A_MIPISensorInit},
#endif
...
/*GC*/
...
#endif
#if defined(GS5604_YUV)
    {GS5604_SENSOR_ID, SENSOR_DRVNAME_GS5604_YUV, GS5604_YUV_SensorInit},
#endif
#if defined(GC2385MIPI_RAW)
    {GC2385MIPI_SENSOR_ID, SENSOR_DRVNAME_GC2385MIPI_RAW,GC2385MIPI_RAW_SensorInit},
#endif
#if defined(GC2375MIPI_RAW)
    ...
    {GC2365SUBMIPI_SENSOR_ID, SENSOR_DRVNAME_GC2365SUB_MIPI_RAW,GC2365SUBMIPI_RAW_SensorInit},
#endif
    ...
    {GC2355DVP_SENSOR_ID, SENSOR_DRVNAME_GC2355DVP_RAW,GC2355_RAW_SensorInit},
#endif
...
#endif
#if defined(GC0311M_YUV)
    {GC0311M_SENSOR_ID, SENSOR_DRVNAME_GC0311M_YUV, GC0311M_YUV_SensorInit},
#endif
...
#endif
#if defined(GC032A_YUV)
    {GC032A_SENSOR_ID, SENSOR_DRVNAME_GC032A_YUV,GC032A_YUV_SensorInit},
#endif
...
/*SP*/
    ...
    {SP5409_SENSOR_ID, SENSOR_DRVNAME_SP5409_MIPI_RAW, SP5409MIPISensorInit},
#endif
