...
#define GC0311_TEST_PATTERN_CHECKSUM 0x4e908d1c
...
static void GC0311_write_cmos_sensor(kal_uint8 addr, kal_uint8 para)
{
	...
	else 
	{
		...
		if(GC0311_MPEG4_encode_mode == KAL_TRUE)
			...
			GC0311_write_cmos_sensor(0x33, 0x20);
           	       GC0311_write_cmos_sensor(0xfe, 0x00);
			GC0311GammaSelect(GC0311_RGB_Gamma_m6);				   
...
void GC0311_Sensor_Init(void)
{
	...
	GC0311_write_cmos_sensor(0x2b, 0x04);   //exp level 0  14.28fps
	GC0311_write_cmos_sensor(0x2c, 0xe0); 
	GC0311_write_cmos_sensor(0x2d, 0x05);   //exp level 1  12.50fps
	GC0311_write_cmos_sensor(0x2e, 0x40); 
	GC0311_write_cmos_sensor(0x2f, 0x06);   //exp level 2  10.00fps
	GC0311_write_cmos_sensor(0x30, 0x00); 
 ...
 /////////////////20120703//////////////////////////
  ...
  /////////////////20120703//////////////////////////						  
	...
	GC0311_write_cmos_sensor(0x82, 0x1f);//30
	GC0311_write_cmos_sensor(0x84, 0x03);
	...
	GC0311_write_cmos_sensor(0x95, 0x56);//64
	...
	/////////////YCP//////////////
	////////////////////////////
	GC0311_write_cmos_sensor(0xd1, 0x2c);//36
	GC0311_write_cmos_sensor(0xd2, 0x2c);
	...
	GC0311_write_cmos_sensor(0x12, 0x14);//14
	GC0311_write_cmos_sensor(0x13, 0x4d);//40 //0x58
	...
	GC0311_write_cmos_sensor(0x53, 0x02);
	GC0311_write_cmos_sensor(0x54, 0x0f);
	GC0311_write_cmos_sensor(0x55, 0x20);
	GC0311_write_cmos_sensor(0x56, 0x16);
	GC0311_write_cmos_sensor(0x57, 0x10);
	GC0311_write_cmos_sensor(0x58, 0xf9);
	GC0311_write_cmos_sensor(0x59, 0x09);
	...
	GC0311_write_cmos_sensor(0x60, 0x19);
	GC0311_write_cmos_sensor(0x61, 0xe7);
	...
	GC0311_write_cmos_sensor(0x6f, 0x0a);
	...
	GC0311_write_cmos_sensor(0x74, 0x03);//23 121018
...
////////////////20120613 start//////////////////////////
	...
	GC0311_write_cmos_sensor(0xd1, 0x20);//2d
	GC0311_write_cmos_sensor(0xd2, 0x20);

	///YUV maxtrix////
	GC0311_write_cmos_sensor(0xb0, 0x0a);//13
			...
			MSDK_SENSOR_CONFIG_STRUCT *pSensorConfigData)
{
	...
	// GC0311Capture(pImageWindow, pSensorConfigData);
		...
		break;
	default:
            SENSORDB("GC0311Control Error ScenarioId setting\n");
...
BOOL GC0311_set_param_banding(UINT16 para)
{
	switch (para)
	{
		case AE_FLICKER_MODE_50HZ:
			...
			GC0311_write_cmos_sensor(0x2f, 0x06);   //exp level 2  10.00fps
			GC0311_write_cmos_sensor(0x30, 0x00); 
			GC0311_write_cmos_sensor(0x31, 0x07);   //exp level 3  7.14fps
			GC0311_write_cmos_sensor(0x32, 0x80); 
			GC0311_SET_PAGE0;
			break;
...
BOOL GC0311_set_param_exposure(UINT16 para)
{
	...
	switch (para)
	{
		...
		case AE_EV_COMP_03:
			GC0311_write_cmos_sensor(0x42, REG42);
			GC0311_write_cmos_sensor(0xd5, 0x15);
		break;
		...
		case AE_EV_COMP_10:
			GC0311_write_cmos_sensor(0x42, REG42);
			GC0311_write_cmos_sensor(0xd5, 0x25);
		break;
...
UINT32 GC0311YUVSensorSetting(FEATURE_ID iCmd, UINT16 iPara)
{
		...
		printk("______%s______GC0311 YUV setting\n",__func__);
		return TRUE;
#endif
...
static void GC0311FlashTriggerCheck(unsigned int *pFeatureReturnPara32) 
{ 
	unsigned int dg_pre,dg_post; 
	
	GC0311_write_cmos_sensor(0xfe,0x00); 
	dg_pre = GC0311_read_cmos_sensor(0x71);
	dg_post = GC0311_read_cmos_sensor(0x72);
...
UINT32 GC0311SetTestPatternMode(kal_bool bEnable)
{
	...
	{			
		...
		GC0311_write_cmos_sensor(0x4c, 0x01);
	}
	else
	{
		GC0311_write_cmos_sensor(0xfe, 0x00); 	
		GC0311_write_cmos_sensor(0x4c, 0x00); //test pattern  	
	}
	return ERROR_NONE;
}
...
//    UINT32 i;
    ...
    case SENSOR_FEATURE_GET_TRIGGER_FLASHLIGHT_INFO: 
	 GC0311FlashTriggerCheck(pFeatureData32); 
	 break;
