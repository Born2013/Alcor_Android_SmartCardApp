...
#else
#define CAMERA_CMRST_PIN            80
#define CAMERA_CMRST_PIN_M_GPIO     80

#define CAMERA_CMPDN_PIN            7
#define CAMERA_CMPDN_PIN_M_GPIO     7

/* FRONT sensor */
#define CAMERA_CMRST1_PIN           11
#define CAMERA_CMRST1_PIN_M_GPIO    11

#define CAMERA_CMPDN1_PIN           12
#define CAMERA_CMPDN1_PIN_M_GPIO    12
