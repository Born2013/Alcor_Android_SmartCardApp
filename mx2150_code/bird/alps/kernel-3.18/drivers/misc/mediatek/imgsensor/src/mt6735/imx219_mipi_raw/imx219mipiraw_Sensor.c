...
static void preview_setting(void)
{
 ...
 //write_cmos_sensor(0x0172,  0x00);//add for 2lane
	...
	write_cmos_sensor(0x0307,  0x2B);  ////2b 4lane //36 2lane 
	write_cmos_sensor(0x0309,  0x0A);   
	write_cmos_sensor(0x030B,  0x01);   
	write_cmos_sensor(0x030C,  0x00);   
	write_cmos_sensor(0x030D,  0x2E);  //2e 4lane //6c 2lane 
...
// write_cmos_sensor(0x0172,   0x00); //add for 2lane
		...
		write_cmos_sensor(0x0100,	0x00); 
		  ...
		  write_cmos_sensor(0x0305,   0x03); 
		  write_cmos_sensor(0x0306,   0x00); 
		  write_cmos_sensor(0x0307,   0x53); //53 4lane //36 2lane
		  write_cmos_sensor(0x0309,   0x0A); 
		  write_cmos_sensor(0x030B,   0x01); 
		  write_cmos_sensor(0x030C,   0x00); 
		  write_cmos_sensor(0x030D,   0x56);//56 4lane //6c 2lane 
		  write_cmos_sensor(0x455E,   0x00); 
		  write_cmos_sensor(0x471E,   0x4B); 
		  write_cmos_sensor(0x4767,   0x0F); 
		  write_cmos_sensor(0x4750,   0x14); 
...
//write_cmos_sensor(0x0172,   0x00);//add for 2lane
		...
		write_cmos_sensor(0x0305,	0x03); 
		write_cmos_sensor(0x0306,	0x00); 
		write_cmos_sensor(0x0307,	0x57); //53 4lane //36 2lane
		write_cmos_sensor(0x0309,	0x0A); 
		write_cmos_sensor(0x030B,	0x01); 
		write_cmos_sensor(0x030C,	0x00); 
		write_cmos_sensor(0x030D,	0x5A); //56 4lane  //6c 2lane
		write_cmos_sensor(0x455E,	0x00); 
		write_cmos_sensor(0x471E,	0x4B); 
		write_cmos_sensor(0x4767,	0x0F); 
		write_cmos_sensor(0x4750,	0x14); 
...
static void slim_video_setting(void)
{
	...
	write_cmos_sensor(0x0305,   0x03); 
	write_cmos_sensor(0x0306,   0x00); 
	write_cmos_sensor(0x0307,   0x2B); //53 4lane //36 2lane
	write_cmos_sensor(0x0309,   0x0A); 
	write_cmos_sensor(0x030B,   0x01); 
	write_cmos_sensor(0x030C,   0x00); 
	write_cmos_sensor(0x030D,   0x2E);//0x54 //56 4lane //6c 2lane
	write_cmos_sensor(0x455E,   0x00); 
	write_cmos_sensor(0x471E,   0x4B); 
	write_cmos_sensor(0x4767,   0x0F); 
	write_cmos_sensor(0x4750,   0x14); 
