...
#include "bf2507mipi_Sensor.h"

/****************************Modify Following Strings for Debug****************************/
#define __SENSOR_WINDSZIE_INFO__
#define PFX "BF2507_camera_sensor"
#define LOG_1 printk( "BF2507,MIPI 2LANE\n")
...
static imgsensor_info_struct imgsensor_info = {
	.sensor_id = BF2507_SENSOR_ID,	//0xA507	//record sensor id defined in Kd_imgsensor.h
	...
	.sensor_output_dataformat	= SENSOR_OUTPUT_FORMAT_RAW_Gb,	//R B Gr Gbsensor output first pixel color
...
static void sensor_init(void)
{
	...
	mDELAY( 6 );
	...
	#ifdef _BF2507_INI_20140820 //Terra20141103-05 //Terra20140820-01
		#ifdef _SENSOR_INITIAL_FLIP
		...
		#endif
	#endif //_BF2507_INI_20140820
	////////////////////////////////////////////////////////////////////////////
	#ifdef _BF2507_INI_20140211
		#ifdef _SENSOR_INITIAL_FLIP
		write_cmos_sensor( 0x12, 0x73 );
		#else
		write_cmos_sensor( 0x12, 0x43 );
...
static void sensor_5M_setting(kal_uint16 currefps)
{
	...
	#ifdef _BF2507_INI_20140820 //Terra20141103-05
		#ifdef _SENSOR_INITIAL_FLIP
...
static kal_uint32 set_test_pattern_mode(kal_bool enable)
{
	...
	if( enable ) {
		tmp = read_cmos_sensor( 0x0C ) | 0x01;//0x80
		...
		do {
			*sensor_id = return_sensor_id();
			if( *sensor_id == imgsensor_info.sensor_id ) {
				printk( "[BF2507] i2c_write_id=0x%x, sensor_id=0x%x\n", imgsensor.i2c_write_id, *sensor_id );
				printk( "<< get_imgsensor_id(): OK\n" );
				return ERROR_NONE;
			}
			printk( "[BF2507] Read sensor id fail, write_id=0x%x, sensor_id=0x%x\n", imgsensor.i2c_write_id, *sensor_id );
			retry--;
		} while( retry > 0 );
...
{
	{
	   (2624),(1956),
		...
		0,0,(1312),(978),
		//BF2507MIPI_PV_X_START,BF2507MIPI_PV_Y_START,BF2507MIPI_IMAGE_SENSOR_PV_WIDTH,BF2507MIPI_IMAGE_SENSOR_PV_HEIGHT
	},//Preview

	{
		...
		0,0,(2624),(1956),
		//BF2507MIPI_FULL_X_START,BF2507MIPI_FULL_Y_START,BF2507MIPI_IMAGE_SENSOR_FULL_WIDTH,BF2507MIPI_IMAGE_SENSOR_FULL_HEIGHT
	},//Capture
	{
		(2624),(1956),
		8,8,(3271),(2455),(1632),(1224),
		0,0,(1632),(1224),
		//BF2507MIPI_VIDEO_X_START,BF2507MIPI_VIDEO_Y_START,BF2507MIPI_IMAGE_SENSOR_VIDEO_WIDTH,BF2507MIPI_IMAGE_SENSOR_VIDEO_HEIGHT
	},//Video
	
	{
		...
		8,8,(3271),(2455),(1632),(1224),
		0,0,(1632),(1224),
		//BF2507MIPI_PV_X_START,BF2507MIPI_PV_Y_START,BF2507MIPI_IMAGE_SENSOR_PV_WIDTH,BF2507MIPI_IMAGE_SENSOR_VIDEO_HEIGHT
	},//High Speed Video
...
void BF2507MIPIGetCropInfo(unsigned long long *pFeaturePara)
#else
void BF2507MIPIGetCropInfo(unsigned long long *pFeaturePara)
#endif
{
	...
	WinInfo=(SENSOR_WINSIZE_INFO_STRUCT *)(uintptr_t)(*(pFeaturePara+1));
...
#ifdef __SENSOR_WINDSZIE_INFO__
#ifdef __64BIT_ARCH__
			BF2507MIPIGetCropInfo(feature_data);
#else	
			BF2507MIPIGetCropInfo(feature_data);
#endif
			break;
