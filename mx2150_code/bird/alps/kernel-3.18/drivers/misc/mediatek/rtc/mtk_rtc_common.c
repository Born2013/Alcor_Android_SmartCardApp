...
#include <mt_ccci_common.h> ///20171107 litianfeng   关机闪光灯闪一下 
...
#define RTC_DEFAULT_YEA		2018//[BIRD][系统默认日期配置][pangmeizhou][20161117]
...
void mt_power_off(void)
{
	...
	rtc_xinfo("mt_power_off\n");
        ...
        ccci_power_off();   ///20171107 litianfeng   关机闪光灯闪一下 
