...
static void lcm_get_params(LCM_PARAMS *params)
{
	...
	//	params->dsi.HS_TRAIL = 15;  //new add
		params->dsi.PLL_CLOCK = 208;//230;//240; //this value must be in MTK suggested table
...
LCM_DRIVER ili9806e_fwvga_ivo_vdo_yixinda_for_e5017_lcm_drv = 
{
    	.name			= "ili9806e_fwvga_ivo_vdo_yixinda_for_e5017",
