...
static void lcm_get_params(LCM_PARAMS *params)
{
	...
	params->height = FRAME_HEIGHT;
		...
		params->dsi.horizontal_backporch				= 110;//20;
...
LCM_DRIVER ili9881c_hd720_dsi_vdo_hsd_wss_mvg6001_mx2132e_ber_s6002_lcm_drv = 
{
    .name			= "ili9881c_hd720_dsi_vdo_hsd_wss_mvg6001_mx2132e_ber_s6002",
