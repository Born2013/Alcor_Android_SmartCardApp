...
static void lcm_get_params(LCM_PARAMS *params)
{
	...
	params->dsi.vertical_frontporch				= 22;//15
	params->dsi.vertical_active_line			= FRAME_HEIGHT;

	params->dsi.horizontal_sync_active			= 10;//10
	params->dsi.horizontal_backporch			= 85;//40;//30
	params->dsi.horizontal_frontporch			= 85;//30;//30
	params->dsi.horizontal_active_pixel			= FRAME_WIDTH;

	params->dsi.PLL_CLOCK = 195;//150//152;//155;//175;//200; //157//this value must be in MTK suggested table
/*
...
LCM_DRIVER st7701_fwvga_ctc_vdo_yxd_for_s45261_lcm_drv = 
{
    	.name			= "st7701_fwvga_ctc_vdo_yxd_for_s45261",
