...
{0x53,1,{0x90}},		//VCOM1
{0x55,1,{0xA2}},		//VCOM2
{0x50,1,{0xB7}},		//VREG1OUT=4.7V  
{0x51,1,{0xB7}},		//VREG2OUT=-4.7V  
...
static void lcm_get_params(LCM_PARAMS *params)
{
	...
	params->height = FRAME_HEIGHT;
		...
		params->dsi.horizontal_backporch				= 80;//120;//20;
		params->dsi.horizontal_frontporch				= 80;//100;//40;
...
{
#ifndef BUILD_LK
printk("crystal_ili9881c_hd720_dsi_vdo_ivo_yixinda_mx2135f_szbd_e5017\n");
#endif
lcm_init();
...
LCM_DRIVER ili9881c_hd720_dsi_vdo_hancai_meijing_mx2135f_szbd_e5017_lcm_drv = 
{
    .name			= "ili9881c_hd720_dsi_vdo_hancai_meijing_mx2135f_szbd_e5017",
