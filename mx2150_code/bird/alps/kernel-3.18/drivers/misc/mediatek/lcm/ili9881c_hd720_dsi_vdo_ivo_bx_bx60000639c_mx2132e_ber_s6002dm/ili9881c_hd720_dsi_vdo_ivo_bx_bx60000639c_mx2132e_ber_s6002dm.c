...
static void lcm_get_params(LCM_PARAMS *params)
{
	...
	params->height = FRAME_HEIGHT;
		...
		params->dsi.PLL_CLOCK = 220;//230; //this value must be in MTK suggested table
...
LCM_DRIVER ili9881c_hd720_dsi_vdo_ivo_bx_bx60000639c_mx2132e_ber_s6002dm_lcm_drv = 
{
    .name			= "ili9881c_hd720_dsi_vdo_ivo_bx_bx60000639c_mx2132e_ber_s6002dm",
