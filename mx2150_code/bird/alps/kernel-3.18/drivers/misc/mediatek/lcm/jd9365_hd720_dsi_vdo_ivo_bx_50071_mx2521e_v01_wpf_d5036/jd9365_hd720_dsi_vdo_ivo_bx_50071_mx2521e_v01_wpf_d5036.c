...
static void lcd_power_en(unsigned char enabled)
{
	if (enabled)
	{
		...
		//pmic_set_register_value(PMIC_RG_VCAMA_VOSEL,0x01); //for ctp 1151
	}	
	else
	{
...
{0xE2, 1, {0x65}},
{0xE3, 1, {0xF8}},
{0x80,1,{0x03}},//lane sel  02 三lane  03 四lane  01 两lane
...
LCM_DRIVER jd9365_hd720_dsi_vdo_ivo_bx_50071_mx2521e_v01_wpf_d5036_lcm_drv = 
{
        .name   	= "jd9365_hd720_dsi_vdo_ivo_bx_50071_mx2521e_v01_wpf_d5036",
