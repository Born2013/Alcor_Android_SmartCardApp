...
static void lcm_get_params(LCM_PARAMS *params)
{
	...
	params->dsi.PLL_CLOCK = 157;//200; //213//this value must be in MTK suggested table
...
LCM_DRIVER st7701_fwvga_hancai_vdo_yixinda_for_e5011_lcm_drv = 
{
    	.name			= "st7701_fwvga_hancai_vdo_yixinda_for_e5011",
