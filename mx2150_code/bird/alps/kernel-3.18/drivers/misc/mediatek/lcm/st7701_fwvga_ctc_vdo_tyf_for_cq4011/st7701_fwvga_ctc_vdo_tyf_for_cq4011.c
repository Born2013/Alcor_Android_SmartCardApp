...
#define REGFLAG_DELAY             							0XFDE
#define REGFLAG_END_OF_TABLE      							0xFEF   // END OF REGISTERS MARKER
...
/*St7701+CMI3.97TN-tianyifu-rober*/
{0xFF,5,{0x77,0x01,0x00,0x00,0x10}},
{0xC0,2,{0x63,0x00}},
{0xC1,2,{0x0D,0x02}},
{0xC2,2,{0x01,0x08}},
//{0xB0,16,{0x00,0x02,0x09,0x0E,0x15,0x0A,0x03,0x0A,0x09,0x18,0x06,0x11,0x0F,0x0C,0x0F,0x15}},
//{0xB1,16,{0x00,0x02,0x05,0x0D,0x12,0x08,0x00,0x08,0x09,0x1A,0x0A,0x1A,0x15,0x10,0x17,0x15}},
{0xB0,16,{0x00,0x07,0x0E,0x15,0x1E,0x0D,0x54,0x0A,0x08,0x66,0x07,0x14,0x10,0x14,0x18,0x18}},
{0xB1,16,{0x00,0x07,0x0F,0x11,0x16,0x0B,0x4F,0x08,0x09,0x65,0x07,0x15,0x13,0x19,0x1E,0x19}},
...
static void lcm_get_params(LCM_PARAMS *params)
{
	...
	params->dsi.PLL_CLOCK = 155;//150//152;//155;//175;//200; //157//this value must be in MTK suggested table
/*
    params->dsi.vertical_sync_active			= 2;//2
	params->dsi.vertical_backporch				= 14;//12
	params->dsi.vertical_frontporch				= 9;//15
...
LCM_DRIVER st7701_fwvga_ctc_vdo_tyf_for_cq4011_lcm_drv = 
{
    	.name			= "st7701_fwvga_ctc_vdo_tyf_for_cq4011",
