...
//{0xCC,10,{0x34,0x20,0x38,0x60,0x11,0x91,0x00,0x04,0x00,0x00}},// ESD to strengthn

//{0xBE,1,{0x01}},//page 1

//{0xC1,2,{0x14,0x05}}, // TP strengthn 2016-01-19 KYD GAN
...
static void lcm_get_params(LCM_PARAMS *params)
{
	...
	params->dsi.vertical_backporch					= 7;   // from Q driver
	params->dsi.vertical_frontporch					= 6;  // rom Q driver
	params->dsi.vertical_active_line				= FRAME_HEIGHT;

	params->dsi.horizontal_sync_active			= 10;//4 60
	params->dsi.horizontal_backporch				= 10;//32 80 46
	params->dsi.horizontal_frontporch				= 10;//32 80 46
...
*/
	params->dsi.PLL_CLOCK = 165;//240; 185;//this value must be in MTK suggested table
...
LCM_DRIVER jd9161ba_fwvga_dsi_vdo_ivo_zgd_t050k409fpc_mx2128e_als_a5066_lcm_drv = 
{
      .name			= "jd9161ba_fwvga_dsi_vdo_ivo_zgd_t050k409fpc_mx2128e_als_a5066",
