...
{0x6F,01,{0x57}}, // 35             //57   // reg vcl + pumping ratio VGH=3.5x VGL=-2.5x
{0x3A,01,{0xA4}},                
{0x8D,01,{0x1a}},               //VGL clamp -11V  1a
{0x87,01,{0xBA}},                              
{0x26,01,{0x76}},            
{0xB2,01,{0xD1}},
...
{0x22, 01, {0x0A}},		//BGR, SS  09->0A
{0x31, 01, {0x00}},		//inversion
{0x53, 01, {0x43}},		//VCOM1  47  42->43
{0x55, 01, {0x50}},		//VCOM2
{0x50, 01, {0xA8}},		//VREG1OUT=4.7V  a8  98->A8
{0x51, 01, {0xA8}},		//VREG2OUT=--4.7V  a8  98->A8
{0x60, 01, {0x06}},               //SDT 
//{0x62, 01, {0x20}}, 

{0xA0, 01, {0x00}},		//VP255	Gamma P  0
{0xA1, 01, {0x22}},               //VP251          4
{0xA2, 01, {0x36}},               //VP247          8
{0xA3, 01, {0x18}},               //VP243          12
{0xA4, 01, {0x1E}},               //VP239          16
{0xA5, 01, {0x32}},               //VP231          24
{0xA6, 01, {0x27}},               //VP219          36
{0xA7, 01, {0x25}},               //VP203          52
{0xA8, 01, {0xA6}},               //VP175          80
{0xA9, 01, {0x1D}},               //VP144          111
{0xAA, 01, {0x28}},               //VP111          144
{0xAB, 01, {0x7D}},               //VP80           175
{0xAC, 01, {0x1A}},               //VP52           203
{0xAD, 01, {0x19}},               //VP36           219
{0xAE, 01, {0x4D}},               //VP24           231
{0xAF, 01, {0x23}},               //VP16           239
{0xB0, 01, {0x2B}},               //VP12           243
{0xB1, 01, {0x49}},               //VP8            247
{0xB2, 01, {0x55}},               //VP4            251
{0xB3, 01, {0x23}},               //VP0            255
...
*/
	params->dsi.PLL_CLOCK = 220;//221; //this value must be in MTK suggested table
...
LCM_DRIVER ili9881c_hd720_dsi_vdo_ivo_bx_c050s050k_mx2128e_v02_jd_jd5002_lcm_drv = 
{
    .name			= "ili9881c_hd720_dsi_vdo_ivo_bx_c050s050k_mx2128e_v02_jd_jd5002",
