...
{0x50,1,{0xA0}},                // BT  +2/-2 pump for DDVDH-L

{0x51,1,{0xA0}},                 // DVDDH DVDDL clamp

{0x60,1,{0x07}},              	//

{0x61,1,{0x00}},                 // VGH clamp off

{0x62,1,{0x07}},	            // VGL clamp off
...
{0x55,1,{0x0C}},	//NBWSEL 0: tn lcd 00; ips lcd 02, //NBWSEL 1  no use
//++++++++++++++++++ Gamma Setting ++++++++++++++++++//
...
{0xA9,1,{0x0D}},     // Gamma 80

{0xAA,1,{0x12}},     // Gamma 52
...
///==============Nagitive
{0xC0,1,{0x0F}},     // Gamma 255

{0xC1,1,{0x1A}},   // Gamma 251

{0xC2,1,{0x23}},     // Gamma 247

{0xC3,1,{0x0E}},   // Gamma 239

{0xC4,1,{0x07}},    // Gamma 231

{0xC5,1,{0x0C}},    // Gamma 203
...
*/
	params->dsi.PLL_CLOCK = 190;//240; 180 //this value must be in MTK suggested table
...
LCM_DRIVER ili9806e_fwvga_dsi_vdo_ivo_bx_bx49505325c_mx2150e_jy_a5010_lcm_drv = 
{
      .name			= "ili9806e_fwvga_dsi_vdo_ivo_bx_bx49505325c_mx2150e_jy_a5010",
