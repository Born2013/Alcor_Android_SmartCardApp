...
//    {0xC0,1,{0x03}},//mike
	...
	{0xEB,7,{0x02,0x02,0x00,0x00,0x00,0x00,0x00}}, //02
...
static void lcm_get_params(LCM_PARAMS *params)
{
	...
	params->dsi.vertical_backporch				= 30;//12
	...
	params->dsi.horizontal_frontporch			= 80;//30;//30
	params->dsi.horizontal_active_pixel			= FRAME_WIDTH;

	params->dsi.PLL_CLOCK = 200;//150//152;//155;//175;//200; //157//this value must be in MTK suggested table
/*
...
LCM_DRIVER st7701_fwvga_ctc_vdo_coe_for_cq4011_lcm_drv = 
{
    	.name			= "st7701_fwvga_ctc_vdo_coe_for_cq4011",
