...
static void init_lcm_registers(void)
{
    ...
    data_array[1] = 0x0B0A00B8; 
	data_array[2] = 0x110D0B00; 
	data_array[3] = 0x00000004; 
    dsi_set_cmdq(data_array, 4, 1);
    //MDELAY(1);
	 
	data_array[0] = 0x00073902;                          
    data_array[1] = 0x110804B9; 
	...
	data_array[2] = 0x14121210; 
	data_array[3] = 0x00000014; 
    dsi_set_cmdq(data_array, 4, 1);
	//MDELAY(1);
...
//legen modify end
    ...
    data_array[1] = 0x340D03C3; 
	data_array[2] = 0x54440105; 
    dsi_set_cmdq(data_array, 3, 1);
	//MDELAY(1);

	data_array[0] = 0x00063902; 
    data_array[1] = 0x350302C4;  //0x701303c4
	data_array[2] = 0x0000483D;  //0x00005C70
    dsi_set_cmdq(data_array, 3, 1);
	//MDELAY(1);
...
static void lcm_get_params(LCM_PARAMS *params)
{
       ...
       //1 SSD2075 has no TE Pin
		...
		params->dsi.vertical_frontporch					= 24;  //----8
...
LCM_DRIVER ssd2075_hd720_dsi_vdo_lg_qt470hd028sh02_mx2521e_yaao_x28_lcm_drv = 
{
    .name			= "ssd2075_hd720_dsi_vdo_lg_qt470hd028sh02_mx2521e_yaao_x28",
