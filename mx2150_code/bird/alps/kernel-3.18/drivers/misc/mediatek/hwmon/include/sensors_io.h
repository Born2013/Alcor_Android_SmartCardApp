...
/*add by Crystal Shen(BIRD_C) begin for mxc400x begin*/
...
#endif
/*add by Crystal Shen(BIRD_C) begin for mxc400x end*/
/* mCube add start */
/* G-sensor */
...
#define ALSPS_SET_PS_CALIBRATION                _IO(ALSPS, 0x1F)  //add by sqq for calibration
