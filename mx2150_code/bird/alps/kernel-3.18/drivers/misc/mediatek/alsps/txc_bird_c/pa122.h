...
/*-----------------------------------------------------------------------------*/
#define PA12_PS_TH_HIGH			35 //40 crystal
#define PA12_PS_TH_LOW			20 //25 crystal
...
#define PA12_PS_OFFSET_EXTRA		3 //5 crystal
#define PA12_PS_OFFSET_MAX		100
#define PA12_PS_OFFSET_MIN		0
#define PA12_FAST_CAL			1//1 crystal
...
#define PA12_LED_CURR		0 	/* 0:150mA | 1:100mA | 2:50mA | 3:25mA | 4:15mA | 5:12mA | 6:10mA | 7:7mA*/
