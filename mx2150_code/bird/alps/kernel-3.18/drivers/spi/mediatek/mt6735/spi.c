...
/*open base log out*/
/*#define SPI_DEBUG*/
//#define SPI_DEBUG    //delete by crystal for cancle log
/*open verbose log out*/
/*#define SPI_VERBOSE*/
//#define SPI_VERBOSE  //delete by crystal for cancle log
...
/*	reg_val = spi_readl ( ms, SPI_CMD_REG );
	...
	spi_writel(ms, SPI_CMD_REG, reg_val);
	//Crystal BIRD BEGIN FOR NORMAL PCB SPI2
	spi_writel(ms, SPI_PAD_SEL_REG, 1);
	//Crystal BIRD END FOR NORMAL PCB SPI2
...
static int __init mt_spi_probe(struct platform_device *pdev)
{
    ...
    /* add by wuchuang for blestech 20170904 begin */
    master->dev.of_node = pdev->dev.of_node; 
    /* add by wuchuang for blestech 20170904 end */
