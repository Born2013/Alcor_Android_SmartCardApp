...
status_t Format(const std::string& source, unsigned long numSectors) {
    ...
    //[BIRD][BIRD_USB_STORAGE_NAME][USB存储默认名字][dengyang][20160517] BEGIN
    char usb_storage_name[PROPERTY_VALUE_MAX];
    property_get("ro.bd_usb_storage_name", usb_storage_name, "Android");
    //[BIRD][BIRD_USB_STORAGE_NAME][USB存储默认名字][dengyang][20160517] END
    ...
    //[BIRD][BIRD_USB_STORAGE_NAME][USB存储默认名字][dengyang][20160517] BEGIN
    cmd.push_back("-L");
    cmd.push_back(usb_storage_name);
    //[BIRD][BIRD_USB_STORAGE_NAME][USB存储默认名字][dengyang][20160517] END
