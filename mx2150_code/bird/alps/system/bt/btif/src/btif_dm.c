...
static char* btif_get_default_local_name()
{
    //[BIRD][BIRD_DEFAULT_BT_HOSTNAME][默认蓝牙名称修改][dengyang][20160517] BEGIN
    #if defined(BIRD_DEFAULT_BT_HOSTNAME)
        char prop_bt_name[PROPERTY_VALUE_MAX];
        property_get("ro.bird_def_bt_hostname", prop_bt_name, "Android");
        strncpy(btif_default_local_name, prop_bt_name, sizeof(btif_default_local_name) - 1);
    #endif
    //[BIRD][BIRD_DEFAULT_BT_HOSTNAME][默认蓝牙名称修改][dengyang][20160517] END    
